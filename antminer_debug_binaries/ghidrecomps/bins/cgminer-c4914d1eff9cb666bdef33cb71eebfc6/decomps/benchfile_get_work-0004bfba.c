...

{
  ...
  if (benchfile_in == (FILE *)0x0) {
    if (opt_benchfile == (char *)0x0) {
      tmp42._0_4_ = s_BENCHFILE_Invalid_benchfile_NULL_0008c478._0_4_;
      tmp42._4_4_ = s_BENCHFILE_Invalid_benchfile_NULL_0008c478._4_4_;
      tmp42._8_4_ = s_BENCHFILE_Invalid_benchfile_NULL_0008c478._8_4_;
      tmp42._12_4_ = s_BENCHFILE_Invalid_benchfile_NULL_0008c478._12_4_;
      tmp42._16_4_ = s_BENCHFILE_Invalid_benchfile_NULL_0008c478._16_4_;
      tmp42._20_4_ = s_BENCHFILE_Invalid_benchfile_NULL_0008c478._20_4_;
      tmp42._24_4_ = s_BENCHFILE_Invalid_benchfile_NULL_0008c478._24_4_;
      tmp42._28_4_ = s_BENCHFILE_Invalid_benchfile_NULL_0008c478._28_4_;
      tmp42[32] = (char)ram0x0008c498;
  ...
  if ((bVar1) || (pcVar3 = fgets(buf,0x400,(FILE *)benchfile_in), pcVar3 != (char *)0x0)) {
    do {
      ...
      if ((buf[0] != '\0') && ((buf[0] != '#' && (buf[0] != '/')))) {
        ...
        iVar6 = benchfile_data[3].length + j + 8;
        memset(work,0,0x1c0);
