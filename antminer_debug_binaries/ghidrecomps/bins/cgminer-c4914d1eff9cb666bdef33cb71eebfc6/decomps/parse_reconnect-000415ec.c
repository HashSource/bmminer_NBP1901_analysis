...

{
  ...
  char **ppcVar4;
  json_int_t jVar5;
  undefined local_a48 [8];
  char acStack_a40 [256];
  undefined auStack_940 [8];
  json_t *val_local;
  pool *pool_local;
  char tmp42 [2048];
  char address [256];
  ...
  *ppcVar4 = port;
  ...
  if (_Var1) {
    ...
    _mutex_lock(&pool_local->stratum_lock,"util.c","parse_reconnect",0x962);
    ...
    free(tmp);
    _mutex_unlock(&pool_local->stratum_lock,"util.c","parse_reconnect",0x96b);
