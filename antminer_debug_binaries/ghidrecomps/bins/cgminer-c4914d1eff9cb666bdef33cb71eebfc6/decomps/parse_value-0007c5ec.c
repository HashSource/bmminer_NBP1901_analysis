...

{
  ...
  iVar2 = lex->token;
  if (iVar2 == 0x101) {
    json = json_integer(CONCAT44(error,uStack_30));
  }
  else if (iVar2 < 0x102) {
    if (iVar2 == 0x5b) {
...
LAB_0007c730:
      ...
      if (iVar2 == 0x7b) {
        ...
        if (iVar2 != 0x100) goto LAB_0007c730;
    ...
    json = json_real((double)CONCAT44(error,uStack_30));
  }
  else if (iVar2 == 0x104) {
    json = json_false();
  }
  else {
    if (iVar2 != 0x105) goto LAB_0007c730;
    json = json_null();
  }
  if (json == (json_t *)0x0) {
    json = (json_t *)0x0;
