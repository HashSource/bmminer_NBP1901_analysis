...

{
  ...
  deleted_block = 0;
  ret = true;
  _wr_lock(&blk_lock,"cgminer.c","block_exists",0x15b1);
  ...
  for (; 0xb < _hj_k; _hj_k = _hj_k - 0xc) {
    iVar9 = (uint)_hj_key[7] * 0x1000000 +
  ...
  s = (block *)0x0;
  if (blocks != (block *)0x0) {
    uVar6 = ((blocks->hh).tbl)->num_buckets - 1 & uVar5;
  ...
  if (s == (block *)0x0) {
    __dest = (block *)_cgcalloc(0x68,1,"cgminer.c","block_exists",0x15b5);
    if (__dest == (block *)0x0) {
      tmp42[0] = s_block_exists_OOM_0008c9ac[0];
      tmp42[1] = s_block_exists_OOM_0008c9ac[1];
      tmp42[2] = s_block_exists_OOM_0008c9ac[2];
      tmp42[3] = s_block_exists_OOM_0008c9ac[3];
      tmp42[4] = s_block_exists_OOM_0008c9ac[4];
      tmp42[5] = s_block_exists_OOM_0008c9ac[5];
      tmp42[6] = s_block_exists_OOM_0008c9ac[6];
      tmp42[7] = s_block_exists_OOM_0008c9ac[7];
      tmp42[8] = s_block_exists_OOM_0008c9ac[8];
      tmp42[9] = s_block_exists_OOM_0008c9ac[9];
      tmp42[10] = s_block_exists_OOM_0008c9ac[10];
      tmp42[11] = s_block_exists_OOM_0008c9ac[11];
      tmp42[12] = s_block_exists_OOM_0008c9ac[12];
      tmp42[13] = s_block_exists_OOM_0008c9ac[13];
      tmp42[14] = s_block_exists_OOM_0008c9ac[14];
      tmp42[15] = s_block_exists_OOM_0008c9ac[15];
      tmp42[16] = (char)ram0x0008c9bc;
    ...
    if ((blocks != (block *)0x0) && (3 < ((blocks->hh).tbl)->num_items)) {
          ...
          while (_hs_p != (UT_hash_handle *)0x0) {
            ...
            for (_hs_i = 0; _hs_i < _hs_insize; _hs_i = _hs_i + 1) {
              ...
              if (_hs_q->next == (void *)0x0) {
                ...
                _hs_q = (UT_hash_handle *)(((blocks->hh).tbl)->hho + (int)_hs_q->next);
              }
              ...
              if (_hs_psize == 0) {
                ...
                if (_hs_p != (UT_hash_handle *)0x0) {
                  if (_hs_p->next == (void *)0x0) {
                    ...
                    _hs_p = (UT_hash_handle *)(((blocks->hh).tbl)->hho + (int)_hs_p->next);
                  }
                }
                _hs_psize = _hs_psize - 1;
              }
      ...
      if (((blocks->hh).prev == (void *)0x0) && ((blocks->hh).next == (void *)0x0)) {
        ...
        pUVar10 = &blocks->hh;
        if (blocks == (block *)((int)((blocks->hh).tbl)->tail - ((blocks->hh).tbl)->hho)) {
          ((blocks->hh).tbl)->tail =
        ...
        if (pUVar10 == ((blocks->hh).tbl)->buckets[uVar5].hh_head) {
    ...
    for (; 0xb < _hj_k_1; _hj_k_1 = _hj_k_1 - 0xc) {
      iVar9 = (uint)_hj_key_1[7] * 0x1000000 +
    ...
    pUVar3 = (blocks->hh).tbl;
    pUVar3->num_items = pUVar3->num_items + 1;
    uVar5 = ((blocks->hh).tbl)->num_buckets - 1 & uVar5;
    pUVar4 = ((blocks->hh).tbl)->buckets;
    pUVar4[uVar5].count = pUVar4[uVar5].count + 1;
      ...
      for (_he_bkt_i = 0; _he_bkt_i < ((__dest->hh).tbl)->num_buckets; _he_bkt_i = _he_bkt_i + 1) {
        ...
        while (_he_thh != (UT_hash_handle *)0x0) {
          ...
          if (((__dest->hh).tbl)->ideal_chain_maxlen < pUVar11->count) {
            ...
            uVar5 = __udivsi3(pUVar11->count,((__dest->hh).tbl)->ideal_chain_maxlen);
  ...
  _wr_unlock(&blk_lock,"cgminer.c","block_exists",0x15d7);
  if (ret != true) {
