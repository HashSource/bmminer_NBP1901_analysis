...

{
  ...
  if (!_Var4) {
    ...
    if ((iVar5 != 0) && (iVar5 = strncmp(url,"https://",8), iVar5 != 0)) {
      __dest = (undefined4 *)_cgmalloc(0x100,"cgminer.c","setup_url",0x3fd);
      uVar2 = s_stratum_tcp____0008aa30._8_4_;
      uVar1 = s_stratum_tcp____0008aa30._4_4_;
      *__dest = s_stratum_tcp____0008aa30._0_4_;
      __dest[1] = uVar1;
      __dest[2] = uVar2;
      cVar3 = s_stratum_tcp____0008aa30[14];
      *(undefined2 *)(__dest + 3) = s_stratum_tcp____0008aa30._12_2_;
