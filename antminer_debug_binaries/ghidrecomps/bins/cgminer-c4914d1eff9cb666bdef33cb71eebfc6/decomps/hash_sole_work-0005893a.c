...
LAB_00059102:
    ...
    *(undefined4 *)((int)&dev->max_hashes + 4) = 0;
    ...
    if (dVar11 == dVar12 || dVar11 < dVar12 != (NAN(dVar11) || NAN(dVar12))) {
      uVar6 = *(undefined4 *)&drv_00->max_diff;
      uVar9 = *(undefined4 *)((int)&drv_00->max_diff + 4);
    }
    else {
      uVar6 = *(undefined4 *)&work->work_difficulty;
      uVar9 = *(undefined4 *)((int)&work->work_difficulty + 4);
    }
    *(undefined4 *)&work->device_diff = uVar6;
    *(undefined4 *)((int)&work->device_diff + 4) = uVar9;
    dVar11 = drv_00->min_diff;
    dVar12 = work->device_diff;
    if (dVar11 == dVar12 || dVar11 < dVar12 != (NAN(dVar11) || NAN(dVar12))) {
      uVar6 = *(undefined4 *)&work->device_diff;
      uVar9 = *(undefined4 *)((int)&work->device_diff + 4);
    }
    else {
      uVar6 = *(undefined4 *)&drv_00->min_diff;
      uVar9 = *(undefined4 *)((int)&drv_00->min_diff + 4);
    }
    *(undefined4 *)&work->device_diff = uVar6;
    *(undefined4 *)((int)&work->device_diff + 4) = uVar9;
    while( true ) {
      ...
      ppVar7 = work->pool;
      addtime(&getwork_start,&(ppVar7->cgminer_stats).getwork_wait);
      _Var1 = time_more(&getwork_start,&(ppVar7->cgminer_stats).getwork_wait_max);
      if (_Var1) {
        copy_time(&(ppVar7->cgminer_stats).getwork_wait_max,&getwork_start);
      }
      _Var1 = time_less(&getwork_start,&(ppVar7->cgminer_stats).getwork_wait_min);
      if (_Var1) {
        copy_time(&(ppVar7->cgminer_stats).getwork_wait_min,&getwork_start);
      }
      (ppVar7->cgminer_stats).getwork_calls = (ppVar7->cgminer_stats).getwork_calls + 1;
      ...
      sdiff.tv_sec = diff.tv_sec + sdiff.tv_sec;
      sdiff.tv_usec = diff.tv_usec + sdiff.tv_usec;
      ...
      if (sdiff.tv_sec < iVar5) {
        ...
        if (iVar5 < sdiff.tv_sec) {
          max_nonce = __udivsi3(max_nonce * iVar5,sdiff.tv_sec);
        }
          ...
          uVar6 = __aeabi_idiv(iVar5 * 1000000 + sdiff.tv_usec,iVar3 >> 10);
          max_nonce = __udivsi3(max_nonce << 10,uVar6);
        }
LAB_00058f7e:
