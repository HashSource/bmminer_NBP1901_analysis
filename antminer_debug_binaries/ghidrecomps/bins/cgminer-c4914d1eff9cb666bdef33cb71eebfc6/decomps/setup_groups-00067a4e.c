...

{
  ...
  sVar3 = strlen(pcVar9);
  __dest = (char *)_cgmalloc(sVar3 + 1,"api-btm.c","setup_groups",0x1201);
  ...
  do {
    ...
    if ((next == (char *)0x0) || (*next == '\0')) {
      ...
      iVar7 = toupper(iVar7);
      iVar8 = toupper(0x41);
      pcVar9 = (char *)_cgmalloc(sVar3 + 1,"api-btm.c","setup_groups",0x127b);
...
LAB_00067bfe:
      ...
      iVar7 = toupper(uVar5 & 0xff);
      iVar8 = toupper(0x5a);
      if (iVar8 < iVar7) goto LAB_00067bfe;
    }
    uVar6 = toupper(0x57);
    if ((uVar5 & 0xff) == uVar6) {
      iVar7 = toupper(0x57);
    ...
    iVar7 = toupper(uVar5 & 0xff);
    iVar8 = toupper(0x41);
    pcVar9 = (char *)_cgmalloc(sVar3 + 1,"api-btm.c","setup_groups",0x1267);
    apigroups[iVar7 - iVar8].commands = pcVar9;
    strcpy(apigroups[iVar7 - iVar8].commands,commands);
  } while( true );
}
