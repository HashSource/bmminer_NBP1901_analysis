        ...
        if ((json_01 == (json_t *)0x0) ||
          ...
          if (__s1 != (char *)0x0) {
            ...
            if (iVar2 == 0) {
              ...
              if (((use_syslog != false) || (opt_log_output != false)) || (5 < opt_log_level)) {
                tmp42[0] = s_Pool_support_multi_version_0008832c[0];
                tmp42[1] = s_Pool_support_multi_version_0008832c[1];
                tmp42[2] = s_Pool_support_multi_version_0008832c[2];
                tmp42[3] = s_Pool_support_multi_version_0008832c[3];
                tmp42[4] = s_Pool_support_multi_version_0008832c[4];
                tmp42[5] = s_Pool_support_multi_version_0008832c[5];
                tmp42[6] = s_Pool_support_multi_version_0008832c[6];
                tmp42[7] = s_Pool_support_multi_version_0008832c[7];
                tmp42[8] = s_Pool_support_multi_version_0008832c[8];
                tmp42[9] = s_Pool_support_multi_version_0008832c[9];
                tmp42[10] = s_Pool_support_multi_version_0008832c[10];
                tmp42[11] = s_Pool_support_multi_version_0008832c[11];
                tmp42[12] = s_Pool_support_multi_version_0008832c[12];
                tmp42[13] = s_Pool_support_multi_version_0008832c[13];
                tmp42[14] = s_Pool_support_multi_version_0008832c[14];
                tmp42[15] = s_Pool_support_multi_version_0008832c[15];
                tmp42[16] = s_Pool_support_multi_version_0008832c[16];
                tmp42[17] = s_Pool_support_multi_version_0008832c[17];
                tmp42[18] = s_Pool_support_multi_version_0008832c[18];
                tmp42[19] = s_Pool_support_multi_version_0008832c[19];
                tmp42[20] = s_Pool_support_multi_version_0008832c[20];
                tmp42[21] = s_Pool_support_multi_version_0008832c[21];
                tmp42[22] = s_Pool_support_multi_version_0008832c[22];
                tmp42[23] = s_Pool_support_multi_version_0008832c[23];
                tmp42._24_2_ = (undefined2)ram0x00088344;
                tmp42[26] = (char)((uint)ram0x00088344 >> 0x10);
                _applog(6,tmp42,false);
              }
