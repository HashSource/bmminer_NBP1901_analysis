...
undefined4
set_PIC16F1704_flash_point32_ter(undefined param_1,undefined param_2,byte param_3,byte param_4)

{
  ...
  if (((byte)local_1c == 1) && (local_1c._1_1_ == 1)) {
    ...
    printf("\n--- %s failed! read_back_data[0] = 0x%02x, read_back_data[1] = 0x%02x\n\n",
           "set_PIC16F1704_flash_point32_ter",(uint)(byte)local_1c,(uint)local_1c._1_1_);
    uVar2 = 0;
  }
  return uVar2;
}
