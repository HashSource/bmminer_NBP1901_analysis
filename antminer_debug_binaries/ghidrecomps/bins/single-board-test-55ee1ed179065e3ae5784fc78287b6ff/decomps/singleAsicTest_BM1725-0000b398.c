...

{
  ...
  chain_reset(gChain);
  fan_control(0x32);
  pthread_create(DAT_0000b708,(pthread_attr_t *)0x0,show_status_func + 1,
                 (void *)((int)&chain_info + (uint)gChain * 2));
  *(undefined *)((int)&start_receive + (uint)gChain) = 1;
  pthread_create(DAT_0000b70c,(pthread_attr_t *)0x0,receive_func + 1,
                 (void *)((int)&chain_info + (uint)gChain * 2));
  ...
  if ((uint)(byte)cgpu[gChain + 0x1004b8] == Conf._108_4_) {
    ...
    pthread_create(DAT_0000b710,(pthread_attr_t *)0x0,read_temp_func + 1,
                   (void *)((int)&chain_info + (uint)gChain * 2));
    ...
    pthread_create(DAT_0000b8b4,(pthread_attr_t *)0x0,send_func + 1,
                   (void *)((int)&chain_info + (uint)gChain * 2));
