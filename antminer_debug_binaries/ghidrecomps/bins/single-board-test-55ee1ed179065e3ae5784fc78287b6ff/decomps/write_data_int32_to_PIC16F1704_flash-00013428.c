...
undefined4 write_data_int32_to_PIC16F1704_flash(undefined param_1,undefined param_2)

{
  ...
  if (((byte)local_1c == 5) && (local_1c._1_1_ == 1)) {
    ...
    printf("\n--- %s failed! read_back_data[0] = 0x%02x, read_back_data[1] = 0x%02x\n\n",
           "write_data_int32_to_PIC16F1704_flash",(uint)(byte)local_1c,(uint)local_1c._1_1_);
    uVar2 = 0;
  }
  return uVar2;
}
