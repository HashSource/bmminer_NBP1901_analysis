...
LAB_0006096e:
  ...
  case (uint **)0x2:
    pbVar7 = pbVar33;
    if (ppuVar31 < (uint **)0x20) goto LAB_0006096e;
LAB_00060996:
    if (puVar32[8] != 0) {
...
LAB_000609b6:
  ...
  case (uint **)0x3:
    pbVar7 = pbVar33;
    if (ppuVar31 < (uint **)0x10) goto LAB_000609b6;
LAB_000609de:
    uVar21 = puVar32[8];
    if (uVar21 != 0) {
...
LAB_00060a68:
    if (uVar23 != 0) {
      ...
      if (puVar17 != (uint *)0x0) goto LAB_00060cf6;
      uVar21 = puVar32[4];
    }
    puVar32[0x10] = 0;
    *puVar32 = 6;
...
LAB_00060b52:
  ...
  case (uint **)0x4:
    uVar21 = puVar32[4];
    if ((int)(uVar21 << 0x15) < 0) goto joined_r0x00061374;
    goto LAB_000613fe;
  case (uint **)0x5:
    uVar21 = puVar32[4];
    uVar23 = uVar21 & 0x400;
  ...
  case (uint **)0x6:
    uVar21 = puVar32[4];
    goto joined_r0x00061390;
  case (uint **)0x7:
    uVar21 = puVar32[4];
    goto joined_r0x00060afc;
  case (uint **)0x8:
    uVar21 = puVar32[4];
    goto LAB_00060b52;
  case (uint **)0x9:
  ...
  case (uint **)0xa:
    ...
    param_1[0xc] = (byte *)uVar36;
    *puVar32 = 0xb;
switchD_000605ae_caseD_b:
    if ((int)param_2 - 5U < 2) goto LAB_00060cf6;
switchD_000605ae_caseD_c:
    if (puVar32[1] == 0) {
    ...
    goto LAB_000605a8;
  case (uint **)0xb:
    goto switchD_000605ae_caseD_b;
  case (uint **)0xc:
    goto switchD_000605ae_caseD_c;
  case (uint **)0xd:
...
LAB_00060e52:
    if (puVar19 == (uint *)0x0) {
      ...
      *puVar32 = 0xb;
      ...
      if (puVar19 == (uint *)0x0) goto LAB_00060cf6;
  ...
  case (uint **)0x10:
    ...
    if ((param_4 < (uint **)0x11f) && (puVar12 < (uint *)0x1f)) {
      ...
      *puVar32 = 0x11;
LAB_00060f32:
      puVar8 = (ushort *)(DAT_00061250 + (uVar23 - 1) * 2);
      pbVar7 = pbVar33;
      do {
        uVar23 = uVar23 + 1;
        pbVar33 = pbVar7;
  ...
  case (uint **)0x11:
    uVar21 = puVar32[0x17];
    uVar23 = puVar32[0x1a];
    if (uVar23 < uVar21) goto LAB_00060f32;
LAB_00060f7a:
    if (uVar23 < 0x13) {
      puVar8 = (ushort *)(DAT_00061250 + (uVar23 - 1) * 2);
      do {
        puVar8 = puVar8 + 1;
        bVar34 = puVar8 != DAT_00061254;
...
LAB_00060ff2:
      ...
      uVar21 = puVar32[0x19];
      while (puVar12 = DAT_00061cd4, puVar17 < (uint *)(uVar21 + (int)local_50)) {
        uVar26 = puVar32[0x13];
...
LAB_000610be:
          ...
          if ((uint *)(uVar21 + (int)local_50) < puVar12) goto LAB_00061c64;
          uVar26 = uVar23 - 1;
...
LAB_0006119a:
            ...
            if (uVar23 != uVar10) goto LAB_0006119a;
          }
      ...
      if (*(short *)(puVar32 + 0x9c) == 0) {
        ...
        *puVar32 = 0x1d;
        ...
        if (local_5c == 0) {
          ...
          puVar12 = DAT_00061ce4;
          local_5c = (int)uVar36;
          if (local_5c == 0) {
            *puVar32 = 0x13;
            if (param_2 == (uint *)0x6) goto LAB_00060cf6;
switchD_000605ae_caseD_13:
            param_4 = (char *)0x14;
            *puVar32 = 0x14;
switchD_000605ae_caseD_14:
                ...
                *puVar32 = 0x19;
                ...
                if ((bVar2 & 0xf0) == 0) {
                  ...
                  *ppuVar14 = (uint *)ppuVar20;
                  param_4 = (char *)ppuVar14;
                  if (puVar12 == (uint *)0x0) goto LAB_00060830;
                }
                else {
                  ppuVar28 = (uint **)((uint)ppuVar28 >> (int)param_4);
                  ppuVar31 = (uint **)((int)ppuVar31 - (int)param_4);
...
joined_r0x00060ce4:
                    ...
                    *puVar32 = 0x18;
switchD_000605ae_caseD_18:
                    puVar12 = DAT_00060a20;
                    if (local_70 == (uint *)0x0) goto LAB_00060cf6;
                    uVar21 = puVar32[0x11];
...
LAB_000615ac:
                      ...
                      if (puVar16 != puVar19) goto LAB_000615ac;
                    }
  ...
  case (uint **)0x12:
    ...
    goto LAB_00060ff2;
  case (uint **)0x13:
    goto switchD_000605ae_caseD_13;
  case (uint **)0x14:
    goto switchD_000605ae_caseD_14;
  case (uint **)0x15:
    ppuVar14 = (uint **)puVar32[0x12];
    goto joined_r0x00060cd2;
  case (uint **)0x16:
    goto switchD_000605ae_caseD_16;
  case (uint **)0x17:
    ppuVar14 = (uint **)puVar32[0x12];
    goto joined_r0x00060ce4;
  case (uint **)0x18:
    goto switchD_000605ae_caseD_18;
  case (uint **)0x19:
    if (local_70 == (uint *)0x0) goto LAB_00060cf6;
    param_4 = (char *)0x14;
...
LAB_00061302:
    ...
    *puVar32 = 0x1c;
    goto LAB_00060cf6;
  case (uint **)0x1c:
    goto switchD_000605ae_caseD_1c;
  case (uint **)0x1d:
    local_5c = -3;
    goto LAB_00060cf6;
  case (uint **)0x1e:
    return -4;
  default:
    goto switchD_000605ae_caseD_1f;
  }
  puVar12 = DAT_00060ea8;
  param_4 = (char *)0x1d;
  ppuVar14 = (uint **)0x1d;
  param_1[6] = (byte *)DAT_00060ea8;
  *puVar32 = 0x1d;
  goto LAB_000605a8;
switchD_000605ae_caseD_1c:
  local_5c = 1;
LAB_00060cf6:
  uVar21 = puVar32[10];
  *param_1 = pbVar33;
