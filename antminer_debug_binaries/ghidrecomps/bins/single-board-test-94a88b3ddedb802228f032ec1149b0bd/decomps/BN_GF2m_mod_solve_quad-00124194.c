...
uint BN_GF2m_mod_solve_quad
               (undefined4 param_1,undefined4 param_2,BIGNUM *param_3,undefined4 param_4)

{
  ...
  if (iVar3 == 0) {
    ...
    if (uVar5 == 0) {
      uVar6 = BN_GF2m_mod_solve_quad_arr(param_1,param_2,ptr,param_4);
      goto LAB_00124244;
    }
  }
