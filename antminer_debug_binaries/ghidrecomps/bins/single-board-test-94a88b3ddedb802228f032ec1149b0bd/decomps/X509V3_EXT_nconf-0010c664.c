...

{
  ...
  if (sVar1 < 9) {
    uVar7 = 0;
LAB_0010c6b0:
    if (3 < sVar1) goto LAB_0010c6da;
LAB_0010c6b4:
    iVar2 = OBJ_sn2nid(name);
    pXVar4 = (X509_EXTENSION *)do_ext_nconf(conf,ctx,iVar2,uVar7,value);
    if (pXVar4 == (X509_EXTENSION *)0x0) {
      ERR_put_error(0x22,0x98,0x80,DAT_0010c75c,0x5f);
      ERR_add_error_data(4,DAT_0010c760,name,DAT_0010c764,value);
    }
  }
  else {
    iVar2 = strncmp(value,DAT_0010c750,9);
    if (iVar2 == 0) {
    ...
    uVar7 = 0;
LAB_0010c6da:
    iVar2 = strncmp(value,DAT_0010c754,4);
    if (iVar2 == 0) {
      pbVar5 = (byte *)value + 4;
      uVar8 = 1;
    }
    else {
      if ((sVar1 == 4) || (iVar2 = strncmp(value,DAT_0010c758,5), iVar2 != 0)) goto LAB_0010c6b4;
      pbVar5 = (byte *)value + 5;
      uVar8 = 2;
    }
    ppuVar3 = __ctype_b_loc();
