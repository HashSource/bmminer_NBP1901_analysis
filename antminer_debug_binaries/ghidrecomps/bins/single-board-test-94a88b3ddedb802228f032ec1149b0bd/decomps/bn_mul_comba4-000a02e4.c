...

{
  ...
  *param_1 = (int)((ulonglong)uVar4 * (ulonglong)uVar3);
  ...
  uVar1 = (ulonglong)param_2[3] * (ulonglong)param_3[1] + (ulonglong)(uVar6 + uVar3);
  ...
  lVar2 = (ulonglong)param_2[1] * (ulonglong)param_3[3] + (uVar1 & 0xffffffff);
  uVar3 = (uint)((ulonglong)lVar2 >> 0x20);
  param_1[4] = (int)lVar2;
  if (CARRY4(uVar5,uVar3) != false) {
    uVar4 = uVar4 + 1;
  }
  uVar1 = (ulonglong)param_2[2] * (ulonglong)param_3[3] + (ulonglong)(uVar5 + uVar3);
  uVar3 = (uint)(uVar1 >> 0x20);
  uVar5 = uVar4 + uVar3;
  lVar2 = (ulonglong)param_2[3] * (ulonglong)param_3[2] + (uVar1 & 0xffffffff);
  uVar6 = (uint)((ulonglong)lVar2 >> 0x20);
  uVar3 = (uint)(CARRY4(uVar4,uVar3) != false);
  param_1[5] = (int)lVar2;
  if (CARRY4(uVar5,uVar6) != false) {
    uVar3 = uVar3 + 1;
  }
  lVar2 = (ulonglong)param_2[3] * (ulonglong)param_3[3] + (ulonglong)(uVar5 + uVar6);
  param_1[6] = (int)lVar2;
  param_1[7] = uVar3 + (int)((ulonglong)lVar2 >> 0x20);
  return;
}
