...
undefined4
atalla_mod_exp_mont(BIGNUM *param_1,BIGNUM *param_2,BIGNUM *param_3,BIGNUM *param_4,BN_CTX *param_5)
...
LAB_000da2dc:
    ...
    if ((iVar4 <= a_02->dmax) || (pBVar1 = bn_expand2(a_02,iVar4), pBVar1 != (BIGNUM *)0x0)) {
      ...
      iVar3 = (**(code **)(iVar3 + 0x10))(auStack_74,a_02->d,a_01->d,sStack_64);
      if (iVar3 == 0) {
        uVar6 = 1;
