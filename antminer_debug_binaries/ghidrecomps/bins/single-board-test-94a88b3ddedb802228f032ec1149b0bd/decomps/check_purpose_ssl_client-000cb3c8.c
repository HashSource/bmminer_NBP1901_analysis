...

{
  ...
  if ((-1 < (int)(uVar2 << 0x1d)) || (uVar1 = *(uint *)(param_2 + 0x30) & 2, uVar1 != 0)) {
    if (param_3 == 0) {
      if (((int)(uVar2 << 0x1e) < 0) && ((*(uint *)(param_2 + 0x2c) & 0x88) == 0)) {
        uVar1 = 0;
      }
      else if ((-1 < (int)(uVar2 << 0x1c)) || (uVar1 = *(uint *)(param_2 + 0x34) & 0x80, uVar1 != 0)
              ) {
        uVar1 = 1;
      }
    }
