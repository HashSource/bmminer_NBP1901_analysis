...
LAB_000631da:
  ...
  while( true ) {
    ...
    if ((int)(uVar20 << 0x1b) < 0) {
      ...
      if (-1 < (int)(uVar20 << 0x1b)) goto joined_r0x00063298;
      goto LAB_000632ca;
    }
  ...
  if (puVar5 == (undefined *)0x0) {
    ...
    if (puVar17 < puVar18) {
      ...
      if (uVar7 != 0 &&
        ...
        if (puVar17 == puVar28) goto LAB_000634d4;
      }
...
LAB_000637c8:
        ...
        if (puVar29 != puVar28) goto LAB_000637c8;
      }
      ...
      if (puVar5 < puVar18) {
        ...
        if ((uVar11 ^ 1 | uVar25) == 0) {
          ...
          if (puVar5 != puVar24) goto LAB_000638fa;
        }
        else {
LAB_000638fa:
    ...
    if (puVar17 < puVar18) {
      ...
      if (uVar7 != 0 &&
        ...
        if (puVar17 == puVar8) goto LAB_000634d4;
      }
      local_a4 = local_ac + (int)local_a4;
      do {
        local_ac = local_ac + 1;
