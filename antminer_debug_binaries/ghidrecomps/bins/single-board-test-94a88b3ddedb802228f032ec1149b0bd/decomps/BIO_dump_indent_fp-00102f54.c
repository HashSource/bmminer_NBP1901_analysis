...
int BIO_dump_indent_fp(FILE *param_1,byte *param_2,int param_3,size_t param_4)

{
  ...
  if (iStack_1f8 < 1) {
    ...
    do {
      ...
      if (iVar5 < 1) {
        BUF_strlcat(acStack_14c,DAT_00102d18,0x121);
      }
      else {
        do {
          ...
          iVar6 = iVar6 + 1;
          BUF_strlcat(acStack_14c,DAT_00102d14,0x121);
        } while (iVar6 != iVar5);
LAB_00102c24:
        BUF_strlcat(acStack_14c,DAT_00102d18,0x121);
        if (iVar2 < iVar4) {
      ...
      iVar8 = iVar8 + 1;
      BUF_strlcat(acStack_14c,DAT_00102d20,0x121);
      iVar2 = iVar2 + iVar5;
      sVar1 = strlen(acStack_14c);
      sVar1 = fwrite(acStack_14c,sVar1,1,param_1);
      pbVar7 = pbVar7 + iVar5;
      iStack_200 = iStack_200 + sVar1;
    } while (iVar8 != iStack_1f8);
  }
  if (uStack_1ec != 0) {
    BIO_snprintf(acStack_14c,0x121,DAT_00102d24,acStack_1d0,uStack_1ec + iVar4);
    sVar1 = strlen(acStack_14c);
    sVar1 = fwrite(acStack_14c,sVar1,1,param_1);
    iStack_200 = iStack_200 + sVar1;
  }
