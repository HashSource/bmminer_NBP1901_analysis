...
void UpdateAsicCoreEnabledFlagByResult(int param_1)

{
  ...
  for (local_14 = 0; local_14 < 0x100; local_14 = local_14 + 1) {
    for (local_18 = 0; local_18 < 0x100; local_18 = local_18 + 1) {
      *(undefined4 *)
       (asic_core_enabled_flag + (local_18 + (local_14 + param_1 * 0x100) * 0x100) * 4) = 1;
    }
  }
    ...
    if (*(int *)(asic_nonce_num + (local_c + param_1 * 0x100) * 4) <
      ...
      for (local_10 = 0; local_10 < 0x72; local_10 = local_10 + 1) {
        if ((*(int *)(asic_core_nonce_num + (local_10 + (local_c + param_1 * 0x100) * 0x100) * 4) <
          ...
          *(undefined4 *)
           (asic_core_enabled_flag + (local_10 + (local_c + param_1 * 0x100) * 0x100) * 4) = 0;
        }
      }
    }
  }
