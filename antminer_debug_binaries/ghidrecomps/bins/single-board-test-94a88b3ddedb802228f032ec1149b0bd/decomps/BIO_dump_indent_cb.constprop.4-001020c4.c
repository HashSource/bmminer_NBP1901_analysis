...
LAB_00102772:
        BUF_strlcat(local_14c,DAT_001027dc,0x121);
...
LAB_001027e0:
        BUF_strlcat(local_14c,DAT_001028e8,0x121);
...
LAB_00102404:
      ...
      local_22c = iVar6 + 6;
      local_230 = iVar6 + 5;
      BUF_strlcat(local_14c,DAT_001024c8,0x121);
      if (iVar6 < (int)param_4) {
      ...
      iVar7 = iVar7 + 1;
      BUF_strlcat(local_14c,DAT_001027d4,0x121);
      iVar6 = iVar6 + 0x10;
...
LAB_00102112:
  local_1fc = local_1d0;
  if (local_1ec != 0) {
    BIO_snprintf(local_14c,0x121,DAT_00102190,local_1fc,local_1ec + param_4);
    sVar2 = strlen(local_14c);
