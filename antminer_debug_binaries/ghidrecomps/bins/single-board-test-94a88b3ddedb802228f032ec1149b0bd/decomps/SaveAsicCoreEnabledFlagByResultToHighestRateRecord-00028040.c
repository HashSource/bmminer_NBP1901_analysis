...
void SaveAsicCoreEnabledFlagByResultToHighestRateRecord(int param_1)

{
  ...
  for (local_10 = 0; local_10 < 0x100; local_10 = local_10 + 1) {
    for (local_14 = 0; local_14 < 0x100; local_14 = local_14 + 1) {
      *(undefined4 *)
       (highest_rate_core_enabled_flag + (local_14 + (local_10 + param_1 * 0x100) * 0x100) * 4) = 1;
    }
  }
    ...
    if (*(int *)(asic_nonce_num + (local_c + param_1 * 0x100) * 4) <
      ...
      for (local_18 = 0; local_18 < 0x72; local_18 = local_18 + 1) {
        if ((*(int *)(asic_core_nonce_num + (local_18 + (local_c + param_1 * 0x100) * 0x100) * 4) <
          ...
          *(undefined4 *)
           (highest_rate_core_enabled_flag + (local_18 + (local_c + param_1 * 0x100) * 0x100) * 4) =
               0;
        }
      }
    }
