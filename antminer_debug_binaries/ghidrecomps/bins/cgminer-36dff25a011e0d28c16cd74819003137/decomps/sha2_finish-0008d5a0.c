...

{
  ...
  iVar3 = ctx->total[1] << 3;
  msglen[3] = (byte)(ctx->total[0] >> 0x1d) | (byte)iVar3;
  iVar1 = ctx->total[0] << 3;
  msglen[0] = (uchar)((uint)iVar3 >> 0x18);
  msglen[1] = (uchar)((uint)iVar3 >> 0x10);
  msglen[2] = (uchar)((uint)iVar3 >> 8);
  msglen[4] = (uchar)((uint)iVar1 >> 0x18);
  msglen[5] = (uchar)((uint)iVar1 >> 0x10);
  msglen[6] = (uchar)((uint)iVar1 >> 8);
  msglen[7] = (uchar)iVar1;
  ...
  sha2_update(ctx,sha2_padding,iVar3);
