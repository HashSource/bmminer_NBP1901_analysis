...
void register_parse_nonce_error_counter(reg_status_t *reg_status)

{
  ...
  nonce_error_counter_t reg_value;
  FILE *pFile_2;
  FILE *pFile_1;
  FILE *pFile;
  ...
  if (3 < log_level) {
    ...
    if (pFVar2 != (FILE *)0x0) {
      ...
      fprintf(pFVar2,">> ASIC_REG[0x4C] = 0x%08X, Nonce Error Counter, %s\n",
