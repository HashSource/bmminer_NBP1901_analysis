...

{
  ...
  deleted_block = 0;
  ret = true;
  _wr_lock(&blk_lock,"cgminer.c","block_exists",0x15ae);
  ...
  if (s == (block *)0x0) {
    __dest = (block *)_cgcalloc(0x68,1,"cgminer.c","block_exists",0x15b2);
    if (__dest == (block *)0x0) {
      tmp42[0] = s_block_exists_OOM_000a3d68[0];
      tmp42[1] = s_block_exists_OOM_000a3d68[1];
      tmp42[2] = s_block_exists_OOM_000a3d68[2];
      tmp42[3] = s_block_exists_OOM_000a3d68[3];
      tmp42[4] = s_block_exists_OOM_000a3d68[4];
      tmp42[5] = s_block_exists_OOM_000a3d68[5];
      tmp42[6] = s_block_exists_OOM_000a3d68[6];
      tmp42[7] = s_block_exists_OOM_000a3d68[7];
      tmp42[8] = s_block_exists_OOM_000a3d68[8];
      tmp42[9] = s_block_exists_OOM_000a3d68[9];
      tmp42[10] = s_block_exists_OOM_000a3d68[10];
      tmp42[11] = s_block_exists_OOM_000a3d68[11];
      tmp42[12] = s_block_exists_OOM_000a3d68[12];
      tmp42[13] = s_block_exists_OOM_000a3d68[13];
      tmp42[14] = s_block_exists_OOM_000a3d68[14];
      tmp42[15] = s_block_exists_OOM_000a3d68[15];
      tmp42[16] = (char)ram0x000a3d78;
  ...
  _wr_unlock(&blk_lock,"cgminer.c","block_exists",0x15d4);
  if (ret != true) {
