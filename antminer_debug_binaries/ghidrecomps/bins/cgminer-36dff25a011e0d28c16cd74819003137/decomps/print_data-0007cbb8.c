...

{
  ...
  *(undefined4 *)((int)item_00->data + 4) = 0;
  ...
  while (root_local != (api_data *)0x0) {
    ...
    case API_UINT64:
                    /* WARNING: Load size is inaccurate */
      snprintf(buf,0x40,"%llu",*(undefined4 *)((int)root_local->data + 4),*root_local->data);
      break;
    case API_INT64:
                    /* WARNING: Load size is inaccurate */
      snprintf(buf,0x40,"%lld",*(undefined4 *)((int)root_local->data + 4),*root_local->data);
      break;
    case API_DOUBLE:
                    /* WARNING: Load size is inaccurate */
      snprintf(buf,0x40,"%f",*(undefined4 *)((int)root_local->data + 4),*root_local->data);
      break;
    case API_ELAPSED:
                    /* WARNING: Load size is inaccurate */
      snprintf(buf,0x40,"%.0f",*(undefined4 *)((int)root_local->data + 4),*root_local->data);
      break;
    case API_BOOL:
                    /* WARNING: Load size is inaccurate */
      pcVar3 = FALSESTR;
    ...
    case API_FREQ:
                    /* WARNING: Load size is inaccurate */
      snprintf(buf,0x40,"%.2f",*(undefined4 *)((int)root_local->data + 4),*root_local->data);
      break;
    case API_MHTOTAL:
                    /* WARNING: Load size is inaccurate */
      snprintf(buf,0x40,"%.4f",*(undefined4 *)((int)root_local->data + 4),*root_local->data);
      break;
    case API_TEMP:
                    /* WARNING: Load size is inaccurate */
    ...
    case API_HS:
                    /* WARNING: Load size is inaccurate */
      snprintf(buf,0x40,"%.15f",*(undefined4 *)((int)root_local->data + 4),*root_local->data);
      break;
    case API_DIFF:
                    /* WARNING: Load size is inaccurate */
      snprintf(buf,0x40,"%.8f",*(undefined4 *)((int)root_local->data + 4),*root_local->data);
      break;
    case API_PERCENT:
                    /* WARNING: Load size is inaccurate */
      snprintf(buf,0x40,"%.4f",buf,*root_local->data * DAT_0007d518);
      break;
    default:
    ...
    if (root_local == root_local->next) {
      ...
      paVar5 = root_local->next;
      paVar5->prev = root_local->prev;
      paVar5->prev->next = paVar5;
      free(root_local);
      root_local = paVar5;
    }
  }
  if (isjson) {
    ...
    add_item_buf(item_00,(char *)&DAT_000adb3c);
  }
                    /* WARNING: Load size is inaccurate */
