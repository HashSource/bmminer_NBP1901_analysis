...

{
  ...
  suffix[1] = '\0';
  bVar2 = true;
  bVar3 = DAT_00025434 <= bufsiz;
  if (bufsiz == DAT_00025434) {
    bVar3 = DAT_00025430 <= buf;
  }
  if (bVar3) {
    uVar5 = __aeabi_uldivmod(buf,bufsiz,1000000,0);
    dVar4 = (double)__floatundidf((int)uVar5,(int)((ulonglong)uVar5 >> 0x20));
    dval = dVar4 / 1000.0;
    suffix[0] = 'G';
    suffix[1] = '\0';
  }
    ...
    if (bufsiz == 0 && buf < (char *)0x3e8) {
      ...
      dVar4 = (double)__floatundidf(buf,bufsiz);
      dval = dVar4 / 1000.0;
      suffix[0] = 'K';
      suffix[1] = '\0';
    }
  ...
  if ((int)val == 0) {
    if (bVar2) {
      snprintf((char *)sigdigits,__maxlen,"%.3g%s",dval._4_4_,dval._0_4_,dval._4_4_,suffix);
    }
    else {
    ...
    if (dval != 0.0 && dval < 0.0 == NAN(dval)) {
      log10((double)CONCAT44(in_stack_ffffff94,in_stack_ffffff90));
      dVar4 = floor((double)CONCAT44(in_stack_ffffff94,in_stack_ffffff90));
    }
