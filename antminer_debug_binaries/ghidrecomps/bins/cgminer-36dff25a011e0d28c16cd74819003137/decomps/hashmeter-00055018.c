...
/* WARNING: Removing unreachable block (ram,0x00055558) */
/* WARNING: Removing unreachable block (ram,0x0005556c) */
/* WARNING: Removing unreachable block (ram,0x00055580) */
/* WARNING: Removing unreachable block (ram,0x00055594) */
/* WARNING: Removing unreachable block (ram,0x00055df8) */
/* WARNING: Removing unreachable block (ram,0x00055e0c) */
/* WARNING: Removing unreachable block (ram,0x00055e20) */
/* WARNING: Removing unreachable block (ram,0x00055e34) */
...

{
  ...
  if (iVar4 == 0) {
    ...
    if (((use_syslog != false) || (opt_log_output != false)) || (5 < opt_log_level)) {
      ...
      iVar4 = *piVar5;
      piVar5 = __errno_location();
      in_stack_fffff5d0 = strerror(*piVar5);
  ...
  if (thr_id < 0) {
    _mutex_lock(&hash_lock,"cgminer.c","hashmeter",0x1b99);
    for (thr_id_local = 0; thr_id_local < mining_threads; thr_id_local = thr_id_local + 1) {
      ...
      decay_time(&pcVar8->rolling,(double)CONCAT44(in_stack_fffff5d4,in_stack_fffff5d0),
                 (double)CONCAT44(in_stack_fffff5dc,in_stack_fffff5d8),
                 (double)CONCAT44(in_stack_fffff5e4,in_stack_fffff5e0));
      decay_time(&pcVar8->rolling1,(double)CONCAT44(in_stack_fffff5d4,in_stack_fffff5d0),
                 (double)CONCAT44(in_stack_fffff5dc,in_stack_fffff5d8),
                 (double)CONCAT44(in_stack_fffff5e4,in_stack_fffff5e0));
      decay_time(&pcVar8->rolling5,(double)CONCAT44(in_stack_fffff5d4,in_stack_fffff5d0),
                 (double)CONCAT44(in_stack_fffff5dc,in_stack_fffff5d8),
                 (double)CONCAT44(in_stack_fffff5e4,in_stack_fffff5e0));
      decay_time(&pcVar8->rolling15,(double)CONCAT44(in_stack_fffff5d4,in_stack_fffff5d0),
                 (double)CONCAT44(in_stack_fffff5dc,in_stack_fffff5d8),
                 (double)CONCAT44(in_stack_fffff5e4,in_stack_fffff5e0));
    }
    _mutex_unlock(&hash_lock,"cgminer.c","hashmeter",0x1ba8);
    dVar9 = (double)CONCAT44(in_stack_fffff5dc,in_stack_fffff5d8);
  }
  else {
    ...
    copy_time(&pcVar8->last_message_tv,&total_tv_end);
    dVar10 = (double)__floatundidf(in_r2,in_r3);
    dVar10 = (dVar10 / dVar9) / DAT_00055620;
    dVar9 = (double)CONCAT44(in_stack_fffff5dc,in_stack_fffff5d8);
    if ((opt_debug != false) &&
       (((use_syslog != false || (opt_log_output != false)) ||
        (dVar9 = (double)CONCAT44(in_stack_fffff5dc,in_stack_fffff5d8), 6 < opt_log_level)))) {
    ...
    _mutex_lock(&hash_lock,"cgminer.c","hashmeter",0x1b7c);
    dVar12 = pcVar8->total_mhashes;
    dVar10 = (double)__floatundidf(uVar15,uVar7);
    pcVar8->total_mhashes = dVar12 + dVar10;
    __floatundidf(uVar15,uVar7);
    decay_time(&pcVar8->rolling,(double)CONCAT44(in_stack_fffff5d4,in_stack_fffff5d0),dVar9,
               (double)CONCAT44(in_stack_fffff5e4,in_stack_fffff5e0));
    __floatundidf(uVar15,uVar7);
    decay_time(&pcVar8->rolling1,(double)CONCAT44(in_stack_fffff5d4,in_stack_fffff5d0),dVar9,
               (double)CONCAT44(in_stack_fffff5e4,in_stack_fffff5e0));
    __floatundidf(uVar15,uVar7);
    decay_time(&pcVar8->rolling5,(double)CONCAT44(in_stack_fffff5d4,in_stack_fffff5d0),dVar9,
               (double)CONCAT44(in_stack_fffff5e4,in_stack_fffff5e0));
    __floatundidf(uVar15,uVar7);
    decay_time(&pcVar8->rolling15,(double)CONCAT44(in_stack_fffff5d4,in_stack_fffff5d0),dVar9,
               (double)CONCAT44(in_stack_fffff5e4,in_stack_fffff5e0));
    _mutex_unlock(&hash_lock,"cgminer.c","hashmeter",0x1b83);
  ...
  _mutex_lock(&hash_lock,"cgminer.c","hashmeter",0x1bab);
  dVar10 = (double)__floatundidf((undefined4)hashes_done_local,hashes_done_local._4_4_);
  ...
  if (bVar1) {
    ...
    while( true ) {
      ...
      if (g_local_mhashes_dones[i] < 0.0 == NAN(g_local_mhashes_dones[i])) {
        dVar10 = (double)__floatundidf((undefined4)local_mhashes_done_avg,
    ...
    decay_time(&total_rolling,(double)CONCAT44(in_stack_fffff5d4,in_stack_fffff5d0),dVar9,
               (double)CONCAT44(in_stack_fffff5e4,in_stack_fffff5e0));
    __floatundidf((undefined4)hashes_done_local,hashes_done_local._4_4_);
    decay_time(&rolling1,(double)CONCAT44(in_stack_fffff5d4,in_stack_fffff5d0),dVar9,
               (double)CONCAT44(in_stack_fffff5e4,in_stack_fffff5e0));
    __floatundidf((undefined4)hashes_done_local,hashes_done_local._4_4_);
    decay_time(&rolling5,(double)CONCAT44(in_stack_fffff5d4,in_stack_fffff5d0),dVar9,
               (double)CONCAT44(in_stack_fffff5e4,in_stack_fffff5e0));
    __floatundidf((undefined4)hashes_done_local,hashes_done_local._4_4_);
    decay_time(&rolling15,(double)CONCAT44(in_stack_fffff5d4,in_stack_fffff5d0),dVar9,
               (double)CONCAT44(in_stack_fffff5e4,in_stack_fffff5e0));
    global_hashrate =
         __fixunsdfdi(SUB84(total_rolling * DAT_00055620,0),
                      (int)((ulonglong)(total_rolling * DAT_00055620) >> 0x20));
  ...
  dVar10 = (double)__floatundidf((undefined4)hashes_done_local,hashes_done_local._4_4_);
  dVar9 = (double)((ulonglong)in_stack_fffff5d4 << 0x20);
  g_local_mhashes_dones[g_local_mhashes_index] = dVar12 + dVar10;
  ...
  dVar12 = dVar10;
  if (dVar11 != DAT_00055de0 && dVar11 < DAT_00055de0 == (NAN(dVar11) || NAN(DAT_00055de0))) {
    ...
    total_secs = dVar12;
    _mutex_unlock(&hash_lock,"cgminer.c","hashmeter",0x1bdb);
    zero_stats();
    _mutex_lock(&hash_lock,"cgminer.c","hashmeter",0x1bdd);
  ...
  if (bVar1) {
    dVar9 = (total_mhashes_done / total_secs) * DAT_00055de8;
    ...
    uVar13 = __fixunsdfdi(SUB84(total_rolling * DAT_00055de8,0),
                          (int)((ulonglong)(total_rolling * DAT_00055de8) >> 0x20));
    g_displayed_rolling = (double)(longlong)((int)(longlong)total_rolling / 10) / DAT_00055df0;
    suffix_string(CONCAT44(uVar15,4),(char *)uVar13,(size_t)((ulonglong)uVar13 >> 0x20),
                  (int)displayed_rolling);
    uVar13 = __fixunsdfdi(SUB84(rolling1 * DAT_00055de8,0),
                          (int)((ulonglong)(rolling1 * DAT_00055de8) >> 0x20));
    suffix_string(CONCAT44(uVar15,4),(char *)uVar13,(size_t)((ulonglong)uVar13 >> 0x20),
                  (int)displayed_r1);
    uVar13 = __fixunsdfdi(SUB84(rolling5 * DAT_00055de8,0),
                          (int)((ulonglong)(rolling5 * DAT_00055de8) >> 0x20));
    suffix_string(CONCAT44(uVar15,4),(char *)uVar13,(size_t)((ulonglong)uVar13 >> 0x20),
                  (int)displayed_r5);
    uVar13 = __fixunsdfdi(SUB84(rolling15 * DAT_00055de8,0),
                          (int)((ulonglong)(rolling15 * DAT_00055de8) >> 0x20));
    suffix_string(CONCAT44(uVar15,4),(char *)uVar13,(size_t)((ulonglong)uVar13 >> 0x20),
                  (int)displayed_r15);
  ...
  _mutex_unlock(&hash_lock,"cgminer.c","hashmeter",0x1c06);
