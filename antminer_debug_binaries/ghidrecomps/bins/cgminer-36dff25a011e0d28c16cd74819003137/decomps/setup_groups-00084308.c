...

{
  ...
  sVar3 = strlen(pcVar9);
  __dest = (char *)_cgmalloc(sVar3 + 1,"api-btm.c","setup_groups",0x11ff);
...
LAB_000844a8:
      ...
      iVar7 = toupper(uVar5 & 0xff);
      iVar8 = toupper(0x5a);
      if (iVar8 < iVar7) goto LAB_000844a8;
    }
    uVar6 = toupper(0x57);
    if ((uVar5 & 0xff) == uVar6) {
      iVar7 = toupper(0x57);
    ...
    iVar7 = toupper(uVar5 & 0xff);
    iVar8 = toupper(0x41);
    pcVar9 = (char *)_cgmalloc(sVar3 + 1,"api-btm.c","setup_groups",0x1265);
    apigroups[iVar7 - iVar8].commands = pcVar9;
    strcpy(apigroups[iVar7 - iVar8].commands,commands);
  } while( true );
}
