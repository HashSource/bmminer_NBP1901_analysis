...

{
  ...
  _mutex_lock(&stats_lock,"cgminer.c","update_work_stats",0x225d);
  ...
  dVar6 = dVar6 + work->device_diff;
  pcVar4 = thr->cgpu;
  iVar8 = __fixdfdi(SUB84(dVar6,0),(int)((ulonglong)dVar6 >> 0x20));
  pcVar4->diff1 = iVar8;
  ...
  _mutex_unlock(&stats_lock,"cgminer.c","update_work_stats",0x2262);
  return;
}
