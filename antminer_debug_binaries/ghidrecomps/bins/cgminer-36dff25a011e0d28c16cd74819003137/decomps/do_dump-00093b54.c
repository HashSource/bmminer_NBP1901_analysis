        ...
        if (iVar6 == 0) {
          ...
          if (iVar6 == 0) {
            if ((flags & 0x80) == 0) {
              do {
                while( true ) {
                  if (iter == (void *)0x0) goto LAB_000943c8;
              ...
              if (pvVar4 != (void *)0x0) {
                ...
                qsort(pvVar4,sVar1,4,compare_keys);
                i_1 = 0;
                do {
                  if (sVar1 <= i_1) {
                    jsonp_free(pvVar4);
...
object_error:
    ...
    case JSON_INTEGER:
      ...
      sVar1 = snprintf(buffer,100,"%lld",(int)((ulonglong)jVar7 >> 0x20),jVar7);
