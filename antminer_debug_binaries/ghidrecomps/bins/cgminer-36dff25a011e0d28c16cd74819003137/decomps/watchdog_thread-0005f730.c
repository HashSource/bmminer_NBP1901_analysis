  ...
  do {
    ...
    if ((sched_paused == true) || (_Var1 = should_run(), _Var1)) {
      if ((sched_paused != false) && (_Var1 = should_run(), _Var1)) {
        ...
        if ((schedstop.enable != false) &&
          ...
          in_stack_fffff7b8 = schedstop.tm.tm_min;
      ...
      if (schedstart.enable != true) {
        tmp42[0] = s_Terminating_execution_as_planned_000a5038[0];
        tmp42[1] = s_Terminating_execution_as_planned_000a5038[1];
        tmp42[2] = s_Terminating_execution_as_planned_000a5038[2];
        tmp42[3] = s_Terminating_execution_as_planned_000a5038[3];
        tmp42[4] = s_Terminating_execution_as_planned_000a5038[4];
        tmp42[5] = s_Terminating_execution_as_planned_000a5038[5];
        tmp42[6] = s_Terminating_execution_as_planned_000a5038[6];
        tmp42[7] = s_Terminating_execution_as_planned_000a5038[7];
        tmp42[8] = s_Terminating_execution_as_planned_000a5038[8];
        tmp42[9] = s_Terminating_execution_as_planned_000a5038[9];
        tmp42[10] = s_Terminating_execution_as_planned_000a5038[10];
        tmp42[11] = s_Terminating_execution_as_planned_000a5038[11];
        tmp42[12] = s_Terminating_execution_as_planned_000a5038[12];
        tmp42[13] = s_Terminating_execution_as_planned_000a5038[13];
        tmp42[14] = s_Terminating_execution_as_planned_000a5038[14];
        tmp42[15] = s_Terminating_execution_as_planned_000a5038[15];
        tmp42[16] = s_Terminating_execution_as_planned_000a5038[16];
        tmp42[17] = s_Terminating_execution_as_planned_000a5038[17];
        tmp42[18] = s_Terminating_execution_as_planned_000a5038[18];
        tmp42[19] = s_Terminating_execution_as_planned_000a5038[19];
        tmp42[20] = s_Terminating_execution_as_planned_000a5038[20];
        tmp42[21] = s_Terminating_execution_as_planned_000a5038[21];
        tmp42[22] = s_Terminating_execution_as_planned_000a5038[22];
        tmp42[23] = s_Terminating_execution_as_planned_000a5038[23];
        tmp42[24] = s_Terminating_execution_as_planned_000a5038[24];
        tmp42[25] = s_Terminating_execution_as_planned_000a5038[25];
        tmp42[26] = s_Terminating_execution_as_planned_000a5038[26];
        tmp42[27] = s_Terminating_execution_as_planned_000a5038[27];
        tmp42[28] = s_Terminating_execution_as_planned_000a5038[28];
        tmp42[29] = s_Terminating_execution_as_planned_000a5038[29];
        tmp42[30] = s_Terminating_execution_as_planned_000a5038[30];
        tmp42[31] = s_Terminating_execution_as_planned_000a5038[31];
        tmp42[32] = (char)ram0x000a5058;
    ...
    for (i = 0; i < total_devices; i = i + 1) {
      ...
      if (ptVar3 != (thr_info *)0x0) {
        ...
        in_stack_fffff7b8 = cgpu_00->device_id;
