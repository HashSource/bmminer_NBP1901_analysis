...
LAB_00026818:
    ...
    if (reg_value_buf.reg_value_num == 0) {
              ...
              if (4 < log_level) {
                ...
                if (pFVar4 != (FILE *)0x0) {
                  fprintf(pFVar4,"%s:%d:%s: chain[%02d] num[%d]: the asic CHIP_ADDRESS is 0x%08x\n",
                          "driver-btm-soc.c",0xb74,"check_asic_reg_oneChain",chainIndex,j,uVar5);
                }
                fclose(pFVar4);
              }
              break;
              ...
              if (3 < log_level) {
                ...
                if (pFVar4 != (FILE *)0x0) {
                  fprintf(pFVar4,
                          ...
                          "driver-btm-soc.c",0xba6,"check_asic_reg_oneChain",chainIndex,j,
            ...
            case '\x04':
              ...
              if ((int)uVar6 < 0x31) {
                for (ii = 0; ii < 4; ii = ii + 1) {
                  sprintf(rate_buf + ii * 2,"%02x",(uint)reg_buf[ii]);
                }
                uVar5 = strtol(rate_buf,(char **)0x0,0x10);
                ...
                tmp_rate._4_4_ = tmp_rate._4_4_ + bufsiz + (uint)bVar7;
                suffix_string_soc(6,buf,bufsiz,(int)displayed_rate_asic,true);
                if (3 < log_level) {
                  print_crt_time_to_file(log_file,3);
                  pFVar4 = fopen(log_file,"a+");
                  if (pFVar4 != (FILE *)0x0) {
                    fprintf(pFVar4,"%s:%d:%s: Asic[%02d]=%s ","driver-btm-soc.c",0xb9b,
                ...
                if ((((uVar6 & 7) == 0) || (uVar6 == 0x30)) && (3 < log_level)) {
                  print_crt_time_to_file(log_file,3);
                  pFVar4 = fopen(log_file,"a+");
                  if (pFVar4 != (FILE *)0x0) {
                    fprintf(pFVar4,"%s:%d:%s: \n","driver-btm-soc.c",0xba1,"check_asic_reg_oneChain"
                           );
                  }
                  fclose(pFVar4);
                }
              ...
              if (3 < log_level) {
                ...
                if (pFVar4 != (FILE *)0x0) {
                  fprintf(pFVar4,"%s:%d:%s: chain[%d]: the asic freq is 0x%x\n","driver-btm-soc.c",
                          0xb7a,"check_asic_reg_oneChain",chainIndex,uVar5);
                }
                fclose(pFVar4);
              }
              break;
              ...
              if (3 < log_level) {
                ...
                if (pFVar4 != (FILE *)0x0) {
                  fprintf(pFVar4,
                          ...
                          ,"driver-btm-soc.c",0xb82,"check_asic_reg_oneChain",chainIndex,uVar6,uVar5
                         );
                }
                fclose(pFVar4);
              }
              ...
              if (3 < log_level) {
                ...
                if (pFVar4 != (FILE *)0x0) {
                  fprintf(pFVar4,
                          ...
                          "driver-btm-soc.c",0xb7e,"check_asic_reg_oneChain",chainIndex,uVar6,uVar5)
                  ;
                }
                fclose(pFVar4);
              }
              ...
              if (4 < log_level) {
                ...
                if (pFVar4 != (FILE *)0x0) {
                  fprintf(pFVar4,"%s:%d:%s: chain[%02d] chip[%02d]: the misc is 0x%08x\n",
                          "driver-btm-soc.c",0xb77,"check_asic_reg_oneChain",chainIndex,read_num,
                          uVar5);
                }
                fclose(pFVar4);
              }
            ...
            if (4 < log_level) {
              ...
              if (pFVar4 != (FILE *)0x0) {
                ...
                fprintf(pFVar4,"%s:%d:%s: crc is 0x%x, but it should be 0x%x\n","driver-btm-soc.c",
                        0xb5c,"check_asic_reg_oneChain",(uint)bVar3,
      ...
      if ((reg_address == '\0') && (dev->chain_asic_num[chainIndex] == '0')) {
        pthread_mutex_unlock((pthread_mutex_t *)&reg_mutex);
        goto LAB_00026818;
      }
    }
