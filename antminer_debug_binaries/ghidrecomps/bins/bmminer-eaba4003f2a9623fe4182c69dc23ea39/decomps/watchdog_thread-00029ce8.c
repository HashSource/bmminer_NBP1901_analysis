  ...
  do {
    ...
    if ((sched_paused == true) || (_Var1 = should_run(), _Var1)) {
      if ((sched_paused != false) && (_Var1 = should_run(), _Var1)) {
        ...
        for (i = 0; i < mining_threads; i = i + 1) {
          ...
          if (ptVar3->cgpu->deven != DEV_DISABLED) {
            ...
            _cgsem_post(&ptVar3->sem,"cgminer.c","watchdog_thread",0x2851);
          }
        }
      }
    }
      ...
      if (schedstart.enable != true) {
        tmp42[0] = s_Terminating_execution_as_planned_000743f8[0];
        tmp42[1] = s_Terminating_execution_as_planned_000743f8[1];
        tmp42[2] = s_Terminating_execution_as_planned_000743f8[2];
        tmp42[3] = s_Terminating_execution_as_planned_000743f8[3];
        tmp42[4] = s_Terminating_execution_as_planned_000743f8[4];
        tmp42[5] = s_Terminating_execution_as_planned_000743f8[5];
        tmp42[6] = s_Terminating_execution_as_planned_000743f8[6];
        tmp42[7] = s_Terminating_execution_as_planned_000743f8[7];
        tmp42[8] = s_Terminating_execution_as_planned_000743f8[8];
        tmp42[9] = s_Terminating_execution_as_planned_000743f8[9];
        tmp42[10] = s_Terminating_execution_as_planned_000743f8[10];
        tmp42[11] = s_Terminating_execution_as_planned_000743f8[11];
        tmp42[12] = s_Terminating_execution_as_planned_000743f8[12];
        tmp42[13] = s_Terminating_execution_as_planned_000743f8[13];
        tmp42[14] = s_Terminating_execution_as_planned_000743f8[14];
        tmp42[15] = s_Terminating_execution_as_planned_000743f8[15];
        tmp42[16] = s_Terminating_execution_as_planned_000743f8[16];
        tmp42[17] = s_Terminating_execution_as_planned_000743f8[17];
        tmp42[18] = s_Terminating_execution_as_planned_000743f8[18];
        tmp42[19] = s_Terminating_execution_as_planned_000743f8[19];
        tmp42[20] = s_Terminating_execution_as_planned_000743f8[20];
        tmp42[21] = s_Terminating_execution_as_planned_000743f8[21];
        tmp42[22] = s_Terminating_execution_as_planned_000743f8[22];
        tmp42[23] = s_Terminating_execution_as_planned_000743f8[23];
        tmp42[24] = s_Terminating_execution_as_planned_000743f8[24];
        tmp42[25] = s_Terminating_execution_as_planned_000743f8[25];
        tmp42[26] = s_Terminating_execution_as_planned_000743f8[26];
        tmp42[27] = s_Terminating_execution_as_planned_000743f8[27];
        tmp42[28] = s_Terminating_execution_as_planned_000743f8[28];
        tmp42[29] = s_Terminating_execution_as_planned_000743f8[29];
        tmp42[30] = s_Terminating_execution_as_planned_000743f8[30];
        tmp42[31] = s_Terminating_execution_as_planned_000743f8[31];
        tmp42[32] = (char)ram0x00074418;
      ...
      sched_paused = true;
      _rd_lock(&mining_thr_lock,"cgminer.c","watchdog_thread",0x282f);
      for (i = 0; i < mining_threads; i = i + 1) {
        mining_thr[i]->pause = true;
      }
      _rd_unlock(&mining_thr_lock,"cgminer.c","watchdog_thread",0x2836);
    }
