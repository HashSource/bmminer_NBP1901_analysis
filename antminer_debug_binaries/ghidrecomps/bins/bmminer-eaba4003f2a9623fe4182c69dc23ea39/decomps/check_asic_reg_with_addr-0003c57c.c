  ...
  do {
    ...
    while (not_reg_data_time < 5) {
      ...
      if ((opt_debug != false) &&
        ...
        snprintf(tmp42,0x800,"%s: reg_value_num %d","check_asic_reg_with_addr",uVar2);
        ...
        if (reg_value_buf.reg_buffer[reg_value_buf.p_rd].chain_number == chain) {
          if (reg == 0x40) {
            if (check_core_register == 0) {
              uVar4 = uVar3 >> 0x18;
              core_hash_clock_delay_control[chain][chip_addr >> 1][uVar4] = (uchar)uVar3;
              if ((cc < 10) &&
                 (((cc = cc + 1, use_syslog != false || (opt_log_output != false)) ||
                  (4 < opt_log_level)))) {
                snprintf(tmp42,0x800,"chip %d CORE[%03d] 0x%08x %02x \n",(uint)(chip_addr >> 1),
                         uVar4,uVar3,
                         (uint)core_hash_clock_delay_control[chain][chip_addr >> 1][uVar4]);
                _applog(5,tmp42,false);
              }
              if (((uVar3 & 0xff) != 10) &&
                 (((use_syslog != false || (opt_log_output != false)) || (4 < opt_log_level)))) {
                snprintf(tmp42,0x800,"chain[%02d] chip[%02d] core[%d] clock delay control is 0x%08x"
                         ,(uint)reg_value_buf.reg_buffer[reg_value_buf.p_rd].chain_number,
                         (uint)chip_addr,uVar4,
                         (uint)core_hash_clock_delay_control[chain][chip_addr >> 1][uVar4]);
                _applog(5,tmp42,false);
              }
            }
              ...
              uVar4 = uVar3 & 0xff;
              core_hash_clock_counter[chain][chip_addr >> 1][uVar3 >> 0x18] = uVar3;
              if (((uVar4 != uVar1) && (uVar1 + 1 != uVar4)) &&
                 ((uVar1 - 1 != uVar4 &&
                  (((use_syslog != false || (opt_log_output != false)) || (4 < opt_log_level)))))) {
                snprintf(tmp42,0x800,
                         "chain[%02d] chip[%02d] core[%02d] hash clock counter is 0x%08x",
                         (uint)reg_value_buf.reg_buffer[reg_value_buf.p_rd].chain_number,
                         (uint)(chip_addr >> 1),uVar3 >> 0x18,uVar4);
                _applog(5,tmp42,false);
              }
            }
          ...
          if ((opt_debug != false) &&
             (((use_syslog != false || (opt_log_output != false)) || (6 < opt_log_level)))) {
            snprintf(tmp42,0x800,"%s: chip %x reg %x reg_buff %x","check_asic_reg_with_addr",
                     (uint)chip_addr,reg,uVar3);
            _applog(7,tmp42,false);
          }
    ...
    if ((opt_debug != false) &&
       (((use_syslog != false || (opt_log_output != false)) || (6 < opt_log_level)))) {
      snprintf(tmp42,0x800,"%s: last_get =%d, get=%d\n","check_asic_reg_with_addr",get_num,get_num);
      _applog(7,tmp42,false);
    }
  } while( true );
}
