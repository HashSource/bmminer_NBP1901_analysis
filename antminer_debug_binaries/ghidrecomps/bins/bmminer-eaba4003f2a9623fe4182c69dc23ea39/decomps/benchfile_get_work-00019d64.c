...

{
  ...
  if (benchfile_in == (FILE *)0x0) {
    if (opt_benchfile == (char *)0x0) {
      tmp42._0_4_ = s_BENCHFILE_Invalid_benchfile_NULL_00072c5c._0_4_;
      tmp42._4_4_ = s_BENCHFILE_Invalid_benchfile_NULL_00072c5c._4_4_;
      tmp42._8_4_ = s_BENCHFILE_Invalid_benchfile_NULL_00072c5c._8_4_;
      tmp42._12_4_ = s_BENCHFILE_Invalid_benchfile_NULL_00072c5c._12_4_;
      tmp42._16_4_ = s_BENCHFILE_Invalid_benchfile_NULL_00072c5c._16_4_;
      tmp42._20_4_ = s_BENCHFILE_Invalid_benchfile_NULL_00072c5c._20_4_;
      tmp42._24_4_ = s_BENCHFILE_Invalid_benchfile_NULL_00072c5c._24_4_;
      tmp42._28_4_ = s_BENCHFILE_Invalid_benchfile_NULL_00072c5c._28_4_;
      tmp42[32] = (char)ram0x00072c7c;
      ...
      if ((buf[0] != '\0') && ((buf[0] != '#' && (buf[0] != '/')))) {
        ...
        for (i = 1; i < 5; i = i + 1) {
          ...
          if ((benchfile_data[i + -1].length != 0) &&
             (benchfile_data[i + -1].length != (int)commas[i] - (int)commas[i + -1])) {
            snprintf(tmp42,0x800,
