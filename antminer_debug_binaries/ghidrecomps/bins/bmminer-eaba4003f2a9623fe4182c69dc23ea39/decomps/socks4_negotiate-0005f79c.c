...

{
  ...
  buf[3] = (char)iVar1;
  buf[8] = s_CGMINER_0007bc68[0];
  buf[9] = s_CGMINER_0007bc68[1];
  buf[10] = s_CGMINER_0007bc68[2];
  buf[11] = s_CGMINER_0007bc68[3];
  buf[12] = s_CGMINER_0007bc68[4];
  buf[13] = s_CGMINER_0007bc68[5];
  buf[14] = s_CGMINER_0007bc68[6];
  buf[15] = s_CGMINER_0007bc68[7];
  ...
  if (socks4a_local == true) {
    ...
    _cg_memcpy(buf + 0x10,pool->sockaddr_url,len,"util.c","socks4_negotiate",0xab2);
    iVar1 = len + 0x10;
    len = len + 0x10;
    buf[iVar1] = '\0';
    send(sockd,buf,len + 1,0);
  }
  else {
    if (inp == 0xffffffff) {
