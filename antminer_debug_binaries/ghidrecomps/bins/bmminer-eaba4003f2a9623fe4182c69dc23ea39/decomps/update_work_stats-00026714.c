...

{
  ...
  dVar6 = (double)__aeabi_ul2d(*(undefined4 *)&work->share_diff,
                               *(undefined4 *)((int)&work->share_diff + 4));
  if (dVar6 < (double)CONCAT44(uVar2,uVar1) == (NAN(dVar6) || NAN((double)CONCAT44(uVar2,uVar1)))) {
    work->block = true;
  ...
  dVar6 = dVar6 + work->device_diff;
  total_diff1 = __aeabi_d2lz(SUB84(dVar6,0),(int)((ulonglong)dVar6 >> 0x20));
  pcVar4 = thr->cgpu;
  dVar6 = (double)__aeabi_l2d(*(undefined4 *)&thr->cgpu->diff1,
                              *(undefined4 *)((int)&thr->cgpu->diff1 + 4));
  dVar6 = dVar6 + work->device_diff;
  iVar8 = __aeabi_d2lz(SUB84(dVar6,0),(int)((ulonglong)dVar6 >> 0x20));
  pcVar4->diff1 = iVar8;
  ppVar5 = work->pool;
  dVar6 = (double)__aeabi_l2d(*(undefined4 *)&work->pool->diff1,
                              *(undefined4 *)((int)&work->pool->diff1 + 4));
  dVar6 = dVar6 + work->device_diff;
  iVar8 = __aeabi_d2lz(SUB84(dVar6,0),(int)((ulonglong)dVar6 >> 0x20));
  ppVar5->diff1 = iVar8;
  pcVar4 = thr->cgpu;
