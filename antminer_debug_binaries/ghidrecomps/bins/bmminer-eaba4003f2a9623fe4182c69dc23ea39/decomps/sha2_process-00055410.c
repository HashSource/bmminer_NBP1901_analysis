...

{
  ...
  uVar41 = iVar39 + ((uVar34 >> 2 | uVar34 << 0x1e) ^ (uVar34 >> 0xd | uVar34 << 0x13) ^
                    ...
                    (ctx->state[2] & (uVar34 | uVar35) | uVar34 & uVar35);
  ...
  uVar27 = ((uVar23 >> 0x11 | uVar23 * 0x8000) ^ (uVar23 >> 0x13 | uVar23 * 0x2000) ^ uVar23 >> 10)
           + uVar13 +
           (uVar30 >> 3 ^
           (uVar30 >> 7 | (uint)data[0x3b] << 0x19) ^ (uVar28 >> 0x12 | uVar30 << 0xe)) + uVar27;
  iVar39 = ((uVar2 >> 6 | uVar2 * 0x4000000) ^ (uVar2 >> 0xb | uVar2 * 0x200000) ^
  ...
  uVar30 = ((uVar25 >> 0x11 | uVar25 * 0x8000) ^ (uVar25 >> 0x13 | uVar25 * 0x2000) ^ uVar25 >> 10)
           + uVar15 +
           (uVar33 >> 3 ^
           (uVar33 >> 7 | (uint)data[0x3f] << 0x19) ^ (uVar31 >> 0x12 | uVar33 << 0xe)) + uVar30;
  iVar39 = ((uVar4 >> 6 | uVar4 * 0x4000000) ^ (uVar4 >> 0xb | uVar4 * 0x200000) ^
  ...
  ctx->state[1] = ctx->state[1] + uVar30;
  ctx->state[2] = ctx->state[2] + uVar7;
  ctx->state[3] = ctx->state[3] + uVar5;
  ctx->state[4] = ctx->state[4] + uVar3 + iVar39;
