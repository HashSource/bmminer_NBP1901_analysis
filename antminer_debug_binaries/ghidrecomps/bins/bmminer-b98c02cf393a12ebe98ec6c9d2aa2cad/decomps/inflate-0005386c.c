...
LAB_000538dc:
  ...
  case (uint **)0x0:
    ...
    for (; ppuVar31 < (uint **)0x10; ppuVar31 = ppuVar31 + 2) {
      if (puVar30 == (uint *)0x0) goto LAB_0005402a;
...
LAB_00053ca2:
  ...
  case (uint **)0x2:
    pbVar7 = pbVar33;
    if (ppuVar31 < (uint **)0x20) goto LAB_00053ca2;
LAB_00053cca:
    if (puVar32[8] != 0) {
...
LAB_00053cea:
  ...
  case (uint **)0x3:
    pbVar7 = pbVar33;
    if (ppuVar31 < (uint **)0x10) goto LAB_00053cea;
LAB_00053d12:
    uVar21 = puVar32[8];
    if (uVar21 != 0) {
...
LAB_00053d9c:
    if (uVar23 != 0) {
      ...
      if (puVar17 != (uint *)0x0) goto LAB_0005402a;
      uVar21 = puVar32[4];
    }
    puVar32[0x10] = 0;
    *puVar32 = 6;
...
LAB_00053e86:
  ...
  case (uint **)0x4:
    uVar21 = puVar32[4];
    if ((int)(uVar21 << 0x15) < 0) goto joined_r0x000546a8;
    goto LAB_00054732;
  case (uint **)0x5:
    uVar21 = puVar32[4];
    uVar23 = uVar21 & 0x400;
  ...
  case (uint **)0x6:
    uVar21 = puVar32[4];
    goto joined_r0x000546c4;
  case (uint **)0x7:
    uVar21 = puVar32[4];
    goto joined_r0x00053e30;
  case (uint **)0x8:
    uVar21 = puVar32[4];
    goto LAB_00053e86;
  case (uint **)0x9:
  ...
  case (uint **)0xa:
    ...
    param_1[0xc] = (byte *)uVar36;
    *puVar32 = 0xb;
switchD_000538e2_caseD_b:
    if ((int)param_2 - 5U < 2) goto LAB_0005402a;
switchD_000538e2_caseD_c:
    if (puVar32[1] == 0) {
    ...
    goto LAB_000538dc;
  case (uint **)0xb:
    goto switchD_000538e2_caseD_b;
  case (uint **)0xc:
    goto switchD_000538e2_caseD_c;
  case (uint **)0xd:
...
LAB_00054186:
    if (puVar19 == (uint *)0x0) {
      ...
      *puVar32 = 0xb;
      ...
      if (puVar19 == (uint *)0x0) goto LAB_0005402a;
  ...
  case (uint **)0x10:
    ...
    if ((param_4 < (uint **)0x11f) && (puVar12 < (uint *)0x1f)) {
      ...
      *puVar32 = 0x11;
LAB_00054266:
      puVar8 = (ushort *)(DAT_00054584 + (uVar23 - 1) * 2);
      pbVar7 = pbVar33;
      do {
        uVar23 = uVar23 + 1;
        pbVar33 = pbVar7;
  ...
  case (uint **)0x11:
    uVar21 = puVar32[0x17];
    uVar23 = puVar32[0x1a];
    if (uVar23 < uVar21) goto LAB_00054266;
LAB_000542ae:
    if (uVar23 < 0x13) {
      puVar8 = (ushort *)(DAT_00054584 + (uVar23 - 1) * 2);
      do {
        puVar8 = puVar8 + 1;
        bVar34 = puVar8 != DAT_00054588;
...
LAB_00054326:
      ...
      uVar21 = puVar32[0x19];
      while (puVar12 = DAT_00055008, puVar17 < (uint *)(uVar21 + (int)local_50)) {
        uVar26 = puVar32[0x13];
...
LAB_000543f2:
          ...
          if ((uint *)(uVar21 + (int)local_50) < puVar12) goto LAB_00054f98;
          uVar26 = uVar23 - 1;
...
LAB_000544ce:
            ...
            if (uVar23 != uVar10) goto LAB_000544ce;
          }
      ...
      if (*(short *)(puVar32 + 0x9c) == 0) {
        ...
        *puVar32 = 0x1d;
        ...
        if (local_5c == 0) {
          ...
          puVar12 = DAT_00055018;
          local_5c = (int)uVar36;
          if (local_5c == 0) {
            *puVar32 = 0x13;
            if (param_2 == (uint *)0x6) goto LAB_0005402a;
switchD_000538e2_caseD_13:
            param_4 = (char *)0x14;
            *puVar32 = 0x14;
switchD_000538e2_caseD_14:
                ...
                *puVar32 = 0x19;
                ...
                if ((bVar2 & 0xf0) == 0) {
                  ...
                  *ppuVar14 = (uint *)ppuVar20;
                  param_4 = (char *)ppuVar14;
                  if (puVar12 == (uint *)0x0) goto LAB_00053b64;
                }
                else {
                  ppuVar28 = (uint **)((uint)ppuVar28 >> (int)param_4);
                  ppuVar31 = (uint **)((int)ppuVar31 - (int)param_4);
...
joined_r0x00054018:
                    ...
                    *puVar32 = 0x18;
switchD_000538e2_caseD_18:
                    puVar12 = DAT_00053d54;
                    if (local_70 == (uint *)0x0) goto LAB_0005402a;
                    uVar21 = puVar32[0x11];
...
LAB_000548e0:
                      ...
                      if (puVar16 != puVar19) goto LAB_000548e0;
                    }
  ...
  case (uint **)0x12:
    ...
    goto LAB_00054326;
  case (uint **)0x13:
    goto switchD_000538e2_caseD_13;
  case (uint **)0x14:
    goto switchD_000538e2_caseD_14;
  case (uint **)0x15:
    ppuVar14 = (uint **)puVar32[0x12];
    goto joined_r0x00054006;
  case (uint **)0x16:
    goto switchD_000538e2_caseD_16;
  case (uint **)0x17:
    ppuVar14 = (uint **)puVar32[0x12];
    goto joined_r0x00054018;
  case (uint **)0x18:
    goto switchD_000538e2_caseD_18;
  case (uint **)0x19:
    if (local_70 == (uint *)0x0) goto LAB_0005402a;
    param_4 = (char *)0x14;
...
LAB_00054636:
    ...
    *puVar32 = 0x1c;
    goto LAB_0005402a;
  case (uint **)0x1c:
    goto switchD_000538e2_caseD_1c;
  case (uint **)0x1d:
    local_5c = -3;
    goto LAB_0005402a;
  case (uint **)0x1e:
    return -4;
  default:
    goto switchD_000538e2_caseD_1f;
  }
  puVar12 = DAT_000541dc;
  param_4 = (char *)0x1d;
  ppuVar14 = (uint **)0x1d;
  param_1[6] = (byte *)DAT_000541dc;
  *puVar32 = 0x1d;
  goto LAB_000538dc;
switchD_000538e2_caseD_1c:
  local_5c = 1;
LAB_0005402a:
  uVar21 = puVar32[10];
  *param_1 = pbVar33;
