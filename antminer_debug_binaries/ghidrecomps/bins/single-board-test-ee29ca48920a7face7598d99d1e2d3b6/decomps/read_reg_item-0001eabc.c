  ...
  do {
    ...
    for (local_18 = 0; local_18 < 100; local_18 = local_18 + 1) {
      if (((((&reg_scan_items)[local_18 * 0xc] == *param_1) &&
           ((&DAT_00047ef9)[local_18 * 0xc] == param_1[1])) &&
          ((&DAT_00047efa)[local_18 * 0xc] == param_1[2])) &&
         (-1 < *(int *)(&DAT_00047f00 + local_18 * 0xc))) {
        *(undefined4 *)(param_1 + 4) = *(undefined4 *)(&DAT_00047efc + local_18 * 0xc);
        *(undefined4 *)(&DAT_00047f00 + local_18 * 0xc) = 0xffffffff;
