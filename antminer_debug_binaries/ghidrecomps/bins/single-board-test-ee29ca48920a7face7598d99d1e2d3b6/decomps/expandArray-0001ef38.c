...

{
  ...
  if (param_5 < 8) {
    ...
    __assert_fail("bit_len >= 8","bm1744/driver/sort-verify.c",0x3f,"expandArray");
  }
  if (0x20 < param_5 + 7) {
                    /* WARNING: Subroutine does not return */
    __assert_fail("8 * sizeof(uint32_t) >= 7 + bit_len","bm1744/driver/sort-verify.c",0x40,
                  "expandArray");
  }
  ...
  if (iVar1 != param_4) {
                    /* WARNING: Subroutine does not return */
    __assert_fail("out_len == 8 * out_width * in_len / bit_len","bm1744/driver/sort-verify.c",0x43,
                  "expandArray");
  }
  local_c = 0;
  local_10 = 0;
  ...
  for (local_18 = 0; local_18 < param_2; local_18 = local_18 + 1) {
    local_10 = local_10 << 8 | (uint)*(byte *)(local_18 + param_1);
    local_c = local_c + 8;
    if (param_5 <= local_c) {
      ...
      for (local_20 = param_6; local_20 < uVar2; local_20 = local_20 + 1) {
        *(byte *)(param_3 + local_20 + local_14) =
             ...
             & (byte)(local_10 >> (local_c + ((uVar2 - local_20) + 0x1fffffff) * 8 & 0xff));
      }
