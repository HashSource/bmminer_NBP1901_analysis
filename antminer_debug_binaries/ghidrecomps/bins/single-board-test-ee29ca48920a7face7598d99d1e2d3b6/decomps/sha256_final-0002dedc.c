...

{
  ...
  *(char *)(param_1 + iVar1 * 0x10 + 1) = (char)((uint)iVar2 >> 0x18);
  ...
  for (local_c = 0; local_c < 8; local_c = local_c + 1) {
    *(char *)(local_c * 4 + 3 + param_2) = (char)param_1[local_c + 0x22];
    *(char *)(local_c * 4 + 2 + param_2) = (char)((uint)param_1[local_c + 0x22] >> 8);
    *(char *)(local_c * 4 + 1 + param_2) = (char)((uint)param_1[local_c + 0x22] >> 0x10);
