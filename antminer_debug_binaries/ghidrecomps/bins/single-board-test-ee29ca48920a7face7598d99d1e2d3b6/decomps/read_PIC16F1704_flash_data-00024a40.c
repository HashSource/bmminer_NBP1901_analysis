...

{
  ...
  if (((use_syslog != '\0') || (opt_log_output != '\0')) || (1 < opt_log_level)) {
    snprintf(acStack_43c,0x400,
             ...
             ,"read_PIC16F1704_flash_data",local_34 & 0xff,local_34 >> 8 & 0xff,
             local_34 >> 0x10 & 0xff,local_34 >> 0x18,local_30 & 0xff,local_30 >> 8 & 0xff,
             local_30 >> 0x10 & 0xff,local_30 >> 0x18,local_2c & 0xff,local_2c >> 8 & 0xff,
    ...
    _applog(2,acStack_43c,0);
  }
  usleep(100000);
  if ((local_34._1_1_ == '\x03') && ((char)local_34 == '\x14')) {
    local_1c = (ushort)local_24._1_1_ +
               ...
               (ushort)(byte)local_2c +
               (ushort)local_30._3_1_ +
               (ushort)local_30._2_1_ +
               (ushort)local_30._1_1_ +
    ...
    if (((char)(local_1c >> 8) == local_24._2_1_) && ((char)local_1c == local_24._3_1_)) {
      ...
      if (((use_syslog != '\0') || (opt_log_output != '\0')) || (1 < opt_log_level)) {
        snprintf(acStack_43c,0x400,"--- %s failed! crc = 0x%04x\n\n","read_PIC16F1704_flash_data",
                 (uint)local_1c);
        _applog(2,acStack_43c,0);
      }
      uVar2 = 0;
    ...
    if (((use_syslog != '\0') || (opt_log_output != '\0')) || (1 < opt_log_level)) {
      snprintf(acStack_43c,0x400,"--- %s failed!\n\n","read_PIC16F1704_flash_data");
      _applog(2,acStack_43c,0);
    }
    uVar2 = 0;
  }
