...

{
  ...
  for (local_1c = 0; local_1c < 8; local_1c = local_1c + 1) {
    auStack_80[local_1c] = *(uint *)(local_1c * 4 + param_1);
  }
  for (local_1c = 0; local_1c < 0x40; local_1c = local_1c + 0x10) {
    for (local_20 = 0; local_20 < 0x10; local_20 = local_20 + 1) {
      ...
      uVar2 = auStack_80[6 - local_20 & 7];
      uVar1 = auStack_80[4 - local_20 & 7];
      uVar9 = auStack_80[5 - local_20 & 7];
      uVar7 = auStack_80[6 - local_20 & 7];
      iVar8 = *(int *)(&K + (local_20 + local_1c) * 4);
      if (local_1c == 0) {
        auStack_60[local_20] = *(uint *)(local_20 * 4 + param_2);
        uVar3 = auStack_60[local_20];
      }
      else {
        uVar3 = local_20 & 0xf;
        auStack_60[uVar3] =
        ...
        uVar3 = auStack_60[uVar3];
      }
      auStack_80[7 - local_20 & 7] =
           ((uVar4 >> 6 | uVar4 << 0x1a) ^ (uVar5 >> 0xb | uVar5 << 0x15) ^
           (uVar6 >> 0x19 | uVar6 << 7)) + ((uVar7 ^ uVar9) & uVar1 ^ uVar2) + iVar8 + uVar3 +
           auStack_80[7 - local_20 & 7];
  ...
  for (local_1c = 0; local_1c < 8; local_1c = local_1c + 1) {
    *(uint *)(param_1 + local_1c * 4) = auStack_80[local_1c] + *(int *)(local_1c * 4 + param_1);
  }
  return;
}
