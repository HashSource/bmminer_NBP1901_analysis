...

{
  ...
  if (((param_2 == (void *)0x0) || (param_3 == 0)) || (0x40 < param_3)) {
    ...
    if ((int)uVar3 == 0) {
      ...
      memset((void *)(param_1 + 0x60 + *(int *)(param_1 + 0x160)),0,
             0x100 - *(int *)(param_1 + 0x160));
      blake2b_compress(param_1,param_1 + 0x60);
      for (local_14 = 0; local_14 < 8; local_14 = local_14 + 1) {
        puVar2 = (undefined4 *)(local_14 * 8 + param_1);
        store64(auStack_54 + local_14 * 8,auStack_54 + local_14 * 8,*puVar2,puVar2[1]);
      }
      memcpy(param_2,auStack_54,(uint)param_3);
      uVar1 = 0;
    }
    else {
      uVar1 = 0xffffffff;
