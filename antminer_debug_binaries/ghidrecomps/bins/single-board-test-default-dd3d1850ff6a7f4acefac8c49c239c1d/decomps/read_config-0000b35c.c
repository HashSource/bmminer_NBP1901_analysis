  ...
  do {
    ...
    if (local_c == (char *)0x0) {
      ...
      if (local_c == (char *)0x0) {
                            ...
                            if (local_c == (char *)0x0) {
                              ...
                              if (local_c == (char *)0x0) {
                                ...
                                if (local_c == (char *)0x0) {
                                  ...
                                  if (local_c == (char *)0x0) {
                                    ...
                                    if (local_c == (char *)0x0) {
                                      ...
                                      if (local_c == (char *)0x0) {
                                        ...
                                        if (local_c == (char *)0x0) {
                                          ...
                                          if (local_c == (char *)0x0) {
                                            ...
                                            if (local_c == (char *)0x0) {
                                              ...
                                              if (local_c == (char *)0x0) {
                                                ...
                                                if (local_c == (char *)0x0) {
                                                  ...
                                                  if (local_c == (char *)0x0) {
                                                        ...
                                                        if (local_c == (char *)0x0) {
                                                          ...
                                                          if (local_c == (char *)0x0) {
                                                            ...
                                                            if (local_c != (char *)0x0) {
                                                              ...
                                                              __isoc99_sscanf(local_c,&DAT_0001a1fc,
                                                                              local_14 + 0xf4);
                                                            }
                                                          }
                                                          else {
                                                    ...
                                                    __isoc99_sscanf(local_c,&DAT_0001a1fc,
                                                                    local_14 + 0xe0);
                                                    __isoc99_sscanf(local_c,&DAT_0001a1fc,&local_420
                                                                   );
                                                    if (local_420 < 0) {
                                                      local_420 = -local_420;
                                                    ...
                                                    local_c = local_c + 0xc;
                                                    __isoc99_sscanf(local_c,&DAT_0001a33c,
                                                                    local_14 + 0xde);
                                                    if (local_14[0xde] != '\0') {
                                                    ...
                                                    local_c = local_c + 0xf;
                                                    __isoc99_sscanf(local_c,&DAT_0001a2f8,
                                                                    local_14 + 0xd8);
                                                  }
                                                  }
                                                  else {
                                              ...
                                              local_c = local_c + 9;
                                              __isoc99_sscanf(local_c,&DAT_0001a1fc,local_14 + 0xb8)
                                              ;
                                            ...
                                            local_c = local_c + 9;
                                            __isoc99_sscanf(local_c,&DAT_0001a1fc,local_14 + 0xb4);
                                          ...
                                          local_c = local_c + 9;
                                          __isoc99_sscanf(local_c,&DAT_0001a1fc,local_14 + 0xb0);
                                        ...
                                        local_c = local_c + 9;
                                        __isoc99_sscanf(local_c,&DAT_0001a1fc,local_14 + 0xac);
                                      ...
                                      local_c = local_c + 9;
                                      __isoc99_sscanf(local_c,&DAT_0001a1fc,local_14 + 0xa8);
                                    ...
                                    local_c = local_c + 9;
                                    __isoc99_sscanf(local_c,&DAT_0001a1fc,local_14 + 0xa4);
                                  ...
                                  local_c = local_c + 9;
                                  __isoc99_sscanf(local_c,&DAT_0001a1fc,local_14 + 0xa0);
                                ...
                                local_c = local_c + 9;
                                __isoc99_sscanf(local_c,&DAT_0001a1fc,local_14 + 0x9c);
                              ...
                              local_c = local_c + 6;
                              __isoc99_sscanf(local_c,&DAT_0001a1fc,local_14 + 0x68);
                            }
                          }
                          else {
                            local_c = local_c + 6;
                            __isoc99_sscanf(local_c,&DAT_0001a1fc,local_14 + 100);
                          }
                        }
                        else {
                          local_c = local_c + 6;
                          __isoc99_sscanf(local_c,&DAT_0001a1fc,local_14 + 0x60);
                        }
                      }
                      else {
                        local_c = local_c + 6;
                        __isoc99_sscanf(local_c,&DAT_0001a1fc,local_14 + 0x5c);
                      }
                    }
                    else {
                      local_c = local_c + 6;
                      __isoc99_sscanf(local_c,&DAT_0001a1fc,local_14 + 0x58);
                    }
                  }
                  else {
                    local_c = local_c + 6;
                    __isoc99_sscanf(local_c,&DAT_0001a1fc,local_14 + 0x54);
                  }
                }
                else {
                  local_c = local_c + 6;
                  __isoc99_sscanf(local_c,&DAT_0001a1fc,local_14 + 0x50);
                }
              }
              else {
                local_c = local_c + 6;
                __isoc99_sscanf(local_c,&DAT_0001a1fc,local_14 + 0x4c);
              }
            }
            else {
              local_c = local_c + 6;
              __isoc99_sscanf(local_c,&DAT_0001a1fc,local_14 + 0x48);
            }
          }
          else {
            local_c = local_c + 9;
            __isoc99_sscanf(local_c,&DAT_0001a1fc,local_14 + 0x74);
          }
        }
        else {
          local_c = local_c + 8;
          __isoc99_sscanf(local_c,&DAT_0001a1fc,local_14 + 0x6c);
        ...
        local_c = local_c + 0xf;
        __isoc99_sscanf(local_c,&DAT_0001a1fc,local_14 + 0x40);
    ...
    if ((*(int *)(local_14 + 0x6c) == 1) && (*(int *)(local_14 + 0x74) == 0x569)) {
      strcpy(DAT_0000c3bc,Single_BM1385_WorkDataPathPrefix);
      strcpy(DAT_0000c3c0,BTC_WorkDataFilePrefix);
      *(undefined4 *)(local_14 + 0x70) = 0x32;
    }
    if (gHashBoard_V9 != '\0') {
      strcpy(DAT_0000c3bc,V9_WorkDataPathPrefix);
      strcpy(DAT_0000c3c0,BTC_WorkDataFilePrefix);
