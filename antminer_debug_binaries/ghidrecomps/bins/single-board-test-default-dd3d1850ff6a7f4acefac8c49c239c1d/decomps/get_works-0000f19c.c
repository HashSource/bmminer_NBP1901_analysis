  ...
  if (Conf._108_4_ == 1) {
    for (local_14 = 0; local_14 < local_28; local_14 = local_14 + 1) {
      for (; local_2c < (int)local_24; local_2c = local_2c + 1) {
        if (local_2c < 0x20) {
          if ((local_38 & 1) != 0) {
            sprintf(acStack_8c,"%s%s%02i.txt",DAT_0000f5c4,DAT_0000f5c8,local_2c);
            local_2c = local_2c + 1;
            local_38 = local_38 >> 1;
            break;
          }
    ...
    for (local_34 = 0; local_34 < local_20; local_34 = local_34 + 1) {
      pvVar2 = malloc(local_24 * Conf._64_4_ * 0x74);
      *(void **)(cgpu + (local_34 + 0x402a) * 4 + 4) = pvVar2;
      ...
      for (local_30 = 0; local_30 < local_24; local_30 = local_30 + 1) {
        sprintf(acStack_8c,"%s%02i%s%02i.txt",DAT_0000f5c4,local_34,DAT_0000f5c8,local_30);
