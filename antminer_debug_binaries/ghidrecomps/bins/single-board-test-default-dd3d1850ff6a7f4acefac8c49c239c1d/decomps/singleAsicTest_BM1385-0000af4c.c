...

{
  ...
  local_18 = 0;
  local_1c = 0x1e240;
  local_2c = s__singleAsicTest_BM1385_00019f84._0_4_;
  uStack_28 = s__singleAsicTest_BM1385_00019f84._4_4_;
  uStack_24 = s__singleAsicTest_BM1385_00019f84._8_4_;
  uStack_20 = s__singleAsicTest_BM1385_00019f84._12_4_;
  ...
  if (gChain == 0xff) {
    ...
    pthread_create(DAT_0000b350,(pthread_attr_t *)0x0,single_BM1385_show_status_func + 1,
                   chain_info + (uint)gChain * 2);
    reset_hash_board();
    start_receive = 1;
    pthread_create(DAT_0000b354,(pthread_attr_t *)0x0,single_BM1385_receive_func + 1,
                   chain_info + (uint)gChain * 2);
    puts("\n--- check asic number");
    ...
    if ((uint)(byte)cgpu[gChain + 0x20338] == Conf._108_4_) {
      ...
      putchar(10);
      gStartTest = 1;
      pthread_create(DAT_0000b358,(pthread_attr_t *)0x0,single_BM1385_send_func + 1,
                     chain_info + (uint)gChain * 2);
