...

{
  ...
  local_18 = 0;
  local_1c = 0x1e240;
  local_2c = s__singleBoardTest_V9_BM1385_45_0001c2bc._0_4_;
  uStack_28 = s__singleBoardTest_V9_BM1385_45_0001c2bc._4_4_;
  uStack_24 = s__singleBoardTest_V9_BM1385_45_0001c2bc._8_4_;
  uStack_20 = s__singleBoardTest_V9_BM1385_45_0001c2bc._12_4_;
  ...
  if (gChain == 0xff) {
    ...
    pthread_create(DAT_00018b34,(pthread_attr_t *)0x0,V9_show_status_func + 1,
    ...
    pthread_create(DAT_00018b38,(pthread_attr_t *)0x0,pic_heart_beat_func + 1,
                   chain_info + (uint)gChain * 2);
    reset_hash_board();
    start_receive = 1;
    pthread_create(DAT_00018b3c,(pthread_attr_t *)0x0,V9_receive_func + 1,
                   chain_info + (uint)gChain * 2);
    ...
    if ((uint)(byte)cgpu[gChain + 0x20338] == Conf._108_4_) {
      ...
      if ((uint)(byte)cgpu[gChain + 0x20338] == Conf._108_4_) {
        ...
        pthread_create(DAT_00018fc4,(pthread_attr_t *)0x0,V9_send_func + 1,
                       chain_info + (uint)gChain * 2);
