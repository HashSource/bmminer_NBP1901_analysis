...

{
  ...
  local_48 = 0;
  local_4c = 0;
  local_24 = Conf._204_4_;
  local_28 = Conf._208_4_;
  local_2c = Conf._212_4_;
  local_30 = Conf._216_4_;
  ...
  for (local_1c = 0; local_1c < local_18; local_1c = local_1c + 1) {
    ...
    for (local_14 = 0; local_14 < (uint)Conf._64_4_; local_14 = local_14 + 1) {
      ...
      memset(local_94,0,0x40);
      for (local_20 = 0; local_20 < 0x20; local_20 = local_20 + 1) {
        local_94[local_20] = *(undefined *)((int)local_54 + local_20 + 0x14);
      }
      ...
      for (local_20 = 0; local_20 < 0xc; local_20 = local_20 + 1) {
        auStack_60[local_20] = *(undefined *)((int)local_54 + local_20 + 8);
      }
      uart_send(local_35,local_94,0x40);
      for (local_20 = 0; local_20 < 0x13; local_20 = local_20 + 1) {
        memcpy(gWorks_For_Hw_Check + (uint)local_35 * 0x910 + local_20 * 0x74 + 0x74,
               gWorks_For_Hw_Check + (uint)local_35 * 0x910 + local_20 * 0x74,0x74);
      }
      gWork_Num_For_Hw_Check = gWork_Num_For_Hw_Check + 1;
      if (0x12 < gWork_Num_For_Hw_Check) {
        gWork_Num_For_Hw_Check = 0x13;
      }
      memcpy(gWorks_For_Hw_Check + (uint)local_35 * 0x910,local_54,0x74);
      *(int *)(gSend_Work_Num + (uint)local_35 * 4) =
           *(int *)(gSend_Work_Num + (uint)local_35 * 4) + 1;
      usleep(Conf._196_4_);
    }
  }
  while (*(uint *)(gSend_Work_Num + (uint)local_35 * 4) < local_18 * Conf._64_4_) {
    printf("\n\n---%s: Chain%d send work num : %d, less than %d\n","single_BM1385_send_func",
           (uint)local_35,*(undefined4 *)(gSend_Work_Num + (uint)local_35 * 4),Conf._64_4_ * 0x32);
  }
  printf("\n\n---%s: Chain%d send work num : %d\n","single_BM1385_send_func",(uint)local_35,
         *(undefined4 *)(gSend_Work_Num + (uint)local_35 * 4));
