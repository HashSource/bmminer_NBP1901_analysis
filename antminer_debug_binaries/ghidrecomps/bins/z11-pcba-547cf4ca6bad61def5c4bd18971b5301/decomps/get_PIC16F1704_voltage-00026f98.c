...

{
  ...
  if (((use_syslog != '\0') || (opt_log_output != '\0')) || (1 < opt_log_level)) {
    snprintf(acStack_428,0x400,
             ...
             ,"get_PIC16F1704_voltage",local_20 & 0xff,local_20 >> 8 & 0xff,local_20 >> 0x10 & 0xff,
             local_20 >> 0x18,(uint)local_1c);
    _applog(2,acStack_428,0);
  }
  if ((local_20._1_1_ == '\x18') && ((char)local_20 == '\x05')) {
    local_14 = local_20._2_1_ + 0x1d;
    if (((char)(local_14 >> 8) == local_20._3_1_) && ((byte)local_14 == local_1c)) {
      *param_3 = local_20._2_1_;
      if (((use_syslog != '\0') || (opt_log_output != '\0')) || (1 < opt_log_level)) {
        snprintf(acStack_428,0x400,"--- %s ok, voltage = 0x%02x\n\n","get_PIC16F1704_voltage",
                 (uint)*param_3);
        _applog(2,acStack_428,0);
      }
      uVar2 = 1;
