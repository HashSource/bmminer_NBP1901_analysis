...
undefined4 reset_PIC16F1704_pic(undefined param_1,undefined param_2)

{
  ...
  usleep(1000000);
  if (((byte)local_1c == 7) && (local_1c._1_1_ == 1)) {
    ...
    if (((use_syslog != '\0') || (opt_log_output != '\0')) || (1 < opt_log_level)) {
      snprintf(acStack_424,0x400,
               ...
               "reset_PIC16F1704_pic",(uint)(byte)local_1c,(uint)local_1c._1_1_);
      _applog(2,acStack_424,0);
    }
    uVar2 = 0;
  }
