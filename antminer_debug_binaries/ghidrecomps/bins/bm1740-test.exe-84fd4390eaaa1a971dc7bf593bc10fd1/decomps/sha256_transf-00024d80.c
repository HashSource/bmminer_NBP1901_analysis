...

{
  ...
  for (local_c = 0; local_c < param_3; local_c = local_c + 1) {
    ...
    for (local_10 = 0; local_10 < 0x10; local_10 = local_10 + 1) {
      local_11c[local_10] =
           CONCAT13(*(undefined *)(iVar2 + local_10 * 4),
                    CONCAT12(*(undefined *)(iVar2 + local_10 * 4 + 1),
                             CONCAT11(*(undefined *)(iVar2 + local_10 * 4 + 2),
                                      *(undefined *)(iVar2 + local_10 * 4 + 3))));
    }
    ...
    for (local_10 = 0; local_10 < 0x40; local_10 = local_10 + 1) {
      ...
      local_13c[0] = iVar2 + ((local_13c[0] >> 2 | local_13c[0] << 0x1e) ^
                              (local_13c[0] >> 0xd | local_13c[0] << 0x13) ^
                             (local_13c[0] >> 0x16 | local_13c[0] << 10)) + (uVar4 ^ uVar1 ^ uVar3);
    }
    for (local_10 = 0; local_10 < 8; local_10 = local_10 + 1) {
