...

{
  ...
  if ((int)(uint)local_22 <
    ...
    *(ushort *)(param_1 + 1) =
         *(ushort *)(param_1 + 1) & 1 |
         (ushort)(((((uint)*(ushort *)(param_1 + 1) << 0x10) >> 0x11) + (uint)local_22 & 0x7fff) <<
                 1);
    pthread_mutex_unlock((pthread_mutex_t *)(param_1 + 4));
    ...
    memcpy((void *)((int)param_2 +
           ...
           (uint)local_22 +
           ((((uint)*(ushort *)(param_1 + 1) << 0x10) >> 0x11) - (uint)*(ushort *)(param_1 + 3)));
    *(byte *)(param_1 + 1) =
         *(byte *)(param_1 + 1) & 0xfe | ~(byte)(((uint)*(byte *)(param_1 + 1) << 0x1f) >> 0x1f) & 1
    ;
    *(ushort *)(param_1 + 1) =
         *(ushort *)(param_1 + 1) & 1 |
         (ushort)((((((uint)*(ushort *)(param_1 + 1) << 0x10) >> 0x11) -
