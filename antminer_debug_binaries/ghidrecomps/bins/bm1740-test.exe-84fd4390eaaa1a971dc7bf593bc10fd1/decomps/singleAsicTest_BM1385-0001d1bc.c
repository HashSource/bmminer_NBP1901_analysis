...

{
  ...
  local_18 = 0;
  local_1c = 0x1e240;
  local_2c = s__singleAsicTest_BM1385_0002d820._0_4_;
  uStack_28 = s__singleAsicTest_BM1385_0002d820._4_4_;
  uStack_24 = s__singleAsicTest_BM1385_0002d820._8_4_;
  uStack_20 = s__singleAsicTest_BM1385_0002d820._12_4_;
  ...
  if (gChain == 0xff) {
    ...
    pthread_create(DAT_0001d5c0,(pthread_attr_t *)0x0,single_BM1385_show_status_func + 1,
                   &chain_info + gChain);
    reset_hash_board();
    start_receive = 1;
    pthread_create(DAT_0001d5c4,(pthread_attr_t *)0x0,single_BM1385_receive_func + 1,
                   &chain_info + gChain);
    puts("\n--- check asic number");
    check_BM1385_asic_reg(gChain,0,0,1);
    printf("\n--- check chain: asicNum = %d\n",(uint)(byte)cgpu[gChain + 0x202fc]);
    if ((uint)(byte)cgpu[gChain + 0x202fc] == Conf._108_4_) {
      single_BM1385_calculate_timeout_and_baud();
      set_BM1385_freq(gChain,0,Conf._68_4_,1);
      single_BM1385_set_address(gChain);
      check_BM1385_asic_reg(gChain,0,0,1);
      single_BM1385_set_baud(gChain,Conf._268_4_ & 0xff);
      single_BM1385_open_core(gChain);
      puts("\nBegin send test pattern");
      system("date");
      putchar(10);
      gStartTest = 1;
      pthread_create(DAT_0001d5c8,(pthread_attr_t *)0x0,single_BM1385_send_func + 1,
                     &chain_info + gChain);
      ...
      pthread_cancel(cgpu._65540_4_);
      pthread_cancel(cgpu._65544_4_);
      sprintf((char *)((int)&uStack_28 + 3),"%d",(uint)(byte)cgpu[gChain + 0x202fc]);
