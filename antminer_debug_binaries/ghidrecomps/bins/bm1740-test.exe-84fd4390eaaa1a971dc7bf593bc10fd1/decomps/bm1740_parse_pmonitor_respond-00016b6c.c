...
undefined4 bm1740_parse_pmonitor_respond(int param_1,int param_2,void *param_3,uint param_4)

{
  ...
  if ((param_2 == 9) && (8 < param_4)) {
    local_15 = CRC5(param_1 + 2,0x33);
    if (local_15 == (*(byte *)(local_14 + 8) & 0x1f)) {
      memcpy(param_3,&local_11c,9);
      uVar1 = 9;
    }
    else {
      if (((use_syslog != '\0') || (opt_log_output != '\0')) || (-1 < opt_log_level)) {
        snprintf(acStack_118,0x100,"%s CRC error. cal-crc=%x, chip-crc=%x\n",
                 "bm1740_parse_pmonitor_respond",(uint)local_15,*(byte *)(local_14 + 8) & 0x1f);
