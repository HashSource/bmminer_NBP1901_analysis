...

{
  ...
  if (param_5 < 8) {
    ...
    __assert_fail("bit_len >= 8","bm1740/sort-verify.c",0x15,"compressArray");
  }
  if (0x20 < param_5 + 7) {
                    /* WARNING: Subroutine does not return */
    __assert_fail("8 * sizeof(uint32_t) >= 7 + bit_len","bm1740/sort-verify.c",0x16,"compressArray")
    ;
  }
  ...
  if (uVar1 != param_4) {
                    /* WARNING: Subroutine does not return */
    __assert_fail("out_len == bit_len * in_len / (8 * in_width)","bm1740/sort-verify.c",0x19,
                  "compressArray");
  }
  local_c = 0;
  local_10 = 0;
  ...
  for (local_18 = 0; local_18 < param_4; local_18 = local_18 + 1) {
    if (local_c < 8) {
      ...
      for (local_1c = param_6; local_1c < uVar2; local_1c = local_1c + 1) {
        local_10 = ((1 << (param_5 & 0xff)) - 1U >> (((uVar2 - local_1c) + 0x1fffffff) * 8 & 0xff) &
                   (uint)*(byte *)(param_1 + local_14 + local_1c)) <<
    ...
    local_c = local_c - 8;
    *(char *)(param_3 + local_18) = (char)(local_10 >> (local_c & 0xff));
  }
  return;
}
