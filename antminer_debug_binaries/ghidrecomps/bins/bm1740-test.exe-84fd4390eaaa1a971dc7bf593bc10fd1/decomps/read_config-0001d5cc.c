  ...
  do {
    ...
    if (local_c == (char *)0x0) {
      ...
      if (local_c == (char *)0x0) {
                            ...
                            if (local_c == (char *)0x0) {
                              ...
                              if (local_c == (char *)0x0) {
                                ...
                                if (local_c == (char *)0x0) {
                                  ...
                                  if (local_c == (char *)0x0) {
                                    ...
                                    if (local_c == (char *)0x0) {
                                      ...
                                      if (local_c == (char *)0x0) {
                                        ...
                                        if (local_c == (char *)0x0) {
                                          ...
                                          if (local_c == (char *)0x0) {
                                            ...
                                            if (local_c == (char *)0x0) {
                                                  ...
                                                  if (local_c == (char *)0x0) {
                                                    ...
                                                    if (local_c == (char *)0x0) {
                                                      ...
                                                      if (local_c != (char *)0x0) {
                                                        ...
                                                        __isoc99_sscanf(local_c,&DAT_0002da98,
                                                                        local_14 + 0x110);
                                                      }
                                                    }
                                                    else {
                                                    ...
                                                    __isoc99_sscanf(local_c,&DAT_0002da98,
                                                                    local_14 + 0xe0);
                                                    __isoc99_sscanf(local_c,&DAT_0002da98,&local_420
                                                                   );
                                                    if (local_420 < 0) {
                                                      local_420 = -local_420;
                                                    ...
                                                    local_c = local_c + 0xc;
                                                    __isoc99_sscanf(local_c,&DAT_0002dbd8,
                                                                    local_14 + 0xde);
                                                    if (local_14[0xde] != '\0') {
                                                    ...
                                                    __isoc99_sscanf(local_c,&DAT_0002dbd8,
                                                                    local_14 + 0x104);
                                                    if (local_14[0x104] == '\x06') {
                                                      gSensor_i2c_addr_high_4_bit = 0x9a0000;
                                                    }
                                                    else if (local_14[0x104] == '\a') {
                                                    ...
                                                    local_c = local_c + 0xf;
                                                    __isoc99_sscanf(local_c,&DAT_0002db94,
                                                                    local_14 + 0xd8);
                                                  }
                                                  }
                                                  else {
                                              ...
                                              local_c = local_c + 9;
                                              __isoc99_sscanf(local_c,&DAT_0002da98,local_14 + 0xb8)
                                              ;
                                            ...
                                            local_c = local_c + 9;
                                            __isoc99_sscanf(local_c,&DAT_0002da98,local_14 + 0xb4);
                                          ...
                                          local_c = local_c + 9;
                                          __isoc99_sscanf(local_c,&DAT_0002da98,local_14 + 0xb0);
                                        ...
                                        local_c = local_c + 9;
                                        __isoc99_sscanf(local_c,&DAT_0002da98,local_14 + 0xac);
                                      ...
                                      local_c = local_c + 9;
                                      __isoc99_sscanf(local_c,&DAT_0002da98,local_14 + 0xa8);
                                    ...
                                    local_c = local_c + 9;
                                    __isoc99_sscanf(local_c,&DAT_0002da98,local_14 + 0xa4);
                                  ...
                                  local_c = local_c + 9;
                                  __isoc99_sscanf(local_c,&DAT_0002da98,local_14 + 0xa0);
                                ...
                                local_c = local_c + 9;
                                __isoc99_sscanf(local_c,&DAT_0002da98,local_14 + 0x9c);
                              ...
                              local_c = local_c + 6;
                              __isoc99_sscanf(local_c,&DAT_0002da98,local_14 + 0x68);
                            }
                          }
                          else {
                            local_c = local_c + 6;
                            __isoc99_sscanf(local_c,&DAT_0002da98,local_14 + 100);
                          }
                        }
                        else {
                          local_c = local_c + 6;
                          __isoc99_sscanf(local_c,&DAT_0002da98,local_14 + 0x60);
                        }
                      }
                      else {
                        local_c = local_c + 6;
                        __isoc99_sscanf(local_c,&DAT_0002da98,local_14 + 0x5c);
                      }
                    }
                    else {
                      local_c = local_c + 6;
                      __isoc99_sscanf(local_c,&DAT_0002da98,local_14 + 0x58);
                    }
                  }
                  else {
                    local_c = local_c + 6;
                    __isoc99_sscanf(local_c,&DAT_0002da98,local_14 + 0x54);
                  }
                }
                else {
                  local_c = local_c + 6;
                  __isoc99_sscanf(local_c,&DAT_0002da98,local_14 + 0x50);
                }
              }
              else {
                local_c = local_c + 6;
                __isoc99_sscanf(local_c,&DAT_0002da98,local_14 + 0x4c);
              }
            }
            else {
              local_c = local_c + 6;
              __isoc99_sscanf(local_c,&DAT_0002da98,local_14 + 0x48);
            }
          }
          else {
            local_c = local_c + 9;
            __isoc99_sscanf(local_c,&DAT_0002da98,local_14 + 0x74);
          }
        }
        else {
          local_c = local_c + 8;
          __isoc99_sscanf(local_c,&DAT_0002da98,local_14 + 0x6c);
        ...
        local_c = local_c + 0xf;
        __isoc99_sscanf(local_c,&DAT_0002da98,local_14 + 0x40);
    ...
    if ((*(int *)(local_14 + 0x6c) == 1) && (*(int *)(local_14 + 0x74) == 0x569)) {
      strcpy(DAT_0001e738,Single_BM1385_WorkDataPathPrefix);
      strcpy(DAT_0001e73c,BTC_WorkDataFilePrefix);
      *(undefined4 *)(local_14 + 0x70) = 0x32;
    }
    if (gHashBoard_V9 != '\0') {
      strcpy(DAT_0001e738,V9_WorkDataPathPrefix);
      strcpy(DAT_0001e73c,BTC_WorkDataFilePrefix);
      *(undefined4 *)(local_14 + 0x6c) = 4;
      *(undefined4 *)(local_14 + 0x70) = 0x32;
