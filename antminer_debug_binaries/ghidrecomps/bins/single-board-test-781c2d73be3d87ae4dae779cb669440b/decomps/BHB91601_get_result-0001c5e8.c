...
uint BHB91601_get_result(uchar which_chain)

{
  ...
  if (BHB91601_ASIC_NUMBER != 0) {
    ...
    do {
      ...
      uVar2 = uVar5;
    } while (uVar5 < BHB91601_ASIC_NUMBER);
  }
  puts("\n");
  if (BHB91601_ASIC_NUMBER == 0) {
    local_30 = 7;
    ...
    local_30 = 7;
    local_3c = 0;
    local_38 = (uint *)(DAT_0001c924 + uVar4 * 0x80000);
    do {
            ...
            if (Conf.pattern_number != 0) {
              do {
                while (pwVar7[Conf.pattern_number * iVar6 + uVar2].is_nonce_return_back[uVar4][0] !=
                       0) {
                  uVar2 = uVar2 + 1;
                  if (Conf.pattern_number <= uVar2) goto LAB_0001c770;
                }
                printf("%d  ",uVar2);
                uVar2 = uVar2 + 1;
...
LAB_0001c770:
      ...
      local_3c = local_3c + 1;
    } while (local_3c < BHB91601_ASIC_NUMBER);
  }
  ...
  if ((gSensor_OK[uVar4][2] & gSensor_OK[uVar4][1] & gSensor_OK[uVar4][0] & gSensor_OK[uVar4][3]) ==
      0) {
    local_30 = local_30 & 0xfffffffd;
  }
  if (Conf.TargetTemp < gGlobalHighestTemp) {
    local_30 = local_30 & 0xfffffffb;
  }
  printf("Chain%d total valid nonce number: %d, lost %d nonce\n\n",uVar4,gValid_Nonce_Num[uVar4],
         BHB91601_ASIC_NUMBER * Conf.pattern_number * 0x100 - gValid_Nonce_Num[uVar4]);
  printf("Nonce rate = %f \n\n");
