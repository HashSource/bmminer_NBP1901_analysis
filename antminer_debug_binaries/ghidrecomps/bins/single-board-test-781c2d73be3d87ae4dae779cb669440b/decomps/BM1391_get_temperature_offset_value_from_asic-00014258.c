...
void BM1391_get_temperature_offset_value_from_asic(uchar which_chain)

{
  ...
  local_34 = &gBM1391_MISC_CONTROL_reg;
  local_38 = 0;
  iVar9 = 0;
  local_3c = 0;
  offset_value[0] = '\0';
  ...
  do {
    ...
    if (uVar8 != 0) {
      ...
      cVar3 = uVar2 + 0xff;
      uVar8 = 0;
      BM1391_set_config(which_chain,(char)gChain_Asic_Interval * cVar3,'\x18',*local_34 | 0x4030,
                        false);
      check_BM1391_asic_reg(which_chain,(char)gChain_Asic_Interval * cVar3,'\x18',false);
      do {
        uVar8 = uVar8 + 1;
        uVar5 = check_BM1391_asic_reg(which_chain,(char)gChain_Asic_Interval * cVar3,'\x1c',false);
        if ((uVar5 & 0xc0000000) == 0) break;
      } while (uVar8 < read_loop);
      uVar8 = 0;
      BM1391_set_config(which_chain,(char)gChain_Asic_Interval * cVar3,'\x1c',
...
LAB_00014488:
      ...
      if (iVar9 == 0) {
        ...
        *DAT_00014580 = cVar4 + uVar2;
        offset_value[3] = cVar4 + uVar2;
      }
      else {
        uVar1 = *DAT_00014578;
        gT3_offset_value = cVar3;
        *DAT_00014578 = cVar4 + uVar1;
    ...
    if (iVar9 == 3) {
      ...
      if ((pattern_test_time == '\0') && (Conf.AsicNum != 1)) {
        if ((gHashBoard_BHB91601P == false) && (gHashBoard_BHB91601S == false)) {
          set_temperature_offset_value((uint)gI2c,gChain,offset_value);
          return;
        }
