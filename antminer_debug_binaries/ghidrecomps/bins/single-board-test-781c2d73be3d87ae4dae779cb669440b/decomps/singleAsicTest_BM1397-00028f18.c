...
void singleAsicTest_BM1397(void)

{
  ...
  lcd_display_buf._8_4_ = DAT_00029234[2];
  lcd_display_buf._12_4_ = DAT_00029234[3];
  lcd_display_buf._0_4_ = *DAT_00029234;
  lcd_display_buf._4_4_ = DAT_00029234[1];
  printf("\nBegin %s test\n",DAT_00029234 + 4);
  system("date");
  putchar(10);
  ...
  iVar3 = pthread_create(DAT_00029238,(pthread_attr_t *)0x0,single_BM1397_show_status_func + 1,
                         chain_info + gChain);
  if (iVar3 == 0) {
    reset_hash_board();
    start_receive = true;
    iVar3 = pthread_create(ppVar1 + -1,(pthread_attr_t *)0x0,single_BM1397_receive_func + 1,
                           chain_info + gChain);
    if (iVar3 != 0) {
    ...
    set_BM1397_freq(gChain,'\0',Conf.Freq,true);
    BM1397_software_set_address(gChain);
    BM1397_set_baud(gChain,Conf.baud);
    check_BM1397_asic_reg(gChain,'\0','\x18',true);
    ...
    putchar(10);
    iVar3 = pthread_create(ppVar1,(pthread_attr_t *)0x0,single_BM1397_send_func + 1,
                           chain_info + gChain);
    if (iVar3 == 0) {
      pthread_join(*ppVar1,(void **)0x0);
      pthread_join(ppVar1[1],(void **)0x0);
      pthread_cancel(ppVar1[2]);
      uVar2 = single_BM1397_get_result(gChain);
      single_BM1397_print_lcd(gChain,uVar2);
      set_fan_speed(0);
      usleep(500000);
    }
    else {
