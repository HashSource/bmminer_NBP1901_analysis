...
void * single_BM1397_send_func(void *arg)

{
      ...
      if (uVar12 != 0) {
        do {
          ...
          if ((1 << gChain & uVar12) == 0) {
            ...
            work_vil_1397.chain_id = local_b0;
            do {
              puVar8 = puVar8 + 1;
              puVar4 = puVar4 + 1;
              *puVar4 = *puVar8;
            } while (puVar6 != puVar8);
            puVar8 = work_vil_1397.data + 0xb;
            do {
              puVar6 = puVar6 + 1;
              puVar8 = puVar8 + 1;
              *puVar8 = *puVar6;
            } while (puVar8 != work_vil_1397.midstate + 0x1f);
            buf_vil[0] = (uVar13 | 0x80) << 0x10 | 0x1000000;
            puVar15 = buf_vil + 1;
            pvVar9 = &work_vil_1397;
            do {
              ...
              *puVar15 = (uint)pvVar9->data[3] |
              ...
              pvVar9 = (vil_work_1397 *)puVar18;
            } while (puVar18 != (uint *)(work_vil_1397.data + 4));
            puVar15 = buf_vil + 4;
            pvVar9 = &work_vil_1397;
            do {
              puVar18 = &pvVar9->work_count;
              ...
              *puVar15 = (uint)pvVar9->midstate[3] |
              ...
              pvVar9 = (vil_work_1397 *)puVar18;
            } while (puVar18 != (uint *)(work_vil_1397.midstate + 0xc));
            work_vil_1397.work_count = uVar11;
            buf_vil[1] = uVar11;
  ...
  printf("\n\n---%s: Chain%d send work num : %d\n","single_BM1397_send_func",uVar13,uVar11);
