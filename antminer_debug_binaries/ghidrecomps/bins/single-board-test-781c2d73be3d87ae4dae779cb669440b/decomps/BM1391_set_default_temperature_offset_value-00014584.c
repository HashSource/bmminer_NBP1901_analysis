...
void BM1391_set_default_temperature_offset_value(uchar which_chain)
...
LAB_0001460a:
      ...
      do {
        uVar5 = uVar5 + 1;
        uVar3 = check_BM1391_asic_reg(which_chain,(char)gChain_Asic_Interval * cVar1,'\x1c',false);
        if ((uVar3 & 0xc0000000) == 0) break;
      } while (uVar5 < read_loop);
      uVar5 = 0;
      BM1391_set_config(which_chain,(char)gChain_Asic_Interval * cVar1,'\x1c',uVar7,false);
      do {
        uVar5 = uVar5 + 1;
        uVar7 = check_BM1391_asic_reg(which_chain,(char)gChain_Asic_Interval * cVar1,'\x1c',false);
      ...
      if (bVar4 == (byte)uVar7) goto LAB_0001460a;
      if (iVar6 == 0) {
        Sensor1_OK = '\0';
