...

{
  ...
  printf("--- %s: read_back_data[0] = 0x%x, read_back_data[1] = 0x%x, read_back_data[2] = 0x%x, read_back_data[3] = 0x%x, read_back_data[4] = 0x%x\n"
         ,DAT_0002327c,uVar9,uVar7,uVar10,uVar2,uVar11);
  if (uVar7 == 0x18 && uVar9 == 5) {
    uVar7 = uVar10 + 0x1d;
    uVar9 = uVar7 * 0x10000 >> 0x18;
    if ((uVar9 != uVar2) || (uVar9 = uVar7 & 0xff, uVar11 != uVar9)) {
      printf("\n--- %s failed! crc = 0x%04x\n\n",DAT_0002327c,uVar7,uVar9,uVar8,uVar12,uVar13);
      return 0;
    }
    *voltage = uVar1;
    printf("\n--- %s ok, voltage = 0x%02x\n\n",DAT_0002327c,uVar10,uVar9,uVar8,uVar12,uVar13);
    iVar3 = 1;
  }
  else {
    printf("\n--- %s failed!\n\n",DAT_0002327c);
