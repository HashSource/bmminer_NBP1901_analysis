...
int get_dsPIC33EP16GS202_software_version(uint which_i2c,uchar which_chain,uchar *version)

{
  ...
  pbVar4 = send_data;
  send_data[2] = '\x04';
  uVar8 = (uint)which_chain << 0x10 | 0x400000 | which_i2c << 0x1a;
  send_data[3] = '\x17';
  send_data[4] = '\0';
  send_data[5] = '\x1b';
  ...
  printf("--- %s: read_back_data[0] = 0x%x, read_back_data[1] = 0x%x, read_back_data[2] = 0x%x, read_back_data[3] = 0x%x, read_back_data[4] = 0x%x\n"
         ,DAT_00024390,uVar9,uVar7,uVar10,uVar2,uVar11);
  if (uVar7 == 0x17 && uVar9 == 5) {
    uVar7 = uVar10 + 0x1c;
    uVar9 = uVar7 * 0x10000 >> 0x18;
    if ((uVar9 != uVar2) || (uVar9 = uVar7 & 0xff, uVar11 != uVar9)) {
      printf("\n--- %s failed! crc = 0x%04x\n\n",DAT_00024390,uVar7,uVar9,uVar8,uVar12,uVar13);
      return 0;
    }
    *version = uVar1;
    printf("\n--- %s ok, version = 0x%02x\n\n",DAT_00024390,uVar10,uVar9,uVar8,uVar12,uVar13);
    iVar3 = 1;
  }
  else {
    printf("\n--- %s failed!\n\n",DAT_00024390);
