...

{
  ...
  uVar8 = (uint)data[5] << 0x10 | (uint)data[4] << 0x18;
  uVar20 = (uint)data[1] << 0x10 | (uint)*data << 0x18 | (uint)data[3] | (uint)data[2] << 8;
  uVar33 = uVar8 | data[7] | (uint)data[6] << 8;
  uVar28 = (uint)data[0xd] << 0x10 | (uint)data[0xc] << 0x18;
  uVar30 = (uint)data[9] << 0x10 | (uint)data[8] << 0x18;
  uVar39 = uVar28 | data[0xf] | (uint)data[0xe] << 8;
  uVar31 = uVar30 | data[0xb] | (uint)data[10] << 8;
  uVar14 = (uint)data[0x11] << 0x10 | (uint)data[0x10] << 0x18;
  uVar21 = (uint)data[0x15] << 0x10 | (uint)data[0x14] << 0x18;
  uVar40 = data[0x13] | uVar14 | (uint)data[0x12] << 8;
  uVar1 = (uint)data[0x19] << 0x10 | (uint)data[0x18] << 0x18;
  uVar34 = uVar21 | data[0x17] | (uint)data[0x16] << 8;
  uVar9 = (uint)data[0x1d] << 0x10 | (uint)data[0x1c] << 0x18;
  uVar32 = uVar1 | data[0x1b] | (uint)data[0x1a] << 8;
  uVar15 = (uint)data[0x21] << 0x10 | (uint)data[0x20] << 0x18;
  uVar36 = uVar15 | data[0x23] | (uint)data[0x22] << 8;
  uVar22 = (uint)data[0x25] << 0x10 | (uint)data[0x24] << 0x18;
  uVar10 = uVar9 | data[0x1f] | (uint)data[0x1e] << 8;
  uVar2 = (uint)data[0x29] << 0x10 | (uint)data[0x28] << 0x18;
  uVar16 = (uint)data[0x31] << 0x10 | (uint)data[0x30] << 0x18;
  uVar41 = uVar2 | data[0x2b] | (uint)data[0x2a] << 8;
  uVar35 = uVar22 | data[0x27] | (uint)data[0x26] << 8;
  uVar11 = (uint)data[0x2d] << 0x10 | (uint)data[0x2c] << 0x18;
  uVar12 = uVar11 | data[0x2f] | (uint)data[0x2e] << 8;
  uVar23 = (uint)data[0x35] << 0x10 | (uint)data[0x34] << 0x18;
  uVar42 = (uint)data[0x39] << 0x10 | (uint)data[0x38] << 0x18;
  uVar37 = uVar16 | data[0x33] | (uint)data[0x32] << 8;
  uVar17 = ctx->state[0];
  uVar26 = ctx->state[6];
  uVar3 = ctx->state[1];
  uVar5 = ctx->state[4];
  uVar6 = ctx->state[5];
  uVar18 = ctx->state[2];
  uVar46 = uVar23 | data[0x37] | (uint)data[0x36] << 8;
  iVar19 = ((uVar5 >> 0xb | uVar5 << 0x15) ^ (uVar5 >> 6 | uVar5 << 0x1a) ^
           (uVar5 >> 0x19 | uVar5 << 7)) + ctx->state[7] + 0x428a2f98 +
  ...
  uVar25 = iVar19 + ctx->state[3];
  uVar13 = (uint)data[0x3d] << 0x10 | (uint)data[0x3c] << 0x18;
  ...
  uVar44 = ((uVar8 >> 0x12 | uVar33 << 0xe) ^ (uVar33 >> 7 | (uint)data[7] << 0x19) ^ uVar33 >> 3) +
           uVar20 + uVar35 +
  ...
  uVar30 = ((uVar13 >> 0x13 | uVar29 << 0xd) ^ (uVar13 >> 0x11 | uVar29 << 0xf) ^ uVar29 >> 10) +
           uVar33 + uVar41 +
           ((uVar30 >> 0x12 | uVar31 << 0xe) ^ (uVar31 >> 7 | (uint)data[0xb] << 0x19) ^ uVar31 >> 3
           );
  ...
  uVar28 = uVar31 + uVar12 +
           ((uVar28 >> 0x12 | uVar39 << 0xe) ^ (uVar39 >> 7 | (uint)data[0xf] << 0x19) ^ uVar39 >> 3
           ) + ((uVar44 >> 0x13 | uVar44 * 0x2000) ^ (uVar44 >> 0x11 | uVar44 * 0x8000) ^
               uVar44 >> 10);
  ...
  uVar47 = ((uVar30 >> 0x13 | uVar30 * 0x2000) ^ (uVar30 >> 0x11 | uVar30 * 0x8000) ^ uVar30 >> 10)
           + ((uVar14 >> 0x12 | uVar40 << 0xe) ^ (uVar40 >> 7 | (uint)data[0x13] << 0x19) ^
  ...
  uVar14 = uVar40 + uVar46 +
           ((uVar21 >> 0x12 | uVar34 << 0xe) ^ (uVar34 >> 7 | (uint)data[0x17] << 0x19) ^
           uVar34 >> 3) +
  ...
  uVar33 = uVar34 + uVar43 +
           ((uVar1 >> 0x12 | uVar32 << 0xe) ^ (uVar32 >> 7 | (uint)data[0x1b] << 0x19) ^ uVar32 >> 3
           ) + ((uVar47 >> 0x13 | uVar47 * 0x2000) ^ (uVar47 >> 0x11 | uVar47 * 0x8000) ^
               uVar47 >> 10);
  ...
  uVar25 = uVar25 + iVar19;
  uVar1 = uVar32 + uVar29 +
          ((uVar9 >> 0x12 | uVar10 << 0xe) ^ (uVar10 >> 7 | (uint)data[0x1f] << 0x19) ^ uVar10 >> 3)
  ...
  uVar15 = ((uVar15 >> 0x12 | uVar36 << 0xe) ^ (uVar36 >> 7 | (uint)data[0x23] << 0x19) ^
  ...
  uVar34 = ((uVar1 >> 0x13 | uVar1 * 0x2000) ^ (uVar1 >> 0x11 | uVar1 * 0x8000) ^ uVar1 >> 10) +
           ((uVar22 >> 0x12 | uVar35 << 0xe) ^ (uVar35 >> 7 | (uint)data[0x27] << 0x19) ^
  ...
  uVar35 = ((uVar15 >> 0x13 | uVar15 * 0x2000) ^ (uVar15 >> 0x11 | uVar15 * 0x8000) ^ uVar15 >> 10)
           + ((uVar2 >> 0x12 | uVar41 << 0xe) ^ (uVar41 >> 7 | (uint)data[0x2b] << 0x19) ^
  ...
  uVar2 = ((uVar11 >> 0x12 | uVar12 << 0xe) ^ (uVar12 >> 7 | (uint)data[0x2f] << 0x19) ^ uVar12 >> 3
          ) + uVar41 + uVar47 +
  ...
  uVar25 = ((uVar35 >> 0x13 | uVar35 * 0x2000) ^ (uVar35 >> 0x11 | uVar35 * 0x8000) ^ uVar35 >> 10)
           + ((uVar16 >> 0x12 | uVar37 << 0xe) ^ (uVar37 >> 7 | (uint)data[0x33] << 0x19) ^
  ...
  uVar12 = iVar19 + ((uVar7 | uVar8) & uVar20 | uVar7 & uVar8) +
                    ((uVar8 >> 0xd | uVar8 * 0x80000) ^ (uVar8 >> 2 | uVar8 * 0x40000000) ^
                    (uVar8 >> 0x16 | uVar8 * 0x400));
  uVar24 = ((uVar23 >> 0x12 | uVar46 << 0xe) ^ (uVar46 >> 7 | (uint)data[0x37] << 0x19) ^
  ...
  uVar23 = ((uVar25 >> 0x13 | uVar25 * 0x2000) ^ (uVar25 >> 0x11 | uVar25 * 0x8000) ^ uVar25 >> 10)
           + ((uVar42 >> 0x12 | uVar43 << 0xe) ^ (uVar43 >> 7 | (uint)data[0x3b] << 0x19) ^
  ...
  uVar27 = ((uVar13 >> 0x12 | uVar29 << 0xe) ^ (uVar29 >> 7 | (uint)data[0x3f] << 0x19) ^
  ...
  ctx->state[3] = uVar1 + ctx->state[3];
  ctx->state[6] = uVar4 + uVar26;
  ctx->state[2] = uVar7 + uVar18;
  ctx->state[1] = uVar8 + uVar3;
  ctx->state[5] = uVar15 + uVar6;
  ctx->state[0] =
       ((uVar7 | uVar8) & uVar1 | uVar7 & uVar8) +
       ((uVar8 >> 0xd | uVar8 * 0x80000) ^ (uVar8 >> 2 | uVar8 * 0x40000000) ^
       (uVar8 >> 0x16 | uVar8 * 0x400)) + uVar17 + iVar19;
  ctx->state[4] = uVar2 + uVar5 + iVar19;
  return;
}
