...
unsigned int __fastcall get_BM1722_asic_register(unsigned __int8 a1, unsigned __int8 a2, unsigned __int8 a3, char a4);
unsigned int __fastcall set_BM1722_asic_register(unsigned __int8 a1, char a2, char a3, char a4, int a5);
unsigned int __fastcall set_BM1722_freq(unsigned __int8 a1, char a2, char a3);
int __fastcall BM1722_chain_inactive(unsigned __int8 a1);
unsigned int __fastcall BM1722_set_address(unsigned __int8 a1, unsigned __int8 a2);
...
unsigned int __fastcall get_BM1725_asic_register(unsigned __int8 a1, unsigned __int8 a2, unsigned __int8 a3, char a4);
unsigned int __fastcall set_BM1725_asic_register(unsigned __int8 a1, char a2, char a3, char a4, int a5);
unsigned int __fastcall BM1725_set_address(unsigned __int8 a1, unsigned __int8 a2);
int __fastcall BM1725_chain_inactive(unsigned __int8 a1);
int __fastcall BM1725_set_address_all(unsigned __int8 a1);
unsigned int __fastcall set_BM1725_freq(unsigned __int8 a1, char a2, char a3);
...
unsigned int __fastcall enable_read_temperature_from_asic_chain(unsigned int result, char a2);
unsigned int __fastcall enable_extended_mode_of_temperature_sensor_chain(unsigned __int8 a1);
int __fastcall get_temperature_offset_value_from_asic_chain(unsigned __int8 a1);
unsigned int __fastcall set_default_temperature_offset_value_chain(unsigned __int8 a1);
...
unsigned int __fastcall dcr_uart_send(unsigned __int8 a1, const void *a2, size_t a3);
...
unsigned int __fastcall blake32_close(_DWORD *a1, char a2, int a3, int a4, unsigned int a5);
...
int __fastcall platform_dump_capability(int result);
int platform_init();
int platform_uninit();
...
unsigned int __fastcall uart_send(int a1, const void *a2, size_t a3);
...
int __fastcall hal_load_conf(const unsigned __int8 *a1);
...
int __fastcall dump_string(unsigned __int8 *a1, int (__fastcall *a2)(unsigned __int8 *, int, int), int a3, __int16 a4);
int __fastcall object_key_compare_keys(int a1, int a2);
int __fastcall object_key_compare_serials(_DWORD *a1, _DWORD *a2);
int __fastcall do_dump(int a1, int a2, int a3, int (__fastcall *a4)(const char *, int, int), int a5);
...
int __fastcall json_decref_0(int result);
...
int __fastcall hashtable_do_del(int a1, const char *a2, unsigned int a3);
...
int __fastcall hashtable_set(int a1, char *a2, int a3, int a4);
...
json_t_0 *__fastcall parse_object(int a1, int a2, json_error_t *a3);
json_t_0 *__fastcall parse_array(int a1, int a2, json_error_t *a3);
void *__fastcall parse_value(double a1, json_error_t *a2);
void *__fastcall parse_json(int a1, unsigned int a2, int a3);
...
int (__fastcall *__fastcall json_set_alloc_funcs(int (__fastcall *result)(_DWORD), int (__fastcall *a2)(_DWORD)))(_DWORD);
...
int __fastcall json_object_set_new_nocheck(_DWORD *a1, char *a2, int a3);
int __fastcall json_object_set_new(_DWORD *a1, char *a2, int a3);
...
json_t_0 *__cdecl json_object_get_0(const json_t_0 *json, const unsigned __int8 *key);
...
bool __fastcall json_string_equal(const json_t_0 *a1, const json_t_0 *a2);
_DWORD *__fastcall json_string_copy(const json_t_0 *a1);
...
void *json_false();
void *json_null();
void __fastcall json_delete(json_array_t *a1);
int __fastcall json_equal(json_t_0 *a1, json_t_0 *a2);
json_t_0 *__fastcall json_copy(json_t_0 *a1);
json_t_0 *__fastcall json_deep_copy(const json_t_0 *a1);
...
int (__fastcall *do_free)(_DWORD) = &free; // weak
...
_DWORD gAsic_Core_Nonce_Num[20011]; // weak
...
unsigned int __fastcall set_BM1722_asic_register(unsigned __int8 a1, char a2, char a3, char a4, int a5)
{
  ...
  v10 = BYTE1(a5);
  v11 = a5;
  v12 = CRC5((unsigned __int8 *)v7, 0x40u);
...
unsigned int __fastcall set_BM1722_freq(unsigned __int8 a1, char a2, char a3)
{
  ...
  set_BM1722_asic_register(a1, a2, 12, a3, v10);
  usleep(0x3E8u);
  set_BM1722_asic_register(a1, a2, 112, a3, v9);
  usleep(0x3E8u);
  return set_BM1722_asic_register(a1, a2, 12, a3, v10);
}
// 92E0: variable 'v3' is possibly undefined
// 92A0: using guessed type float var_10;
...
{
  int result; // r0
  char v3[186]; // [sp+14h] [bp+Ch] BYREF
        ...
        if ( i > 0x5F )
        {
          if ( i <= 0x7F )
          {
            if ( i == 96 )
              v5 = 0;
            v5 = (2 * v5) | 1;
            set_BM1722_asic_register(a1, 0, 92, 1, v5);
          }
        }
        else
        {
          if ( i == 64 )
            v5 = 0;
          v5 = (2 * v5) | 1;
          set_BM1722_asic_register(a1, 0, 88, 1, v5);
        }
      }
      else
      {
        if ( i == 32 )
          v5 = 0;
        v5 = (2 * v5) | 1;
        set_BM1722_asic_register(a1, 0, 84, 1, v5);
      }
    }
    else
    {
      if ( !i )
        v5 = 0;
      v5 = (2 * v5) | 1;
      set_BM1722_asic_register(a1, 0, 80, 1, v5);
    }
    dcr_uart_send(a1, v3, 0xB8u);
    usleep(dword_3368A0);
  }
...
unsigned int __fastcall check_BM1722_asic_reg(unsigned __int8 a1, unsigned __int8 a2, unsigned __int8 a3, char a4)
{
  ...
  __int16 v5; // r1
  int v6; // r0
  _DWORD v12[2]; // [sp+8h] [bp+8h] BYREF
    ...
    if ( v13 )
    {
      ...
      for ( i = 0; i < v13; ++i )
      {
        ...
        if ( a1 == *(unsigned __int8 *)(reg_value_buf + 10 * *(_DWORD *)(reg_value_buf + 4) + 25) )
        {
          ...
          LOWORD(v12[1]) = v5;
          BYTE2(v12[1]) = v4;
          if ( CRC5((unsigned __int8 *)v12, 0x33u) == *(unsigned __int8 *)(reg_value_buf
          ...
          else
          {
            ...
            if ( *(_DWORD *)(reg_value_buf + 4) == 513 )
              *(_DWORD *)(reg_value_buf + 4) = 0;
            v6 = CRC5((unsigned __int8 *)v12, 0x33u);
            printf(
...
int singleAsicTest_BM1722()
{
  ...
  if ( *((unsigned __int8 *)&cgpu + (unsigned __int8)gChain + 1049784) == dword_336848 )
  {
    ...
    set_BM1725_asic_register(gChain, 0, 20, 1, 38);
    ...
    pthread_cancel(newthread);
    pthread_cancel(dword_2B631C);
    LOBYTE(v2) = single_asic_get_result(gChain);
...
// E134: using guessed type void __noreturn show_status_func();
// EBC4: using guessed type int receive_func();
// EF58: using guessed type int send_func();
// F348: using guessed type void __noreturn read_temp_func();
...
// 336820: using guessed type int dword_336820;
// 336848: using guessed type int dword_336848;
...
int singleBoardTest_BBD12601()
{
        ...
        *((unsigned __int8 *)&cgpu + (unsigned __int8)gChain + 1049784) == dword_336848) )
  {
    ...
    pthread_create(
      ...
      (void *(*)(void *))read_temp_func,
      (char *)&chain_info + 2 * (unsigned __int8)gChain);
    set_BM1722_asic_register(gChain, 0, 20, 1, 38);
    BM1722_open_core(gChain);
    puts("\nBegin send test pattern");
...
// EF58: using guessed type int send_func();
// F348: using guessed type void __noreturn read_temp_func();
// 14088: using guessed type void __noreturn pic_heart_beat_func();
...
unsigned int __fastcall set_BM1725_freq(unsigned __int8 a1, char a2, char a3)
{
  ...
  set_BM1725_asic_register(a1, a2, 12, a3, v10);
  usleep(0x3E8u);
  set_BM1725_asic_register(a1, a2, 112, a3, v9);
  usleep(0x3E8u);
  return set_BM1725_asic_register(a1, a2, 12, a3, v10);
}
// ABF0: variable 'v3' is possibly undefined
// ABB0: using guessed type float var_10;

//----- (0000ACA0) --------------------------------------------------------
int __fastcall BM1725_open_core(unsigned __int8 a1)
{
  int result; // r0
  char v3[184]; // [sp+14h] [bp+Ch] BYREF
  int v4; // [sp+CCh] [bp+C4h]
  ...
  {
    v4 = (i << 16) | 0x8201;
    set_BM1725_asic_register(a1, 0, 36, 1, v4);
    usleep(0x64u);
    dcr_uart_send(a1, v3, 0xB8u);
    usleep(dword_3368A0);
  }
    ...
    if ( v13 )
    {
      ...
      for ( i = 0; i < v13; ++i )
      {
        ...
        if ( a1 == *(unsigned __int8 *)(reg_value_buf + 10 * *(_DWORD *)(reg_value_buf + 4) + 25) )
        {
          ...
          v12[0] = *(_DWORD *)(reg_value_buf + v4);
          v12[1] = v5;
          if ( CRC5((unsigned __int8 *)v12, 0x3Bu) == *(unsigned __int8 *)(reg_value_buf
                                                                         + 10 * *(_DWORD *)(reg_value_buf + 4)
                                                                         + 24) )
          {
            if ( !a3 )
          ...
          else
          {
            ...
            if ( *(_DWORD *)(reg_value_buf + 4) == 513 )
              *(_DWORD *)(reg_value_buf + 4) = 0;
            v6 = CRC5((unsigned __int8 *)v12, 0x3Bu);
            printf(
              "%s: crc is 0x%x, but it should be 0x%x\n",
              "check_BM1725_asic_reg",
              v6,
...
int singleAsicTest_BM1725()
{
  ...
  if ( *((unsigned __int8 *)&cgpu + (unsigned __int8)gChain + 1049784) == dword_336848 )
  {
    ...
    if ( byte_3368D8 == 1 )
    {
      set_BM1725_asic_register(gChain, 0, 64, 0, 1);
      if ( !pattern_test_time )
        get_temperature_offset_value_from_asic_chain(gChain);
      set_default_temperature_offset_value_chain(gChain);
    }
...
int singleBoardTest_BBD25601()
{
        ...
        *((unsigned __int8 *)&cgpu + (unsigned __int8)gChain + 1049784) == dword_336848) )
  {
    ...
    if ( v2 == 7 )
    {
      g_test_epprom = save_voltage_info_to_eeprom(dword_336820, dword_336878);
      if ( g_test_epprom != 1 )
        g_test_epprom = save_voltage_info_to_eeprom(dword_336820, dword_336878);
    }
    single_board_print_lcd(v2);
...
int read_config()
{
  ...
  int v1; // r0
  int v2; // r0
  char v4[1024]; // [sp+4h] [bp+4h] BYREF
  FILE *stream; // [sp+404h] [bp+404h]
  int v6; // [sp+408h] [bp+408h]
  _BYTE *v7; // [sp+40Ch] [bp+40Ch]
                                                                ...
                                                                else
                                                                {
                                                                  ...
                                                                  else
                                                                  {
                                                                    ...
                                                                    else
                                                                    {
                                                                      ...
                                                                      {
                                                                        v9 = strstr(v4, "add_voltage_after_test_ok=");
                                                                        if ( v9 )
                                                                        {
                                                                          v9 += 26;
                                                                        ...
                                                                        {
                                                                          v9 = strstr(v4, "add_voltage_value=");
                                                                          if ( v9 )
                                                                          {
                                                                            v9 += 18;
...
int __fastcall calculate_how_many_nonce_per_asic_get(unsigned __int8 a1, unsigned __int8 a2, unsigned int a3)
{
  ...
  v5 = 0;
  for ( i = 0; i < a3; ++i )
    v5 += gAsic_Core_Nonce_Num[512 * ((a1 << 8) + a2) + i];
  return v5;
}
// 35B34: using guessed type _DWORD gAsic_Core_Nonce_Num[20011];
  ...
  for ( i = 0; i <= 3; ++i )
  {
    ...
    *((_BYTE *)&cgpu + i + 1049784) = 0;
    ...
    for ( j = 0; dword_336848 > j; ++j )
    {
      ...
      {
        gAsic_Core_Nonce_Num[512 * ((i << 8) + j) + k] = 0;
...
int __fastcall check_hw(int a1, int a2, char a3, char a4)
{
  ...
  int v11[45]; // [sp+34h] [bp+34h] BYREF
  ...
  if ( dword_336850 == 1725 )
    LOBYTE(v11[36]) = a3;
  decred_hash_simple((int)v10, (char *)v11);
...
int __fastcall set_voltage(char a1, char a2, char a3)
{
  ...
  switch ( pattern_test_time )
  {
    ...
    default:
      v8 = dword_33687C;
      printf("\n--- %s: Can't find voltage%d\n", (const char *)(unsigned __int8)pattern_test_time, jpt_E282);
      break;
  }
  dword_336878 = v8;
  if ( a3 )
...
// E288: using guessed type void *jpt_E282[9];
// 35AC5: using guessed type char pattern_test_time;
// 336850: using guessed type int dword_336850;
// 336878: using guessed type int dword_336878;
// 33687C: using guessed type int dword_33687C;
...
// 3368C0: using guessed type int dword_3368C0;
...
int __fastcall set_baud(unsigned __int8 a1, unsigned __int8 a2)
{
  ...
  if ( dword_336850 == 1722 )
  {
    set_BM1722_asic_register(a1, 0, 28, 1, (a2 << 8) | 0x7002001);
  }
  else if ( dword_336850 == 1725 )
  {
    set_BM1725_asic_register(a1, 0, 28, 1, (a2 << 8) | 0x7002001);
  }
  usleep(0xC350u);
      ...
      if ( dword_33681C > v11 )
      {
        ...
        if ( v10 == v7 )
        {
          ...
          else
          {
            ++*(_DWORD *)(v6 + 4 * (a1 + 46) + 4);
            ++gValid_Nonce_Num[a1];
            ++gAsic_Core_Nonce_Num[512 * ((a1 << 8) + v13) + v12];
          }
        }
        else
        {
...
void *__fastcall receive_func(unsigned __int8 *a1)
{
  ...
  unsigned int v25; // [sp+44h] [bp+3Ch]
  ...
  for ( i = 0; dword_336848 > i; ++i )
  {
    ...
    for ( j = 0; dword_33684C > j; ++j )
    {
      for ( k = 0; dword_33681C > k; ++k )
      {
        ...
        for ( m = 0; m <= 179; ++m )
          v3[m + 2] = *((_BYTE *)src + m + 8);
        if ( v3[0] == 48 )
          v3[146] = 0;
        v4 = CRC16(v3, 182);
        v3[182] = HIBYTE(v4);
        v3[183] = v4;
        dcr_uart_send(v9, v3, 0xB8u);
...
int __fastcall single_asic_get_result(unsigned __int8 a1)
{
  ...
  for ( i = 0; dword_33684C > i; ++i )
  {
    if ( !(i % 0xA) )
      putchar(10);
    printf("core[%02d]=%02d\t", i, gAsic_Core_Nonce_Num[0x20000 * a1 + i]);
  }
  puts("\n\n");
  for ( j = 0; dword_33684C > j; ++j )
  {
    if ( gAsic_Core_Nonce_Num[0x20000 * a1 + j] < (unsigned int)dword_33681C )
    {
      v8 &= ~1u;
      printf("core[%02d] = %d,      lost these pattern's nonce : ", j, gAsic_Core_Nonce_Num[0x20000 * a1 + j]);
      for ( k = 0; dword_33681C > k; ++k )
      {
...
int __fastcall single_board_get_result(unsigned __int8 a1)
{
  ...
  for ( kk = 0; dword_336848 > kk; ++kk )
  {
    ...
    if ( dword_33684C * dword_33681C > v8 )
    {
      ...
      {
        if ( gAsic_Core_Nonce_Num[512 * ((a1 << 8) + kk) + mm] < (unsigned int)dword_33681C )
        {
          v9 += ++v14;
          if ( dword_3368C8 < v14 )
            v13 &= ~1u;
          if ( gAsic_Core_Nonce_Num[512 * ((a1 << 8) + kk) + mm] < (unsigned int)dword_3368CC )
            v13 &= ~1u;
          printf("core[%02d] = %d,      lost these nonce : ", mm, gAsic_Core_Nonce_Num[512 * ((a1 << 8) + kk) + mm]);
...
{
  if ( dword_336850 == 1722 )
    return set_BM1722_asic_register(result, a2, 28, 0, (dword_3368E0 << 8) | 0x7006061);
  if ( dword_336850 == 1725 )
    return set_BM1725_asic_register(result, a2, 28, 0, (dword_3368E0 << 8) | 0x7006061);
  return result;
}
// 336850: using guessed type int dword_336850;
// 3368E0: using guessed type int dword_3368E0;
  ...
  for ( i = 0; i <= 2; ++i )
  {
    ...
    if ( v4 )
    {
      ...
      else
      {
        if ( dword_336850 == 1722 )
        {
          result = set_BM1722_asic_register(a1, gChain_Asic_Interval * (v4 - 1), 32, 0, 26806532);
        }
        else if ( dword_336850 == 1725 )
        {
          result = set_BM1725_asic_register(a1, gChain_Asic_Interval * (v4 - 1), 32, 0, 26806532);
        }
        do
        {
          if ( dword_336850 == 1722 )
...
int __fastcall get_temperature_offset_value_from_asic_chain(unsigned __int8 a1)
{
  ...
  for ( i = 0; i <= 2; ++i )
  {
    ...
    if ( v15 )
    {
      ...
      if ( dword_336850 == 1722 )
      {
        set_BM1722_asic_register(a1, gChain_Asic_Interval * (v15 - 1), 32, 0, 26738944);
      }
      else if ( dword_336850 == 1725 )
      {
        set_BM1725_asic_register(a1, gChain_Asic_Interval * (v15 - 1), 32, 0, 26738944);
      }
      do
      {
        if ( dword_336850 == 1722 )
      ...
      if ( dword_336850 == 1722 )
      {
        set_BM1722_asic_register(a1, gChain_Asic_Interval * (v15 - 1), 32, 0, 26738688);
      }
      else if ( dword_336850 == 1725 )
      {
        set_BM1725_asic_register(a1, gChain_Asic_Interval * (v15 - 1), 32, 0, 26738688);
      }
      do
      {
        if ( dword_336850 == 1722 )
...
unsigned int __fastcall set_default_temperature_offset_value_chain(unsigned __int8 a1)
{
  ...
  for ( i = 0; i <= 2; ++i )
  {
    ...
    if ( v9 )
    {
      ...
      if ( dword_336850 == 1722 )
      {
        result = set_BM1722_asic_register(a1, gChain_Asic_Interval * (v9 - 1), 32, 0, v5);
      }
      else if ( dword_336850 == 1725 )
      {
        result = set_BM1725_asic_register(a1, gChain_Asic_Interval * (v9 - 1), 32, 0, v5);
      }
      do
      {
        if ( dword_336850 == 1722 )
      ...
      if ( dword_336850 == 1722 )
      {
        result = set_BM1722_asic_register(a1, gChain_Asic_Interval * (v9 - 1), 32, 0, 26743040);
      }
      else if ( dword_336850 == 1725 )
      {
        result = set_BM1725_asic_register(a1, gChain_Asic_Interval * (v9 - 1), 32, 0, 26743040);
      }
      do
      {
        if ( dword_336850 == 1722 )
...
int __fastcall read_asic_temperature(unsigned __int8 a1)
{
  ...
  for ( i = 0; i <= 2; ++i )
  {
    ...
    if ( v7 )
    {
      ...
      if ( dword_336850 == 1722 )
      {
        set_BM1722_asic_register(a1, gChain_Asic_Interval * (v7 - 1), 32, 0, 26738944);
      }
      else if ( dword_336850 == 1725 )
      {
        set_BM1725_asic_register(a1, gChain_Asic_Interval * (v7 - 1), 32, 0, 26738944);
      }
      do
      {
        if ( dword_336850 == 1722 )
      ...
      if ( dword_336850 == 1722 )
      {
        set_BM1722_asic_register(a1, gChain_Asic_Interval * (v7 - 1), 32, 0, 26738688);
      }
      else if ( dword_336850 == 1725 )
      {
        set_BM1725_asic_register(a1, gChain_Asic_Interval * (v7 - 1), 32, 0, 26738688);
      }
      do
      {
        if ( dword_336850 == 1722 )
  ...
  if ( (int)temp_change[a1] > 0 || (int)temp_change[a1] < 0 )
  {
...
bool test_eeprom()
{
  ...
  unsigned __int8 v3; // [sp+Ah] [bp+2h] BYREF
...
// 235C48: using guessed type int e2prom_fd;
// 11BA0: using guessed type unsigned __int8 var_9[8];
...
// 235C48: using guessed type int e2prom_fd;
// 11BD8: using guessed type unsigned __int8 var_9[5];
...
int __fastcall save_voltage_info_to_eeprom(unsigned int a1, unsigned int a2)
{
  char v3[5]; // [sp+8h] [bp+8h] BYREF
  unsigned __int8 v4; // [sp+Dh] [bp+Dh]
  char v5; // [sp+Eh] [bp+Eh]
  char v6; // [sp+Fh] [bp+Fh]
  int i; // [sp+10h] [bp+10h]
  ...
  *(_DWORD *)v3 = 43605;
  ...
  v3[3] = a1 / 0xA;
  v3[4] = a2 / 0xA;
  v4 = CRC5((unsigned __int8 *)v3, 0x28u);
  if ( test_eeprom() )
  {
    for ( i = 0; i <= 5; ++i )
    {
      v8 = save_byte_to_eeprom(i - 102, v3[i]);
      if ( v8 != 1 )
      {
...
unsigned int __fastcall dcr_uart_send(unsigned __int8 a1, const void *a2, size_t a3)
{
  _BYTE v8[512]; // [sp+14h] [bp+14h] BYREF
...
// 12034: using guessed type int var_8;

//----- (00012068) --------------------------------------------------------
const char *__fastcall key_callback(int a1, int a2)
{
  const char *result; // r0
  int v4[2]; // [sp+8h] [bp+8h]
...
// 12068: using guessed type int key_callback();
...
unsigned int __fastcall get_work(int a1, int a2, FILE *a3, unsigned int a4)
{
  char v10[1024]; // [sp+10h] [bp+10h] BYREF
  ...
  while ( 1 )
  {
    if ( !fgets(v10, 1023, a3) || a4 <= v13 )
      return v13;
    ptr = (void *)(*((_DWORD *)&cgpu + a1 + 131112) + 204 * (a4 * a2 + v13));
    v14 = strstr(v10, "nonce");
    if ( !v14 )
      break;
...
int get_works()
{
  ...
  for ( i = 0; dword_336848 > i; ++i )
  {
    *((_DWORD *)&cgpu + i + 131112) = malloc(204 * dword_33684C * dword_33681C);
    ...
    for ( j = 0; dword_33684C > j; ++j )
    {
      sprintf(v4, "%s%02d%s%03d.txt", dest, i, byte_2B636C, j);
      v1 = i * dword_33684C + j;
      *((_DWORD *)&cgpu + v1) = fopen(v4, "r");
...
int __fastcall write_hash_ID_PIC16F1704(unsigned __int8 a1, unsigned __int8 a2, int a3)
{
  ...
  pthread_mutex_lock(&i2c_mutex_0);
  for ( i = 0; i <= 0x11u; ++i )
    write_pic(a2, a1, *((unsigned __int8 *)v8 + i));
...
// 12A3C: using guessed type int __fastcall write_pic(_DWORD, _DWORD, _DWORD);
// 12A60: using guessed type int __fastcall read_pic(_DWORD, _DWORD);
// 35AAC: using guessed type pthread_mutex_t i2c_mutex_0;
...
int __fastcall power_save_eeprom_data(unsigned __int8 a1, int a2, unsigned __int8 a3)
{
  ...
  unsigned __int8 v16[259]; // [sp+2Ch] [bp+2Ch] BYREF
  ...
  if ( (a1 & 0x80u) == 0 && a3 <= 0x20u )
  {
    ...
    for ( i = 2; i < a3 + 5; ++i )
      v20 += v16[i];
    v16[v18 - 2] = v20;
    v16[v18 - 1] = HIBYTE(v20);
    if ( !power_send_cmd(v16, v18, (unsigned __int8 *)&v8, 8u) )
    {
      return 0;
    }
    else if ( BYTE1(v9) == 1 )
...
int __fastcall power_read_eeprom_data(unsigned __int8 a1, int a2, unsigned __int8 a3)
{
  unsigned __int8 v8[256]; // [sp+8h] [bp+8h] BYREF
  ...
  if ( (a1 & 0x80u) == 0 && a3 <= 0x20u )
  {
    ...
    HIWORD(v10) = v13;
    if ( !power_send_cmd((unsigned __int8 *)&v9, 8u, v8, a3 + 7) )
    {
      return 0;
    }
    else
...
{
  unsigned int result; // r0
  char v8[56]; // [sp+14h] [bp+14h] BYREF
  ...
  if ( v15 > 0x1BE )
  {
    memset(&v8[v16 + 1], 0, 63 - v16);
    blake32((unsigned int)a1, &v8[v16], 64 - v16);
    a1[29] = -512;
    a1[30] = -1;
    memset(v8, 0, sizeof(v8));
    if ( a5 == 8 )
    ...
    result = blake32((unsigned int)a1, v8, 0x40u);
  }
  else
  {
    memset(&v8[v16 + 1], 0, 55 - v16);
    if ( a5 == 8 )
      v8[55] |= 1u;
    sph_enc32be_aligned(&v9, v12);
    sph_enc32be_aligned(&v10, v13);
    result = blake32((unsigned int)a1, &v8[v16], 64 - v16);
  }
  v11 = a4;
  for ( i = 0; i < a5; ++i )
    result = (unsigned int)sph_enc32be((_BYTE *)(v11 + 4 * i), a1[i + 17]);
  return result;
}
...
__int64 *__fastcall blake64(int a1, char *a2, size_t a3)
{
  ...
  unsigned __int64 v50; // [sp+1C8h] [bp+1C8h]
  unsigned __int64 v51; // [sp+1D0h] [bp+1D0h]
  unsigned __int64 v52; // [sp+1D8h] [bp+1D8h]
  unsigned __int64 v53; // [sp+1E0h] [bp+1E0h]
  ...
  unsigned __int64 v58; // [sp+208h] [bp+208h]
  unsigned __int64 v59; // [sp+210h] [bp+210h]
  unsigned __int64 v60; // [sp+218h] [bp+218h]
  unsigned __int64 v61; // [sp+220h] [bp+220h]
  ...
  unsigned __int64 v69; // [sp+260h] [bp+260h]
  unsigned __int64 v70; // [sp+268h] [bp+268h]
  unsigned __int64 v71; // [sp+270h] [bp+270h]
  unsigned __int64 v72; // [sp+278h] [bp+278h]
...
// 1B662: returning address of temporary local variable '%0x248'
// 1B662: returning address of temporary local variable '%anonymous_21'
...
__int64 *__fastcall blake64_close(int a1, char a2, int a3, int a4, unsigned int a5)
{
  ...
  int v11; // r1
  int v12; // r1
  char v15[112]; // [sp+10h] [bp+10h] BYREF
  ...
  {
    *(_QWORD *)(a1 + 232) = -1024LL;
    *(_QWORD *)(a1 + 240) = -1LL;
  }
  if ( v22 > 0x37E )
  {
    memset(&v15[v23 + 1], 0, 127 - v23);
    blake64(a1, &v15[v23], 128 - v23);
    *(_QWORD *)(a1 + 232) = -1024LL;
    *(_QWORD *)(a1 + 240) = -1LL;
    ...
    result = blake64(a1, v15, 0x80u);
  }
  else
  {
    memset(&v15[v23 + 1], 0, 111 - v23);
    if ( a5 == 8 )
      v15[111] |= 1u;
    sph_enc64be_aligned(&v16, v8, v19, HIDWORD(v19));
    sph_enc64be_aligned(&v17, v9, v20, HIDWORD(v20));
    result = blake64(a1, &v15[v23], 128 - v23);
  }
  v18 = a4;
  for ( i = 0; i < a5; ++i )
...
int platform_init()
{
  ...
  char v3[512]; // [sp+10h] [bp+8h] BYREF
  ...
  else
  {
    ...
    if ( v4 )
      snprintf(v3, 0x200u, "%s/%s", v4, "hal_conf.json");
    else
      snprintf(v3, 0x200u, "/media/card/%s", "hal_conf.json");
    printf("%s:%d", "platform_init", 65);
    printf("hal config path = %s\n", v3);
    if ( hal_load_conf((const unsigned __int8 *)v3) )
    {
      fpga_uninit();
      gpio_uninit();
    ...
    else
    {
      ...
      platform_dump_capability((int)capability);
      platform_inited = 1;
      fan_init();
      ui_init();
      uart_init();
...
// 235C5C: using guessed type int capability[73];
    ...
    if ( !pthread_mutex_lock(&gpio_ctrl_map) )
    {
      ...
      for ( i = ((int (__fastcall *)(_DWORD *))*v6)(v6); i; i = ((int (__fastcall *)(_DWORD *))*v6)(v6) )
      {
        ...
        if ( *((_DWORD *)ptr + 1) != v2 )
        {
          ...
          v1[0] = *(_DWORD *)ptr;
          v1[1] = v2;
          ((void (__fastcall *)(_DWORD *, int *, int))v6[1])(v6, v1, 8);
        }
        free(ptr);
      }
...
int __fastcall gpio_direction(int a1, int a2)
{
  ...
  {
    snprintf(v11, 0x40u, "/sys/class/gpio/gpio%d/direction", a1);
    fd = open(v11, 1);
    if ( fd >= 0 )
    {
      if ( a2 )
...
int __fastcall gpio_read(int a1, _BYTE *a2)
{
  ...
  {
    snprintf(v7, 0x40u, "/sys/class/gpio/gpio%d/value", a1);
    fd = open(v7, 0);
    if ( fd >= 0 )
    {
      if ( read(fd, &v6, 4u) >= 0 )
...
int __fastcall gpio_write(int a1, char a2)
{
  ...
  {
    snprintf(v6, 0x40u, "/sys/class/gpio/gpio%d/value", a1);
    fd = open(v6, 1);
    if ( fd >= 0 )
    {
...
unsigned int __fastcall uart_send(int a1, const void *a2, size_t a3)
{
  ...
  unsigned int v9; // [sp+1Ch] [bp+14h] BYREF
  int v10; // [sp+20h] [bp+18h] BYREF
  int v11; // [sp+24h] [bp+1Ch] BYREF
  int v12; // [sp+28h] [bp+20h] BYREF
  _BYTE v13[256]; // [sp+2Ch] [bp+24h] BYREF
  unsigned int v14; // [sp+12Ch] [bp+124h]
  int v15; // [sp+130h] [bp+128h]
  int v16; // [sp+134h] [bp+12Ch]
  int v17; // [sp+138h] [bp+130h]
  int i; // [sp+13Ch] [bp+134h]
  ...
  else
  {
    ...
    for ( i = 0; i < v15; ++i )
    {
      v17 = (unsigned __int8)v13[4 * i + 3] | ((unsigned __int8)v13[4 * i] << 24) | ((unsigned __int8)v13[4 * i + 1] << 16) | ((unsigned __int8)v13[4 * i + 2] << 8);
      fpga_write(v10, v17);
    }
    v15 = v14 & 3;
    if ( (v14 & 3) != 0 )
    {
      ...
      {
        case 2:
          v17 = ((unsigned __int8)v13[4 * i + 1] << 16) | ((unsigned __int8)v13[4 * i] << 24);
          break;
        case 3:
          v17 = ((unsigned __int8)v13[4 * i + 2] << 8) | ((unsigned __int8)v13[4 * i] << 24) | ((unsigned __int8)v13[4 * i + 1] << 16);
          break;
        case 1:
          v17 = (unsigned __int8)v13[4 * i] << 24;
          break;
        default:
...
int __fastcall clear_uart_rx_fifo(int a1)
{
  ...
  unsigned int size; // [sp+18h] [bp+10h]
    ...
    if ( !pthread_mutex_lock(&ui_api_mutex) )
    {
      ...
      for ( i = ((int (__fastcall *)(_DWORD *))*v4)(v4); i; i = ((int (__fastcall *)(_DWORD *))*v4)(v4) )
      {
        ...
        *((_DWORD *)ptr + 1) = *((_DWORD *)ptr + 1);
        ...
        v1[1] = *((_DWORD *)ptr + 1);
        v1[2] = *((_DWORD *)ptr + 2);
        ((void (__fastcall *)(_DWORD *, int *, int))v4[1])(v4, v1, 12);
        free(ptr);
      }
...
// 1F86C: using guessed type int ui_pull_function();
// 1FA50: using guessed type int gpio_key_callback();
// 2360F4: using guessed type pthread_mutex_t ui_api_mutex;
// 23610C: using guessed type int ui_flicker_map;
...
int __fastcall add_port_to_gpio_map(int result, int a2, int *a3)
{
  int v5[2]; // [sp+14h] [bp+Ch] BYREF
  int v6[3]; // [sp+1Ch] [bp+14h] BYREF
  ...
  if ( a3 )
  {
    ...
    for ( i = ((int (__fastcall *)(_DWORD *))*v8)(v8); i; i = ((int (__fastcall *)(_DWORD *))*v8)(v8) )
    {
      ...
      if ( ***(_DWORD ***)(v7 + 16) == a1 )
      {
        ...
        v5[1] = 0;
        v5[2] = 1;
        ((void (__fastcall *)(_DWORD *, int *, int))v8[1])(v8, v5, 12);
...
int __fastcall i2c_uninit(int a1)
{
  ...
  else
  {
    ...
    v3 = new_iterator_c_map(i2c_ctx_map);
    for ( i = ((int (__fastcall *)(_DWORD *))*v3)(v3); i; i = ((int (__fastcall *)(_DWORD *))*v3)(v3) )
      ++v5;
  ...
  if ( a3 == 1 )
  {
    ...
    else
    {
      ...
      if ( find_c_map((int *)i2c_ctx_map, (int)&v9, &ptr) == 1 )
      {
        ...
        for ( i = 0; i < a5; ++i )
        {
          v12 = *(unsigned __int8 *)(a4 + i) | (*v11 << 26) | (v11[1] >> 4 << 20) | (((v11[1] >> 1) & 7) << 16) | ((*a2 + i) << 8) | 0x1000000;
          if ( !wait4i2c_ready() )
          {
    ...
    for ( i = ((int (__fastcall *)(_DWORD *))*v11)(v11); i; i = ((int (__fastcall *)(_DWORD *))*v11)(v11) )
    {
      ...
      if ( a1 == ***(_DWORD ***)(v10 + 16) )
      {
        ...
        if ( a2 == 1795 )
        {
          v8[0] = *(_DWORD *)ptr;
          v8[1] = a3;
          ((void (__fastcall *)(_DWORD *, int *, int))v11[1])(v11, v8, 8);
  ...
  else
  {
    ...
    for ( i = ((int (__fastcall *)(_DWORD *))*v9)(v9); i; i = ((int (__fastcall *)(_DWORD *))*v9)(v9) )
    {
      ...
      if ( a1 == ***(_DWORD ***)(v8 + 16) )
      {
        ...
        v6[0] = a2;
        v6[1] = *((_DWORD *)ptr + 1);
        ((void (__fastcall *)(_DWORD *, int *, int))v9[1])(v9, v6, 8);
...
int __fastcall hal_load_conf(const unsigned __int8 *a1)
{
  ...
  json_t_0 *v22; // [sp+124h] [bp+124h]
  const json_t_0 *v23; // [sp+128h] [bp+128h]
  json_t_0 *file; // [sp+12Ch] [bp+12Ch]
  ...
  if ( file && !*(_DWORD *)file )
  {
    ...
    printf("json = %s \n", (const char *)ptr);
    free(ptr);
    v23 = (const json_t_0 *)json_object_get(file, "chain");
    if ( v23 && *(_DWORD *)v23 == 1 )
    {
      for ( i = 0; ; ++i )
      {
      ...
      v23 = (const json_t_0 *)json_object_get(file, "fan");
      if ( v23 && *(_DWORD *)v23 == 1 )
      {
        for ( j = 0; ; ++j )
        {
        ...
        v22 = (json_t_0 *)json_object_get(file, "red");
        if ( v22 && *(_DWORD *)v22 == 3 )
        {
          red_addr = json_integer_value((int)v22);
          v22 = (json_t_0 *)json_object_get(file, "green");
          if ( v22 && *(_DWORD *)v22 == 3 )
          {
            green_addr = json_integer_value((int)v22);
            v22 = (json_t_0 *)json_object_get(file, "reset");
            if ( v22 && *(_DWORD *)v22 == 3 )
            {
              reset_addr = json_integer_value((int)v22);
              v22 = (json_t_0 *)json_object_get(file, "ipreport");
              if ( v22 && *(_DWORD *)v22 == 3 )
              {
...
// 22098: using guessed type int get_next_c_map();
// 220F4: using guessed type int get_value_c_map();
// 22114: using guessed type int replace_value_c_map();
...
int __fastcall debug_verify_property_1(int a1, _DWORD *a2)
{
  ...
  if ( (_DWORD *)(a1 + 4) != a2 )
  {
    debug_verify_property_1(a1, *a2);
    return debug_verify_property_1(a1, a2[1]);
  }
  return result;
}
...
int __fastcall debug_verify_property_4(int a1, int *a2)
{
  ...
  if ( (int *)(a1 + 4) != a2 )
  {
    debug_verify_property_4(a1, *a2);
    return debug_verify_property_4(a1, a2[1]);
  }
  return result;
}
...
int __fastcall debug_verify_property_5_helper(int a1, _DWORD *a2, int a3, _DWORD *a4)
{
  ...
  {
    debug_verify_property_5_helper(a1, *a2, a3, a4);
    return debug_verify_property_5_helper(a1, a2[1], a3, a4);
  }
  return result;
}
...
int __fastcall dump_string(unsigned __int8 *a1, int (__fastcall *a2)(unsigned __int8 *, int, int), int a3, __int16 a4)
{
  char v10[16]; // [sp+14h] [bp+14h] BYREF
  int v11; // [sp+24h] [bp+24h] BYREF
  int v12; // [sp+28h] [bp+28h]
  int v13; // [sp+2Ch] [bp+2Ch]
  int v14; // [sp+30h] [bp+30h]
  const char *v15; // [sp+34h] [bp+34h]
  unsigned __int8 *i; // [sp+38h] [bp+38h]
  unsigned __int8 *v17; // [sp+3Ch] [bp+3Ch]
  ...
  if ( !a2("\"", 1, a3) )
  {
    ...
    for ( i = a1; ; a1 = i )
    {
      ...
      if ( v11 > 0xFFFF )
      {
        ...
        sprintf(v10, "\\u%04x\\u%04x", v13, v12);
        v14 = 12;
      }
      else
      {
        sprintf(v10, "\\u%04x", v11);
        v14 = 6;
      }
      v15 = v10;
LABEL_43:
    ...
    switch ( *(_DWORD *)a1 )
    {
      case 0:
        ...
        if ( *(_DWORD *)(a1 + 32) )
          goto LABEL_75;
        *(_DWORD *)(v23 + 32) = 1;
        v33 = json_object_iter((json_t_0 *)a1);
        if ( a4("{", 1, a5) )
          goto LABEL_75;
        if ( !v33 )
          goto LABEL_37;
        ...
        {
          nmemb = json_object_size((const json_t_0 *)a1);
...
LABEL_75:
          ...
          while ( v33 )
          {
            ...
            *((_DWORD *)base + 2 * i + 1) = json_object_iter_key(v33);
            v33 = json_object_iter_next((json_t_0 *)a1, v33);
            ++i;
          }
          if ( i != nmemb )
          ...
          for ( i = 0; i < nmemb; ++i )
          {
            ...
            v18 = json_object_get((_DWORD *)a1, v19);
            if ( !v18 )
              _assert_fail("value", "3rdparty/jansson-2.6/src/dump.c", 0x151u, "do_dump");
            dump_string((unsigned __int8 *)v19, (int (__fastcall *)(unsigned __int8 *, int, int))a4, a5, a2);
...
LABEL_61:
        ...
        else
        {
          while ( v33 )
          {
            v22 = json_object_iter_next((json_t_0 *)a1, v33);
            v10 = (unsigned __int8 *)json_object_iter_key(v33);
            dump_string(v10, (int (__fastcall *)(unsigned __int8 *, int, int))a4, a5, a2);
            if ( a4(v32, v31, a5) )
              goto LABEL_75;
            v11 = json_object_iter_value((int)v33);
...
LABEL_37:
      ...
      case 1:
        ...
        if ( *(_DWORD *)(a1 + 20) )
          goto LABEL_30;
        *(_DWORD *)(v25 + 20) = 1;
        v24 = json_array_size((const json_t_0 *)a1);
        if ( a4("[", 1, a5) )
          goto LABEL_30;
        if ( !v24 )
          goto LABEL_18;
...
LABEL_18:
          ...
          v9 = json_array_get((const json_t_0 *)a1, v34);
...
LABEL_30:
        *(_DWORD *)(v25 + 20) = 0;
        return -1;
      case 2:
        v8 = (unsigned __int8 *)json_string_value((const json_t_0 *)a1);
        return dump_string(v8, (int (__fastcall *)(unsigned __int8 *, int, int))a4, a5, a2);
      case 3:
        v7 = json_integer_value(a1);
        v28 = snprintf(v17, 0x64u, "%lld", v7);
        if ( v28 >= 0 && v28 <= 99 )
          return a4(v17, v28, a5);
        else
          return -1;
      case 4:
        json_real_value((const json_t_0 *)a1);
        v27 = v5;
        v26 = jsonp_dtostr(v17, 0x64u);
        if ( v26 >= 0 )
          return a4(v17, v26, a5);
        else
          return -1;
      case 5:
        return a4("true", 4, a5);
...
unsigned __int8 *__cdecl json_dumps(const json_t_0 *json, size_t flags)
{
  ...
  char strbuff[12]; // [sp+8h] [bp+8h] BYREF
  unsigned __int8 *v8; // [sp+14h] [bp+14h]

  v5 = flags;
  if ( strbuffer_init((strbuffer_t *)strbuff) )
    return 0;
  if ( json_dump_callback(json, (int (__fastcall *)(const char *, int, int))dump_to_strbuffer, (int)strbuff, v5) )
  {
    v8 = 0;
  }
  else
  {
    v3 = (const char *)strbuffer_value((int)strbuff);
    v8 = (unsigned __int8 *)jsonp_strdup(v3);
  }
...
int __cdecl json_dump_file(const json_t_0 *json, const unsigned __int8 *path, size_t flags)
{
  ...
  stream = fopen((const char *)path, "w");
  if ( !stream )
    return -1;
...
int __fastcall json_dump_callback(_DWORD *a1, int (__fastcall *a2)(const char *, int, int), int a3, __int16 a4)
{
  if ( (a4 & 0x200) != 0 || a1 && *a1 == 1 || a1 && !*a1 )
    return do_dump((int)a1, a4, 0, a2, a3);
  else
    return -1;
}
...
int __fastcall json_decref_0(int result)
{
  if ( result && *(_DWORD *)(result + 4) != -1 && !--*(_DWORD *)(result + 4) )
    return json_delete(result);
  return result;
}
// 27554: using guessed type int __fastcall json_delete(_DWORD);
...
int __fastcall hashtable_do_del(int a1, const char *a2, unsigned int a3)
{
  ...
  v9 = *(_DWORD *)(a1 + 4) + 8 * (a3 % num_buckets(a1));
  pair = hashtable_find_pair((hashtable_t *)a1, (bucket_t *)v9, a2, a3);
  if ( !pair )
    return -1;
...
int __fastcall hashtable_set(int a1, char *a2, int a3, int a4)
{
  ...
  v4 = *(_DWORD *)a1;
  if ( v4 < num_buckets(a1) || !hashtable_do_rehash(a1) )
  {
    v15 = hash_str(a2);
    v14 = (bucket_t *)(*(_DWORD *)(a1 + 4) + 8 * (v15 % num_buckets(a1)));
    pair = hashtable_find_pair((hashtable_t *)a1, v14, a2, v15);
    if ( pair )
    {
      json_decref_0(*(_DWORD *)(pair + 12));
      *(_DWORD *)(pair + 12) = a4;
    ...
    else
    {
      ...
      *((_DWORD *)v13 + 3) = a4;
      ...
      insert_to_bucket((hashtable_t *)a1, v14, (list_t *)(v13 + 4));
      ++*(_DWORD *)a1;
    }
    return 0;
  }
...
int __fastcall hashtable_iter_set(int a1, int a2)
{
  ...
  v4 = a1 - 4;
  result = json_decref_0(*(_DWORD *)(a1 + 8));
  *(_DWORD *)(v4 + 12) = a2;
  return result;
}
...
int __cdecl json_object_set_nocheck(json_t_0 *object, const unsigned __int8 *key, json_t_0 *value)
{
  ...
  return json_object_set_new_nocheck(object, (char *)key, (int)v3);
}
...
void error_set(json_error_t *error, const lex_t *lex, const unsigned __int8 *msg, ...)
{
  ...
  char v6[160]; // [sp+B0h] [bp+A8h] BYREF
  __gnuc_va_list arg; // [sp+150h] [bp+148h]
  const char *v8; // [sp+154h] [bp+14Ch]
  char *v9; // [sp+158h] [bp+150h]
  int v10; // [sp+15Ch] [bp+154h]
  int v11; // [sp+160h] [bp+158h]
  int v12; // [sp+164h] [bp+15Ch]
  const char *varg_r2; // [sp+170h] [bp+168h]
  va_list varg_r3; // [sp+174h] [bp+16Ch] BYREF

  va_start(varg_r3, msg);
  varg_r2 = (const char *)msg;
  v12 = -1;
  v11 = -1;
  v10 = 0;
  v9 = v6;
  ...
  {
    va_copy(arg, varg_r3);
    vsnprintf(v6, 0xA0u, varg_r2, varg_r3);
    v6[159] = 0;
    if ( lex )
    {
      v8 = (const char *)strbuffer_value((int)lex + 40);
      v12 = *((_DWORD *)lex + 6);
      v11 = *((_DWORD *)lex + 7);
      v10 = *((_DWORD *)lex + 9);
      if ( v8 && *v8 )
      {
        ...
        {
          snprintf((char *)msg_with_context, 0xA0u, "%s near '%s'", v6, v8);
          msg_with_context[159] = 0;
          v9 = (char *)msg_with_context;
        }
      }
      ...
      {
        snprintf((char *)msg_with_context, 0xA0u, "%s near end of file", v6);
        msg_with_context[159] = 0;
        v9 = (char *)msg_with_context;
      }
    }
    jsonp_error_set(error, v12, v11, v10, "%s", v9);
  }
}
...
void __fastcall lex_scan_string(int a1, json_error_t *a2)
{
  ...
  unsigned __int8 v6[4]; // [sp+14h] [bp+Ch] BYREF
...
// 248E8: using guessed type unsigned __int8 anonymous_0[4];
...
// 24CA0: using guessed type double var_20;
...
json_t_0 *__fastcall parse_object(int a1, int a2, json_error_t *a3)
{
  json_t_0 *v8; // [sp+14h] [bp+14h]
  void *v9; // [sp+18h] [bp+18h]
  json_t_0 *v10; // [sp+1Ch] [bp+1Ch]

  v10 = (json_t_0 *)json_object();
  if ( !v10 )
    return 0;
  lex_scan(a1, a3);
  if ( *(_DWORD *)(a1 + 52) == 125 )
  ...
  while ( 1 )
  {
    if ( *(_DWORD *)(a1 + 52) != 256 )
    {
      error_set(a3, (const lex_t *)a1, "string or '}' expected");
      goto LABEL_23;
    }
    v9 = (void *)lex_steal_string(a1);
    if ( !v9 )
      return 0;
    if ( (a2 & 1) != 0 && json_object_get(v10, (char *)v9) )
    {
      jsonp_free(v9);
      error_set(a3, (const lex_t *)a1, "duplicate object key");
      goto LABEL_23;
    }
    lex_scan(a1, a3);
    if ( *(_DWORD *)(a1 + 52) != 58 )
    {
      jsonp_free(v9);
      error_set(a3, (const lex_t *)a1, "':' expected");
      goto LABEL_23;
    }
    lex_scan(a1, a3);
    v8 = (json_t_0 *)parse_value(a1, a2, a3);
    if ( !v8 )
    {
      jsonp_free(v9);
      goto LABEL_23;
    }
    if ( json_object_set_nocheck(v10, (const unsigned __int8 *)v9, v8) )
    {
      jsonp_free(v9);
...
// 25360: using guessed type int __fastcall parse_value(_DWORD, _DWORD, _DWORD);

//----- (000252A8) --------------------------------------------------------
json_t_0 *__fastcall parse_array(int a1, int a2, json_error_t *a3)
{
  json_t_0 *v8; // [sp+10h] [bp+10h]
  json_t_0 *v9; // [sp+14h] [bp+14h]
...
void *__fastcall parse_value(double a1, json_error_t *a2)
{
  ...
  if ( v2 == 91 )
  {
    v9 = parse_array(SLODWORD(a1), SHIDWORD(a1), a2);
LABEL_29:
    if ( v9 )
      return v9;
    else
  ...
  if ( v2 > 91 )
  {
    if ( v2 == 123 )
    {
      v9 = parse_object(SLODWORD(a1), SHIDWORD(a1), a2);
    }
    else
    {
      if ( v2 != 256 )
...
// 25360: using guessed type double var_10;
...
void *__fastcall parse_json(int a1, unsigned int a2, int a3)
{
  ...
  lex_scan(a1, (json_error_t *)a3);
  if ( (a2 & 4) != 0 || *(_DWORD *)(a1 + 52) == 91 || *(_DWORD *)(a1 + 52) == 123 )
  {
    v8 = parse_value(COERCE_DOUBLE(__PAIR64__(a2, a1)), (json_error_t *)a3);
    if ( v8 )
    {
      if ( (a2 & 2) != 0 || (lex_scan(a1, (json_error_t *)a3), !*(_DWORD *)(a1 + 52)) )
      {
        if ( a3 )
      ...
      {
        error_set((json_error_t *)a3, (const lex_t *)a1, "end of file expected");
        json_decref_1((int)v8);
        return 0;
      }
    }
  ...
  {
    error_set((json_error_t *)a3, (const lex_t *)a1, "'[' or '{' expected");
    return 0;
  }
}
...
void *__fastcall json_loads(int a1, unsigned int a2, json_error_t *a3)
{
  ...
  if ( a1 )
  {
    ...
    {
      v10 = parse_json((int)v9, a2, (int)a3);
      lex_close((int)v9);
      return v10;
    }
  }
...
void *__fastcall json_loadb(int a1, int a2, unsigned int a3, json_error_t *a4)
{
  int v10[3]; // [sp+14h] [bp+14h] BYREF
  _BYTE v11[68]; // [sp+20h] [bp+20h] BYREF
  void *v12; // [sp+64h] [bp+64h]
  ...
  if ( a1 )
  {
    ...
    {
      v12 = parse_json((int)v11, a3, (int)a4);
      lex_close((int)v11);
      return v12;
    }
  }
...
void *__fastcall json_loadf(int a1, unsigned int a2, json_error_t *a3)
{
  ...
  if ( a1 == stdin )
    ...
    v10 = "<stream>";
  jsonp_error_init(a3, (const unsigned __int8 *)v10);
  if ( a1 )
  {
    ...
    {
      v9 = parse_json((int)v8, a2, (int)a3);
      lex_close((int)v8);
      return v9;
    }
  }
...
json_t_0 *__cdecl json_load_file(const unsigned __int8 *path, size_t flags, json_error_t *error)
{
  ...
  if ( path )
  {
    ...
    if ( stream )
    {
      v10 = (json_t_0 *)json_loadf((int)stream, flags, error);
      fclose(stream);
      return v10;
    }
    else
...
void *__fastcall json_load_callback(int a1, int a2, unsigned int a3, json_error_t *a4)
{
  ...
  int v8; // [sp+8h] [bp+8h]
  int v9; // [sp+Ch] [bp+Ch]
  _DWORD v10[260]; // [sp+10h] [bp+10h] BYREF
  _BYTE v11[68]; // [sp+420h] [bp+420h] BYREF
  void *v12; // [sp+464h] [bp+464h]
  ...
  if ( v9 )
  {
    if ( lex_init((int)v11, (int)callback_get, (int)v10) )
    {
      return 0;
    }
    else
    {
      v12 = parse_json((int)v11, v7, (int)v6);
      lex_close((int)v11);
      return v12;
    }
  }
...
{
  if ( size )
    return (void *)do_malloc(size);
  else
    return 0;
}
// 35A80: using guessed type int (__fastcall *do_malloc)(_DWORD);
...
// 35A84: using guessed type int (__fastcall *do_free)(_DWORD);
...
//----- (000259F8) --------------------------------------------------------
int (__fastcall *__fastcall json_set_alloc_funcs(
        int (__fastcall *result)(_DWORD),
...
unsigned __int8 *__cdecl strbuffer_steal_value(strbuffer_t *strbuff)
{
  unsigned __int8 *v2; // [sp+Ch] [bp+Ch]

  v2 = *(unsigned __int8 **)strbuff;
  *(_DWORD *)strbuff = 0;
  return v2;
}
...
int __fastcall strbuffer_append(strbuffer_t *a1, const char *a2)
{
  ...
  v2 = strlen(a2);
  return strbuffer_append_bytes(a1, (const unsigned __int8 *)a2, v2);
}

//----- (00025B24) --------------------------------------------------------
int __cdecl strbuffer_append_byte(strbuffer_t *strbuff, unsigned __int8 byte)
{
  unsigned __int8 v3; // [sp+3h] [bp+3h] BYREF
...
void __cdecl from_locale(unsigned __int8 *buffer)
{
  ...
  if ( *v1->decimal_point != 46 )
  {
    v3 = strchr((const char *)buffer, *(unsigned __int8 *)v1->decimal_point);
    if ( v3 )
      *v3 = 46;
  }
}
...
{
  double v2; // d0
  char *v7; // [sp+Ch] [bp+Ch] BYREF
  double v8; // [sp+10h] [bp+10h]

  to_locale((strbuffer_t *)a1);
  *_errno_location() = 0;
  strtod(*(const char **)a1, &v7);
  v8 = v2;
  if ( (char *)(*(_DWORD *)a1 + *(_DWORD *)(a1 + 4)) != v7 )
    _assert_fail(
...
int __fastcall jsonp_dtostr(char *a1, size_t a2)
{
  ...
  if ( v7 >= a2 )
    return -1;
  from_locale((unsigned __int8 *)a1);
...
unsigned __int8 *__fastcall utf8_iterate(unsigned __int8 *a1, _DWORD *a2)
{
  ...
  else if ( !utf8_check_full((char *)a1, v7, &v6) )
  {
    return 0;
  }
  if ( a2 )
  ...
  if ( a2 )
  {
    if ( a1 )
    {
      if ( !*a1 && a1 != (_DWORD *)a3 )
      {
        v4 = a1[7];
        a1[7] = v4 + 1;
        if ( !hashtable_set((int)(a1 + 2), a2, v4, a3) )
          return 0;
      }
    }
  }
...
json_t_0 *__cdecl json_object_get_0(const json_t_0 *json, const unsigned __int8 *key)
{
  if ( key && json && !*(_DWORD *)json )
    return (json_t_0 *)hashtable_iter_at((int)json + 8, (char *)key);
  else
    return 0;
}
...
{
  if ( iter )
    return (const unsigned __int8 *)hashtable_iter_key((int)iter);
  else
    return 0;
}
...
int __cdecl json_object_equal(json_t_0 *object1, json_t_0 *object2)
{
  ...
  void *v6; // r0
  int v7; // r0
  json_t_0 *v11; // [sp+Ch] [bp+Ch]
  json_t_0 *v12; // [sp+10h] [bp+10h]
  ...
  for ( i = (char *)json_object_iter_key(v4); i; i = (char *)json_object_iter_key(v6) )
  {
    ...
    v12 = (json_t_0 *)json_object_iter_value(v7);
    if ( !v12 )
      break;
    v11 = (json_t_0 *)json_object_get(object2, i);
...
json_t_0 *__cdecl json_object_copy(json_t_0 *object)
{
  ...
  int v5; // r0
  int v8; // [sp+Ch] [bp+Ch]
  json_t_0 *v9; // [sp+10h] [bp+10h]
  char *i; // [sp+14h] [bp+14h]

  v9 = (json_t_0 *)json_object();
  if ( !v9 )
    return 0;
...
{
  json_t_0 *v2; // r0
  const json_t_0 *v5; // [sp+8h] [bp+8h]
  char *v6; // [sp+Ch] [bp+Ch]
  json_t_0 *v7; // [sp+10h] [bp+10h]
  void *i; // [sp+14h] [bp+14h]

  v7 = (json_t_0 *)json_object();
  if ( !v7 )
    return 0;
  for ( i = json_object_iter(object); i; i = json_object_iter_next(object, i) )
  {
    v6 = (char *)json_object_iter_key(i);
    v5 = (const json_t_0 *)json_object_iter_value((int)i);
    v2 = json_deep_copy(v5);
    json_object_set_new_nocheck(v7, v6, (int)v2);
  }
  return v7;
}
...
json_t_0 *__cdecl json_array_get(const json_t_0 *json, size_t index)
{
  ...
  if ( *((_DWORD *)json + 3) > index )
    return *(json_t_0 **)(*((_DWORD *)json + 4) + 4 * index);
  return 0;
}
...
json_t_0 **__cdecl json_array_grow(json_array_t *array, size_t amount, int copy)
{
  ...
  json_t_0 **v10; // [sp+24h] [bp+1Ch]

  if ( *((_DWORD *)array + 3) + amount <= *((_DWORD *)array + 2) )
    return (json_t_0 **)*((_DWORD *)array + 4);
  v10 = (json_t_0 **)*((_DWORD *)array + 4);
  ...
  *((_DWORD *)array + 4) = v8;
  if ( !copy )
    return v10;
  array_copy(*((json_t_0 ***)array + 4), 0, v10, 0, *((_DWORD *)array + 3));
  jsonp_free(v10);
  return (json_t_0 **)*((_DWORD *)array + 4);
}
...
int __cdecl json_array_insert_new(json_t_0 *json, size_t index, json_t_0 *value)
{
  ...
  if ( json && *(_DWORD *)json == 1 && json != value && *((_DWORD *)json + 3) >= index )
  {
    ...
    if ( v8 )
    {
      if ( *((json_t_0 ***)json + 4) == v8 )
      {
        array_move(json, index + 1, index, *((_DWORD *)json + 3) - index);
      }
      else
      {
        array_copy(*((json_t_0 ***)json + 4), 0, v8, 0, index);
        array_copy(*((json_t_0 ***)json + 4), index + 1, v8, index, *((_DWORD *)json + 3) - index);
        jsonp_free(v8);
      }
      *(_DWORD *)(*((_DWORD *)json + 4) + 4 * index) = value;
      ++*((_DWORD *)json + 3);
...
int __cdecl json_array_equal(json_t_0 *array1, json_t_0 *array2)
{
  ...
  for ( i = 0; i < v8; ++i )
  {
    ...
    v3 = json_array_get(array2, i);
    if ( !json_equal(v7, v3) )
      return 0;
  }
  return 1;
}
// 275D0: using guessed type int __fastcall json_equal(_DWORD, _DWORD);

//----- (00026FC0) --------------------------------------------------------
json_t_0 *__cdecl json_array_copy(json_t_0 *array)
{
  json_t_0 *v2; // r0
  json_t_0 *v5; // [sp+8h] [bp+8h]
...
bool __fastcall json_string_equal(const json_t_0 *a1, const json_t_0 *a2)
{
  ...
  return strcmp((const char *)v2, (const char *)v3) == 0;
}

//----- (0002720C) --------------------------------------------------------
_DWORD *__fastcall json_string_copy(const json_t_0 *a1)
{
  const unsigned __int8 *v1; // r0

  v1 = json_string_value(a1);
  return json_string_nocheck((const char *)v1);
}
...
json_t_0 *__cdecl json_integer_copy(const json_t_0 *integer)
{
  ...
  return (json_t_0 *)json_integer(v1);
}
...
json_t_0 *__cdecl json_real(double value)
{
  __int64 v1; // d0
  double v2; // r0
  json_t_0 *v5; // [sp+Ch] [bp+Ch]

  LODWORD(v2) = _isnan(value);
  if ( LODWORD(v2) || _isinf(v2) )
    return 0;
  v5 = (json_t_0 *)jsonp_malloc(0x10u);
  if ( !v5 )
    return 0;
  json_init(v5, 4);
  *((_QWORD *)v5 + 1) = v1;
...
// 273AC: variables would overlap: r0.4 and r0.8
// 273AC: bad return variable
...
void __fastcall json_delete(json_array_t *a1)
{
  if ( !a1 || *(_DWORD *)a1 )
  {
    if ( a1 && *(_DWORD *)a1 == 1 )
    {
      json_delete_array(a1);
    }
    else if ( a1 && *(_DWORD *)a1 == 2 )
    {
      json_delete_string(a1);
    }
    else if ( a1 && *(_DWORD *)a1 == 3 )
    {
...
json_t_0 *__fastcall json_copy(json_t_0 *a1)
{
  ...
  switch ( *(_DWORD *)a1 )
  {
    ...
    case 2:
      return (json_t_0 *)json_string_copy(a1);
    case 3:
...
void __cdecl jsonp_error_init(json_error_t *error, const unsigned __int8 *source)
{
  if ( error )
  {
    ...
    *((_DWORD *)error + 2) = 0;
    if ( source )
      jsonp_error_set_source((char *)error, (const char *)source);
    else
      *((_BYTE *)error + 12) = 0;
  }
}
  ...
  if ( error )
  {
    if ( !*((_BYTE *)error + 92) )
    {
      ...
      *((_DWORD *)error + 2) = position;
      vsnprintf((char *)error + 92, 0xA0u, (const char *)msg, ap);
      *((_BYTE *)error + 251) = 0;
    }
  }
}
