...
uint32_t __fastcall targetValidator(const void *, const void *); // idb
int __fastcall read_register(int, char, char, char); // idb
int __fastcall write_register_2(int, char, char, char, int); // idb
int __fastcall write_register(char, int); // idb
int set_i2c_enable();
int __fastcall i2c_status(unsigned __int8 a1, unsigned __int8 a2);
int __fastcall i2c_recv(unsigned __int8, unsigned __int8, char, char, _DWORD *); // idb
int __fastcall i2c_send(unsigned __int8, char, char, char, char); // idb
void asic_num_calculate(); // idb
int __fastcall calculate_asic_number(unsigned int); // idb
int asic_addr_interval(); // idb
int __fastcall set_frequency(int); // idb
int __fastcall set_frequency_scanfreq(int result); // idb
int __fastcall set_ticket_mask(int result); // idb
int set_io_drive_strength(); // idb
int __fastcall set_baud_chain(int result); // idb
int set_address(); // idb
int __fastcall set_core_timeout(int result); // idb
int __fastcall set_txn_data(int result); // idb
int __fastcall set_nonce_shift(char); // idb
int __fastcall set_pt_ctrl(int result, char); // idb
int __fastcall set_pt_result(int result, char); // idb
int __fastcall x86_tty_open(int, int); // idb
int x86_tty_close(); // idb
int __fastcall x86_tty_init(int, uint32_t); // idb
double cal_avg_hashrate();
int __fastcall cal_rt_hashrate(int a1, int a2);
double __fastcall cal_factor_hashrate(double a1, double a2);
int __fastcall is_patten_match(int a1, const unsigned __int8 *a2, const unsigned __int8 *a3);
int nonce_scanhash(); // weak
void __noreturn nonce_scanhash_loop(); // idb
int __fastcall nonce_integrality(unsigned __int8, unsigned __int8, int, int); // idb
void clear_register_value_buf(); // idb
int __fastcall pm_handle(unsigned __int8 *a1, size_t a2, unsigned __int8 a3);
int __fastcall pt_handle(int, int, unsigned __int8); // idb
int __fastcall reg_handle(int, char, char); // idb
int __fastcall nonce_handle(int, int, const unsigned __int8 *, size_t, char); // idb
void __cdecl add_point(int *point, int MAX_SIZE);
void __noreturn handle_asic_response(); // idb
int bm1744_app_init(); // idb
int bm1744_app_exit();
void *__fastcall send_work(const unsigned __int8 *a1, char a2, char a3);
int __fastcall read_sensor(unsigned __int8, int, char, unsigned __int8, _BYTE *); // idb
void app_config_init_registers(); // idb
void __noreturn rw_register_loop(); // idb
uint8_t __cdecl get_bt8d_from_baud(const uint32_t baud);
unsigned int __fastcall get_index_by_freq(int a1);
int __fastcall get_freq_by_index(int); // idb
int __fastcall get_plldata(int result, _DWORD *); // idb
...
int __fastcall add_reg_item(int, int, int); // idb
int __fastcall read_reg_item(unsigned __int8 *, int); // idb
int reg_scan_aging(); // idb
int reg_scan_init(); // idb
int reg_scan_exit(); // idb
unsigned int __fastcall _bswap_32(unsigned int a1);
unsigned int __fastcall compressArray(int, int, int, unsigned int, unsigned int, unsigned int); // idb
unsigned int __fastcall expandArray(int, unsigned int, int, int, unsigned int, unsigned int); // idb
unsigned int __fastcall getIndices(int, int, int, int, int, unsigned int); // idb
...
int __fastcall ISL_page_enable(unsigned __int8, unsigned __int8, unsigned __int8, char); // idb
int __fastcall ISL_on(unsigned __int8, unsigned __int8, unsigned __int8); // idb
int __fastcall ISL_off(unsigned __int8, unsigned __int8, unsigned __int8); // idb
int __fastcall ISL_set_on_off_config(unsigned __int8, unsigned __int8, unsigned __int8, char); // idb
int __fastcall ISL_set_clear_faults(unsigned __int8, unsigned __int8, unsigned __int8); // idb
int __fastcall ISL_set_write_protect(unsigned __int8, unsigned __int8, unsigned __int8, char); // idb
int __fastcall ISL_set_vout_command(unsigned __int8, unsigned __int8, unsigned __int8, unsigned __int16); // idb
int __fastcall ISL_set_apply_settings(unsigned __int8, unsigned __int8, unsigned __int8); // idb
int __fastcall ISL_get_voltage(unsigned __int8, unsigned __int8, char, _WORD *); // idb
int __fastcall ISL_read_reg_default(unsigned __int8, unsigned __int8, char); // idb
...
int __fastcall set_baud(int); // idb
int bm1744_hashboard_init();
void *show_nonce_detail(); // idb
void __noreturn singleboard_sensor_test(); // weak
int singleboard_set_address_test(); // idb
int __fastcall singleboard_step_increase_frequency(int, int); // idb
void *singleboard_nonce_test(); // idb
void singleboard_patten_test();
int pcba_test(); // idb
int __cdecl vol_init(unsigned __int16 vol);
int __fastcall isl_communication_check(unsigned __int16); // idb
int start_single_board_test();
unsigned int hw_test_customized();
int pcba_app_manual_test(); // idb
int start_pcba_test(); // idb
...
int __fastcall write_dc_dc(unsigned __int8, unsigned __int8, unsigned __int8, char, int, int); // idb
int __fastcall read_dc_dc(unsigned __int8, unsigned __int8, char, char, int, int); // idb
...
int __fastcall reset_PIC16F1704_pic(unsigned __int8, unsigned __int8); // idb
...
int __fastcall write_data_to_PIC16F1704_flash(unsigned __int8, unsigned __int8, unsigned __int8 *, signed int); // idb
...
int __fastcall uart_open(const char *, _DWORD *); // idb
...
unsigned int __fastcall uart_receive(unsigned __int8 a1, unsigned __int8 *a2, unsigned int a3);
...
int check_chain();
void V9_print_lcd();
void __fastcall V9_print_lcd_type(int); // idb
int __fastcall is_asic_pass(int); // idb
int V9_show_status_func();
int singleBoardTest_V9_BM1744_manual();
int singleBoardTest_V9_BM1744();
void *__fastcall get_app_config(void *); // idb
int __fastcall app_config_handle(const char *); // idb
...
int power_up();
int power_down();
int __fastcall my_log_curses(int result, const char *, const char *, char); // idb
int __fastcall applog(int, const char *, char); // idb
...
int __fastcall slt_notify_ui(int result, int); // idb
int slt_init();
int slt_exit();
...
void __fastcall dump_str(FILE *, const char *, const unsigned __int8 *, size_t); // idb
...
_UNKNOWN loc_125A0; // weak
_UNKNOWN loc_125A8; // weak
_UNKNOWN loc_125B0; // weak
_UNKNOWN loc_125B8; // weak
_UNKNOWN loc_125BC; // weak
_UNKNOWN loc_125C0; // weak
_UNKNOWN loc_125C4; // weak
_UNKNOWN locret_125C8; // weak
_UNKNOWN loc_125CC; // weak
_UNKNOWN loc_125D0; // weak
_UNKNOWN loc_125D4; // weak
_UNKNOWN loc_32F00; // weak
_QWORD blake2b_IV[8] =
{
...
char byte_3665C[4] = { '\0', '\0', '\0', '\0' }; // weak
_DWORD K[64] =
{
  1116352408,
  1899447441,
...
void *_frame_dummy_init_array_entry = (void *)0x11225; // weak
...
void *status_period_8900 = &unk_7A120; // weak
...
int dword_47880; // weak
int dword_47884; // weak
int nonce_invalid_num_each_asic[3]; // weak
int nonce_invalid_num_each_asic_2[]; // weak
int dword_47898; // weak
int dword_4789C; // weak
int dword_478A0; // weak
int dword_478A4; // weak
int dword_478A8; // weak
int one_work_nonce_each_asic[]; // weak
int dword_478B0; // weak
int dword_478B4; // weak
_DWORD one_work_invalid_nonce_each_asic[3]; // weak
...
int this_time_8855; // weak
int last_time_8854; // weak
int last_time_nonces_8856; // weak
int total_8896; // weak
int golden_nonce_8895; // weak
int total_shares_8897; // weak
__int64 t1_8899; // weak
__int64 t0_8898; // weak
int txok_flag_9001; // weak
int total_error_9000; // weak
...
char byte_47E55; // weak
char byte_47E56; // weak
...
char byte_4843D; // weak
char byte_48440; // weak
char byte_48441; // weak
_UNKNOWN g_work_header; // weak
int nonce_fifo; // weak
int dword_492DC; // weak
int dword_492E0; // weak
...
_UNKNOWN unk_F27C0; // weak
int dword_F294C; // weak
_UNKNOWN cgpu; // weak
pthread_t dword_F2970; // idb
pthread_t newthread; // idb
int dword_F298C; // weak
int dword_F2994; // weak
int dword_F29B4; // weak
_BYTE chain_info[4]; // weak
int app_conf; // weak
char byte_F29CC[40]; // weak
int dword_F29F4; // weak
int dword_F2B30; // weak
int dword_F2B34; // weak
int dword_F2B38; // weak
int dword_F2B3C; // weak
int dword_F2B40; // weak
int dword_F2B44; // weak
int dword_F2B48; // weak
char s1[16]; // idb
int dword_F2B5C; // weak
int dword_F2B60; // weak
int dword_F2B64; // weak
int dword_F2B68; // weak
int dword_F2B6C; // weak
int dword_F2B70; // weak
int dword_F2B74; // weak
int dword_F2B78; // weak
int g_patten; // weak
...
// 10E60: control flows out of bounds to 0
...
// 11172: positive sp value 4 has been found
// 11184: variable 'v4' is possibly undefined
...
// 11018: using guessed type int _gmon_start__(void);
...
// 47828: using guessed type int _bss_start;
...
// 47838: using guessed type char completed_9251;
...
// 46EC0: using guessed type int (__fastcall *memset_v_5089)(_DWORD, _DWORD, _DWORD);
...
// 331C8: using guessed type _QWORD blake2b_IV[8];
...
int __cdecl blake2b_compress(blake2b_state *S, const uint8_t *block)
{
  ...
  v16 = loc_125A8;
  v17 = loc_125B0;
  v18 = *((_QWORD *)S + 8) ^ __PAIR64__(loc_125BC, loc_125B8);
  v19 = *((_QWORD *)S + 9) ^ __PAIR64__(loc_125C4, loc_125C0);
  v20 = *((_QWORD *)S + 10) ^ __PAIR64__(loc_125CC, locret_125C8);
  v21 = *((_QWORD *)S + 11) ^ __PAIR64__(loc_125D4, loc_125D0);
  v6 += m[0] + v10;
...
// 47ECC: using guessed type int g_chain[8];
...
// 46EDC: using guessed type int g_misc_control;
// 47704: using guessed type int opt_log_level;
// 47EAC: using guessed type char use_syslog;
// 47EAF: using guessed type char opt_log_output;
// 47ECC: using guessed type int g_chain[8];
...
// 47860: using guessed type int g_general_i2c_command;
// 47ECC: using guessed type int g_chain[8];
...
// 478E8: using guessed type _DWORD asic_num[1];
// 47ECC: using guessed type int g_chain[8];
...
// 47704: using guessed type int opt_log_level;
// 47EAC: using guessed type char use_syslog;
// 47EAE: using guessed type char opt_debug;
// 47EAF: using guessed type char opt_log_output;
...
// 46EF8: using guessed type int addr_interval;
// 47704: using guessed type int opt_log_level;
// 478EC: using guessed type char sensor_chip_addr;
// 478ED: using guessed type char byte_478ED;
// 47EAC: using guessed type char use_syslog;
// 47EAF: using guessed type char opt_log_output;
...
// 46ED4: using guessed type int g_pll_parameter;
// 47704: using guessed type int opt_log_level;
// 47EAC: using guessed type char use_syslog;
// 47EAF: using guessed type char opt_log_output;
// 47ECC: using guessed type int g_chain[8];
...
// 46ED8: using guessed type int g_ticket_mask;
// 47704: using guessed type int opt_log_level;
// 47EAC: using guessed type char use_syslog;
// 47EAF: using guessed type char opt_log_output;
// 47ECC: using guessed type int g_chain[8];
...
// 46EE4: using guessed type int g_io_drive_strength;
// 47704: using guessed type int opt_log_level;
// 47EAC: using guessed type char use_syslog;
// 47EAF: using guessed type char opt_log_output;
...
// 46EE0: using guessed type int g_core_timeout;
// 47704: using guessed type int opt_log_level;
// 47EAC: using guessed type char use_syslog;
// 47EAF: using guessed type char opt_log_output;
// 47ECC: using guessed type int g_chain[8];
...
// 46EF0: using guessed type int g_nonce_shift;
// 47704: using guessed type int opt_log_level;
// 47EAC: using guessed type char use_syslog;
// 47EAF: using guessed type char opt_log_output;
// 47ECC: using guessed type int g_chain[8];
...
// 47704: using guessed type int opt_log_level;
// 47874: using guessed type int g_pt_ctrl;
// 47EAC: using guessed type char use_syslog;
// 47EAF: using guessed type char opt_log_output;
// 47ECC: using guessed type int g_chain[8];
...
double cal_avg_hashrate()
{
  ...
  LODWORD(v0) = time(0);
  return pow(v0, COERCE_DOUBLE(__PAIR64__(g_ticket_mask, LODWORD(v0))));
}
// 1B734: variable 'v0' is possibly undefined
// 46ED8: using guessed type int g_ticket_mask;
...
int __fastcall cal_rt_hashrate(int a1, int a2)
{
  ...
  LODWORD(v2) = time(0);
  this_time_8855 = LODWORD(v2);
  if ( LODWORD(v2) - last_time_8854 >= a2 )
  {
    last_time_8854 = this_time_8855;
    LODWORD(v3) = a1;
    last_time_nonces_8856 = a1;
    if ( this_time_8855 )
    {
      HIDWORD(v3) = g_ticket_mask;
      v4 = pow(v2, v3);
      HIDWORD(v5) = g_ticket_mask;
      v2 = pow(v4, v5);
    }
  }
  return LODWORD(v2);
}
// 1B7FE: variable 'v2' is possibly undefined
// 1B82A: variable 'v5' is possibly undefined
// 46ED8: using guessed type int g_ticket_mask;
// 47928: using guessed type int this_time_8855;
// 4792C: using guessed type int last_time_8854;
// 47930: using guessed type int last_time_nonces_8856;

//----- (0001B868) --------------------------------------------------------
double __fastcall cal_factor_hashrate(double a1, double a2)
{
  HIDWORD(a2) = g_ticket_mask;
  return pow(a1, a2);
}
// 46ED8: using guessed type int g_ticket_mask;
...
int __fastcall is_patten_match(int a1, const unsigned __int8 *a2, const unsigned __int8 *a3)
{
  ...
  if ( dword_F2C94 != a1
    || (v8 = memcmp((const void *)(dword_F2C90 + dword_F2C3C), a2, dword_F2C40),
        v7 = memcmp((const void *)(dword_F2C90 + dword_F2C40 + dword_F2C3C), a3, dword_F2C44),
        v8)
    || v7 )
  {
    dump_str((FILE *)_bss_start, "Not Match Golden:", a2, dword_F2C40);
    dump_str((FILE *)_bss_start, "Not Match Recv:", a3, dword_F2C44);
    return 1;
  }
  else
  {
    pthread_mutex_lock(&mutex);
    *(_BYTE *)(dword_F2C9C + dword_F2C48 * (dword_F2C38 * dword_F2C94 + dword_F2C98) + dword_F2CA0) = 1;
    ++dword_F2CA4;
...
int nonce_scanhash()
{
  ...
  uint32_t v2; // r0
  int v3; // r2
  _BYTE v5[360]; // [sp+30h] [bp+0h] BYREF
  char v6[1024]; // [sp+198h] [bp+168h] BYREF
  _DWORD v7[3]; // [sp+598h] [bp+568h] BYREF
  uint8_t v8[140]; // [sp+5A4h] [bp+574h] BYREF
  unsigned int v9[340]; // [sp+630h] [bp+600h] BYREF
  float v10; // [sp+B80h] [bp+B50h]
  unsigned int v11; // [sp+B84h] [bp+B54h]
  float v12; // [sp+B88h] [bp+B58h]
  float v13; // [sp+B8Ch] [bp+B5Ch]
  int v14; // [sp+B90h] [bp+B60h]
  unsigned int v15; // [sp+B94h] [bp+B64h]
  unsigned int j; // [sp+B98h] [bp+B68h]
  int i; // [sp+B9Ch] [bp+B6Ch]
  unsigned int m; // [sp+BA0h] [bp+B70h]
  int k; // [sp+BA4h] [bp+B74h]
  int v20; // [sp+BA8h] [bp+B78h]
  int v21; // [sp+BACh] [bp+B7Ch]
  ...
  while ( v20 )
  {
    ...
    --v20;
    --dword_492E0;
    memcpy(v9, (char *)&nonce_fifo + 1357 * dword_492DC + 12, 0x54Du);
    pthread_mutex_unlock(&nonce_mutex);
    pthread_mutex_lock(&g_rt_nonce_mutex);
    memcpy(&g_rt_nonce, v9, 0x54Du);
    pthread_mutex_unlock(&g_rt_nonce_mutex);
    if ( LOBYTE(v9[339]) && (use_syslog || opt_log_output || opt_log_level > 1) )
    {
      snprintf(v6, 0x400u, "Error:scanhash chainid=%u\n", LOBYTE(v9[339]));
      applog(2, v6, 0);
    }
    memcpy(v8, &g_work_header, sizeof(v8));
    *(_DWORD *)&v8[136 - g_nonce_shift] = v9[338];
    v7[0] = 200;
    v7[1] = 9;
    v7[2] = v5;
    digestInit((blake2b_state *)v5, 200, 9);
    blake2b_update((blake2b_state *)v5, v8, 0x8CuLL);
    v14 = sortValidator(v7, (const unsigned __int8 *)v9);
    v15 = targetValidator(v8, v9);
    if ( g_new_work )
    {
    ...
    if ( v14 )
    {
      ...
      for ( i = 0; i <= 0; ++i )
      {
        for ( j = 0; j <= 2; ++j )
        {
          if ( LOBYTE(v9[336]) / (unsigned int)addr_interval == j )
          {
            if ( v14 == 1 )
            {
    ...
    else
    {
      ...
      for ( k = 0; k <= 0; ++k )
      {
        for ( m = 0; m <= 2; ++m )
        {
          if ( LOBYTE(v9[336]) / (unsigned int)addr_interval == m )
          {
            ++one_work_nonce_each_asic[3 * k + m];
            ++nonce_num_each_asic[3 * k + m];
            if ( dword_F2CB0 )
              is_patten_match(m, (const unsigned __int8 *)&v9[338], (const unsigned __int8 *)v9);
            cal_avg_hashrate();
            v13 = v0;
            cal_rt_hashrate(one_work_nonce_each_asic[3 * k + m], 60);
            v12 = v0;
            v11 = bswap32(v9[338]);
            LODWORD(v1) = one_work_nonce_each_asic;
            HIDWORD(v1) = one_work_nonce_each_asic[3 * k + m];
            cal_factor_hashrate(COERCE_DOUBLE(__PAIR64__(HIDWORD(v1), v11)), v1);
            v10 = v0;
            if ( use_syslog || opt_log_output || opt_log_level > 0 )
            {
              snprintf(
      ...
      if ( dword_F29F4 == 1 )
      {
        v2 = target_zero_cal(g_work_info);
        if ( v2 <= v15 )
        {
          ++*(_QWORD *)&total_8896;
          if ( use_syslog || opt_log_output || opt_log_level > 2 )
          {
            v3 = golden_nonce_8895++;
            snprintf(v6, 0x400u, "Golden Nonce Found! %d\n", v3);
            applog(3, v6, 0);
          }
          print_solver_line((int)v9, (int)v8, dword_F294C, (int)&unk_F27C0);
          ++*(_QWORD *)&total_shares_8897;
          t1_8899 = miner_now();
          if ( *(_QWORD *)&status_period_8900 + t0_8898 < (unsigned __int64)t1_8899 )
          {
            t0_8898 = t1_8899;
            printf("status: %lld %lld\n", *(_QWORD *)&total_8896, *(_QWORD *)&total_shares_8897);
            fflush((FILE *)stdout);
          }
        }
      }
    }
    dump_str((FILE *)app_conf, 0, v8, 0x8Cu);
    pthread_mutex_lock(&nonce_mutex);
    if ( (unsigned int)dword_492DC >= 0x1FE )
      dword_492DC = 0;
    else
      ++dword_492DC;
    pthread_mutex_unlock(&nonce_mutex);
...
// 1BD7C: variable 'v0' is possibly undefined
// 1BA10: using guessed type int nonce_scanhash();
// 46EC8: using guessed type char g_new_work;
// 46EF0: using guessed type int g_nonce_shift;
// 46EF8: using guessed type int addr_interval;
// 46F00: using guessed type void *status_period_8900;
// 47704: using guessed type int opt_log_level;
// 47834: using guessed type int stdout;
// 4787C: using guessed type int nonce_num_each_asic[];
// 47888: using guessed type int nonce_invalid_num_each_asic[3];
// 47894: using guessed type int nonce_invalid_num_each_asic_2[];
// 478AC: using guessed type int one_work_nonce_each_asic[];
// 478B8: using guessed type _DWORD one_work_invalid_nonce_each_asic[3];
// 478C4: using guessed type _DWORD one_work_invalid_nonce_each_asic_2[6];
// 478DC: using guessed type int valid_nonce_total;
// 478E0: using guessed type int invalid_nonce_total;
// 478E4: using guessed type int submit_nonce;
// 478F0: using guessed type pthread_mutex_t g_rt_nonce_mutex;
// 4790C: using guessed type pthread_mutex_t nonce_mutex;
// 47938: using guessed type int total_8896;
// 47940: using guessed type int golden_nonce_8895;
// 47948: using guessed type int total_shares_8897;
// 47950: using guessed type __int64 t1_8899;
// 47958: using guessed type __int64 t0_8898;
// 47EAC: using guessed type char use_syslog;
// 47EAF: using guessed type char opt_log_output;
// 492D8: using guessed type int nonce_fifo;
// 492DC: using guessed type int dword_492DC;
// 492E0: using guessed type int dword_492E0;
// F27A0: using guessed type uint8_t g_work_info[32];
// F294C: using guessed type int dword_F294C;
// F29C8: using guessed type int app_conf;
// F29F4: using guessed type int dword_F29F4;
...
// 47704: using guessed type int opt_log_level;
// 47924: using guessed type char pattern_test_crc_error;
// 47EAC: using guessed type char use_syslog;
// 47EAF: using guessed type char opt_log_output;
  ...
  if ( v15 >= 0 )
  {
    ...
    *((_BYTE *)&nonce_fifo + 1357 * nonce_fifo + 1359) = *(_BYTE *)(1357 * v16 + a1 + 1357 * v18 + 1347);
    ...
    if ( (unsigned int)nonce_fifo >= 0x1FE )
      ...
      ++nonce_fifo;
    if ( (unsigned int)dword_492E0 > 0x1FE )
    {
      dword_492E0 = 511;
      if ( use_syslog || opt_log_output || opt_log_level > 0 )
      {
...
// 47704: using guessed type int opt_log_level;
// 4790C: using guessed type pthread_mutex_t nonce_mutex;
// 47925: using guessed type char g_txok_test_enable;
// 47960: using guessed type int txok_flag_9001;
// 47964: using guessed type int total_error_9000;
// 47EAC: using guessed type char use_syslog;
// 47EAF: using guessed type char opt_log_output;
// 492D8: using guessed type int nonce_fifo;
// 492E0: using guessed type int dword_492E0;
...
void __noreturn handle_asic_response()
{
  ...
  signed int v16; // [sp+15194h] [bp+1518Ch]
...
// 47704: using guessed type int opt_log_level;
// 47926: using guessed type char start_recv;
// 47EAC: using guessed type char use_syslog;
// 47EAF: using guessed type char opt_log_output;
// 47ECC: using guessed type int g_chain[8];
// 1D764: using guessed type int anonymous_4;
...
// 47EAC: using guessed type char use_syslog;
// 47EAF: using guessed type char opt_log_output;
// 47EC8: using guessed type int p_scanhash;
// 47ECC: using guessed type int g_chain[8];
...
int bm1744_app_exit()
{
  ...
  return pthread_join(p_scanhash, 0);
}
// 47704: using guessed type int opt_log_level;
// 47EAC: using guessed type char use_syslog;
// 47EAF: using guessed type char opt_log_output;
...
void *__fastcall send_work(const unsigned __int8 *a1, char a2, char a3)
{
  ...
  result = memcpy(&g_work_header, v8, 0x8Cu);
  g_new_work = 1;
  for ( i = 0; i <= 0; ++i )
    result = (void *)bm174x_ioctl(g_chain[8 * i], 2u, v9);
  return result;
}
// 46EC8: using guessed type char g_new_work;
// 4785C: using guessed type char total_work;
// 47ECC: using guessed type int g_chain[8];
...
{
  g_ticket_mask = dword_F2B30;
  g_core_timeout = dword_F2B34;
  g_misc_control = dword_F2B38;
}
// 46ED8: using guessed type int g_ticket_mask;
// 46EDC: using guessed type int g_misc_control;
// 46EE0: using guessed type int g_core_timeout;
// F2B30: using guessed type int dword_F2B30;
// F2B34: using guessed type int dword_F2B34;
// F2B38: using guessed type int dword_F2B38;
...
// 46F44: using guessed type _DWORD freq_pll[404];
...
// 47704: using guessed type int opt_log_level;
// 47968: using guessed type int reg_scan_items[300];
// 47E18: using guessed type pthread_mutex_t reg_scan_mutex;
// 47EAC: using guessed type char use_syslog;
// 47EAF: using guessed type char opt_log_output;
...
// 47594: using guessed type int alive;
// 47968: using guessed type int reg_scan_items[300];
// 47E18: using guessed type pthread_mutex_t reg_scan_mutex;
...
// 47704: using guessed type int opt_log_level;
// 47968: using guessed type int reg_scan_items[300];
// 47E30: using guessed type int p_reg_scan;
// 47EAC: using guessed type char use_syslog;
// 47EAF: using guessed type char opt_log_output;
...
// 1F440: using guessed type uint32_t var_8[2];
...
// 47598: using guessed type int compare_size;
...
// 33BD8: using guessed type _BYTE chCRCHTalbe[256];
// 33CD8: using guessed type _BYTE chCRCLTalbe[256];
...
// 47704: using guessed type int opt_log_level;
// 47E34: using guessed type int fpga_mem_addr;
// 47E38: using guessed type int axi_fpga_addr;
// 47EAC: using guessed type char use_syslog;
// 47EAF: using guessed type char opt_log_output;
// F2798: using guessed type int fd_fpga_mem;
// F279C: using guessed type int fd_fpga;
...
// 20F8E: conditional instruction was optimized away because %var_4.4==0
// 47704: using guessed type int opt_log_level;
// 47EAC: using guessed type char use_syslog;
// 47EAF: using guessed type char opt_log_output;
...
// 2104E: conditional instruction was optimized away because %var_4.4==0
// 47704: using guessed type int opt_log_level;
// 47EAC: using guessed type char use_syslog;
// 47EAF: using guessed type char opt_log_output;
...
int open_key()
{
  ...
  dword_F2994 = open("/sys/class/gpio/gpio943/value", 2048);
  if ( dword_F2994 < 0 && (use_syslog || opt_log_output || opt_log_level > 1) )
  {
...
// 47EAC: using guessed type char use_syslog;
// 47EAF: using guessed type char opt_log_output;
// F2994: using guessed type int dword_F2994;
...
ssize_t __cdecl read_key(unsigned __int8 value)
{
  ...
  valuea[0] = value;
  v5 = 0;
  lseek(dword_F2994, 0, 0);
  v5 = read(dword_F2994, valuea, 1u);
  if ( v5 == 1 )
    return 1;
  if ( use_syslog || opt_log_output || opt_log_level > 1 )
  {
...
int open_lcd()
{
  ...
  dword_F298C = open("/dev/bitmain-lcd", 2178);
  if ( dword_F298C <= 0 && (use_syslog || opt_log_output || opt_log_level > 1) )
  {
...
// 47EAC: using guessed type char use_syslog;
// 47EAF: using guessed type char opt_log_output;
// F298C: using guessed type int dword_F298C;
...
void __cdecl write_lcd(unsigned int line, unsigned __int8 *buf, unsigned int size)
{
  ...
  sizea = size;
  v8 = 0;
  if ( buf && dword_F298C > 0 )
  {
    if ( line <= 3 && size <= 0x40 )
    {
      lseek(dword_F298C, 0, 0);
      ...
      write(dword_F298C, lcd_output, 0x40u);
    }
    else if ( use_syslog || opt_log_output || opt_log_level > 1 )
    {
...
// 47704: using guessed type int opt_log_level;
// 47E3C: using guessed type int red_led_fd;
// 47EAC: using guessed type char use_syslog;
// 47EAF: using guessed type char opt_log_output;
...
// 47704: using guessed type int opt_log_level;
// 47E40: using guessed type int green_led_fd;
// 47EAC: using guessed type char use_syslog;
// 47EAF: using guessed type char opt_log_output;
...
int bm1744_hashboard_init()
{
  ...
  usleep(0x2710u);
  set_ticket_mask(dword_F2B30);
  usleep(0x2710u);
  return set_frequency(dword_F2B64);
}
// F2B30: using guessed type int dword_F2B30;
// F2B64: using guessed type int dword_F2B64;
...
// 47600: using guessed type char gChain;
// 47704: using guessed type int opt_log_level;
// 478AC: using guessed type int one_work_nonce_each_asic[];
// 478C4: using guessed type _DWORD one_work_invalid_nonce_each_asic_2[6];
// 47EAC: using guessed type char use_syslog;
...
void __noreturn singleboard_sensor_test()
{
  ...
  while ( 1 )
  {
    ...
    {
      read_temp_test_result = 1;
      if ( dword_F2B70 <= v8 || dword_F2B74 >= v7 )
...
// 22100: using guessed type void __noreturn singleboard_sensor_test();
// 47704: using guessed type int opt_log_level;
// 47E48: using guessed type int read_temp_test_result;
// 47E4C: using guessed type int tempture_value_test_result;
// 47EAC: using guessed type char use_syslog;
// 47EAF: using guessed type char opt_log_output;
// F2B70: using guessed type int dword_F2B70;
// F2B74: using guessed type int dword_F2B74;
...
// 46EF8: using guessed type int addr_interval;
// 47704: using guessed type int opt_log_level;
// 47E44: using guessed type int set_address_test_result;
// 47EAC: using guessed type char use_syslog;
// 47EAF: using guessed type char opt_log_output;
...
int __fastcall singleboard_step_increase_frequency(int a1, int a2)
{
  ...
  unsigned int index_by_freq; // [sp+418h] [bp+418h]
...
void *singleboard_nonce_test()
{
  ...
  for ( i = 0; i <= 2; ++i )
  {
    if ( one_work_nonce_each_asic[3 * (unsigned __int8)gChain + i] >= (unsigned int)dword_F2B40
      && one_work_invalid_nonce_each_asic_2[6 * (unsigned __int8)gChain + 1 + 2 * i] <= (unsigned int)dword_F2B44 )
    {
      if ( use_syslog || opt_log_output || opt_log_level > 1 )
      {
        snprintf(
...
// 47EAC: using guessed type char use_syslog;
// 47EAF: using guessed type char opt_log_output;
// F2B3C: using guessed type int dword_F2B3C;
// F2B40: using guessed type int dword_F2B40;
// F2B44: using guessed type int dword_F2B44;
...
void singleboard_patten_test()
{
  ...
  v1 = dword_F2C44 + dword_F2C3C + dword_F2C40;
  dword_F2CB0 = 1;
  for ( i = 0; g_patten > i; ++i )
  {
    for ( j = 0; dword_F2C38 > j; ++j )
    {
      for ( k = 0; dword_F2C48 > k; ++k )
      {
        dword_F2C90 = dword_F2C8C + v1 * j * dword_F2C48 + v1 * dword_F2C48 * i * dword_F2C38 + v1 * k;
        ptr = bin2hex((const unsigned __int8 *)dword_F2C90, 0x8Cu);
        dword_F2C94 = i;
        dword_F2C98 = j;
        dword_F2C9C = k;
        send_work(ptr, 1, 0);
        free(ptr);
        usleep(1000 * dword_F2B78);
        pthread_mutex_lock(&mutex);
        dword_F2CAC = dword_F2CA4 / dword_F2CA8;
        pthread_mutex_unlock(&mutex);
      }
    }
  }
...
// F2B78: using guessed type int dword_F2B78;
// F2C34: using guessed type int g_patten;
// F2C38: using guessed type int dword_F2C38;
// F2C3C: using guessed type int dword_F2C3C;
// F2C40: using guessed type int dword_F2C40;
// F2C44: using guessed type int dword_F2C44;
...
// 475FC: using guessed type _BYTE isl_dev_addr[4];
// 47600: using guessed type char gChain;
// 47704: using guessed type int opt_log_level;
// 47EAC: using guessed type char use_syslog;
// 47EAF: using guessed type char opt_log_output;
...
// 47704: using guessed type int opt_log_level;
// 4787C: using guessed type int nonce_num_each_asic[];
// 47880: using guessed type int dword_47880;
// 47884: using guessed type int dword_47884;
// 47888: using guessed type int nonce_invalid_num_each_asic[3];
// 47894: using guessed type int nonce_invalid_num_each_asic_2[];
// 47898: using guessed type int dword_47898;
// 4789C: using guessed type int dword_4789C;
// 478A0: using guessed type int dword_478A0;
// 478A4: using guessed type int dword_478A4;
// 478A8: using guessed type int dword_478A8;
// 478AC: using guessed type int one_work_nonce_each_asic[];
// 478B0: using guessed type int dword_478B0;
// 47EAC: using guessed type char use_syslog;
// 47EAF: using guessed type char opt_log_output;
  ...
  while ( v28 )
  {
    ...
    switch ( (char)v21 )
    {
      ...
      case 'w':
        ...
        result = (int)send_work((const unsigned __int8 *)v3, v20, 0);
        break;
      default:
        if ( use_syslog || opt_log_output || opt_log_level > 0 )
        {
...
// 10EBC: using guessed type int _isoc99_fscanf(_DWORD, const char *, ...);
// 110FC: using guessed type int _isoc99_scanf(const char *, ...);
// 47704: using guessed type int opt_log_level;
// 47830: using guessed type int stdin;
// 47EAC: using guessed type char use_syslog;
// 47EAF: using guessed type char opt_log_output;
// 23440: using guessed type unsigned __int16 var_30;
// 23440: using guessed type uint16_t var_34;
...
int __fastcall write_dc_dc(unsigned __int8 a1, unsigned __int8 a2, unsigned __int8 a3, char a4, int a5, int a6)
{
  ...
  _DWORD v15[2]; // [sp+18h] [bp+10h]
  _DWORD v16[4]; // [sp+20h] [bp+18h] BYREF
  __int16 v17; // [sp+30h] [bp+28h]
  unsigned __int8 v18; // [sp+33h] [bp+2Bh]
  int j; // [sp+34h] [bp+2Ch]
  int i; // [sp+38h] [bp+30h]
  unsigned __int8 k; // [sp+3Dh] [bp+35h]
  __int16 v22; // [sp+3Eh] [bp+36h]
  _BYTE v23[4]; // [sp+40h] [bp+38h] BYREF
  ...
  for ( i = 0; i < a6; ++i )
    v23[i - 42] = *(_BYTE *)(i + a5);
  for ( j = 2; a6 + 6 > j; ++j )
    v22 += (unsigned __int8)v13[j];
  LOBYTE(v17) = HIBYTE(v22);
  HIBYTE(v17) = v22;
  v23[a6 - 42] = HIBYTE(v22);
  v23[a6 - 41] = HIBYTE(v17);
  pthread_mutex_lock(&i2c_mutex);
  for ( k = 0; k < v18 + 2; ++k )
    write_pic(a2, a1, v23[k - 48]);
  usleep(0x186A0u);
  memset(v16, 0, sizeof(v16));
  for ( k = 0; k <= 4u; ++k )
  {
    v6 = k;
    *((_BYTE *)v16 + v6) = read_pic(a2, a1);
  }
  pthread_mutex_unlock(&i2c_mutex);
  if ( BYTE1(v16[0]) == 50 && BYTE2(v16[0]) == 1 )
    return 0;
  printf(
...
// 47E58: using guessed type pthread_mutex_t i2c_mutex;
...
int __cdecl send_data_to_PIC16F1704(unsigned int which_i2c, unsigned __int8 which_chain, unsigned __int8 *buf)
{
  ...
  char v10[16]; // [sp+420h] [bp+418h] BYREF
  __int16 v11; // [sp+430h] [bp+428h]
  __int16 v12[2]; // [sp+434h] [bp+42Ch]
  __int16 v13; // [sp+438h] [bp+430h]
  char v14; // [sp+43Ch] [bp+434h]
  unsigned __int8 i; // [sp+43Dh] [bp+435h]
  __int16 v16; // [sp+43Eh] [bp+436h]
  _BYTE v17[4]; // [sp+440h] [bp+438h] BYREF
  ...
  pthread_mutex_lock(&i2c_mutex);
  for ( i = 0; i <= 0x15u; ++i )
    write_pic(which_i2ca, which_chain, v17[i - 36]);
  usleep(0x186A0u);
  for ( i = 0; i <= 1u; ++i )
  {
    v3 = i;
    *((_BYTE *)v12 + v3) = read_pic(which_i2ca, which_chain);
  }
  pthread_mutex_unlock(&i2c_mutex);
  if ( LOBYTE(v12[0]) == 2 && HIBYTE(v12[0]) == 1 )
  {
    if ( use_syslog || opt_log_output || opt_log_level > 1 )
    {
...
int __cdecl write_hash_ID_PIC16F1704(unsigned int which_chain, unsigned __int8 which_i2c, unsigned __int8 *buf)
{
  ...
  char v10[12]; // [sp+41Ch] [bp+414h] BYREF
  __int16 v11; // [sp+428h] [bp+420h]
  __int16 v12[2]; // [sp+42Ch] [bp+424h]
  __int16 v13; // [sp+430h] [bp+428h]
  char v14; // [sp+434h] [bp+42Ch]
  unsigned __int8 i; // [sp+435h] [bp+42Dh]
  __int16 v16; // [sp+436h] [bp+42Eh]
  _BYTE v17[4]; // [sp+438h] [bp+430h] BYREF
  ...
  pthread_mutex_lock(&i2c_mutex);
  for ( i = 0; i <= 0x11u; ++i )
    write_pic(which_i2c, which_chaina, v17[i - 32]);
  usleep((__useconds_t)&unk_61A80);
  for ( i = 0; i <= 1u; ++i )
  {
    v3 = i;
    *((_BYTE *)v12 + v3) = read_pic(which_i2c, which_chaina);
  }
  pthread_mutex_unlock(&i2c_mutex);
  usleep(0x30D40u);
  if ( LOBYTE(v12[0]) == 18 && HIBYTE(v12[0]) == 1 )
  {
    if ( use_syslog || opt_log_output || opt_log_level > 1 )
    {
...
int __cdecl heart_beat_PIC16F1704(unsigned int which_chain, unsigned __int8 which_i2c)
{
  ...
  _WORD v12[5]; // [sp+414h] [bp+414h]
  char v13; // [sp+41Eh] [bp+41Eh]
  unsigned __int8 i; // [sp+41Fh] [bp+41Fh]
  _BYTE v15[4]; // [sp+420h] [bp+420h] BYREF
  ...
  pthread_mutex_lock(&i2c_mutex);
  for ( i = 0; i <= 5u; ++i )
    write_pic(which_i2c, which_chaina, v15[i - 24]);
  usleep(0x186A0u);
  for ( i = 0; i <= 5u; ++i )
  {
    v2 = i;
    *((_BYTE *)&v12[-2] + v2) = read_pic(which_i2c, which_chaina);
  }
  pthread_mutex_unlock(&i2c_mutex);
...
// 354A0: using guessed type _BYTE isl68127_i2c_dev_addr[4];
// 26DC8: using guessed type uint16_t var_10;
...
// 47704: using guessed type int opt_log_level;
// 47E70: using guessed type pthread_mutex_t uart_send_mutex[1];
// 47EAC: using guessed type char use_syslog;
// 47EAF: using guessed type char opt_log_output;
...
unsigned int __fastcall uart_receive(unsigned __int8 a1, unsigned __int8 *a2, unsigned int a3)
{
  ...
  unsigned int uart_data_in_fpga; // [sp+1Ch] [bp+1Ch]
  ...
  if ( uart_data_in_fpga )
  {
    for ( i = 0; i < uart_data_in_fpga; ++i )
      fprintf((FILE *)_bss_start, "%02x", a2[i]);
    fprintf((FILE *)_bss_start, "   len=%d fd=%d\n", uart_data_in_fpga, a1);
  }
  pthread_mutex_unlock(&uart_receive_mutex[a1]);
  return uart_data_in_fpga;
}
// 47828: using guessed type int _bss_start;
// 47E88: using guessed type pthread_mutex_t uart_receive_mutex[1];
...
{
  lseek(dword_F2994, 0, 0);
  return read(dword_F2994, command, len);
}
// F2994: using guessed type int dword_F2994;
...
ssize_t display_arguments()
{
  ...
  v0 = strlen(v4);
  memcpy(v2, v4, v0);
  sprintf(&v2[16], "IC:%2d", v5[0]);
  sprintf(&v2[32], "FREQ: %d", v5[2]);
  sprintf(&v2[48], "Voltage: %d", v5[3]);
  return write(dword_F298C, v2, 0x40u);
}
// F298C: using guessed type int dword_F298C;
...
// 47600: using guessed type char gChain;
// 47704: using guessed type int opt_log_level;
// 47EA0: using guessed type _BYTE gChain_exist[4];
// 47EA5: using guessed type char gI2c;
// 47EAC: using guessed type char use_syslog;
// 47EAF: using guessed type char opt_log_output;
// 47ECC: using guessed type int g_chain[8];
// F29B4: using guessed type int dword_F29B4;
// F29C4: using guessed type _BYTE chain_info[4];

//----- (0002B04C) --------------------------------------------------------
void V9_print_lcd()
{
  int v0; // [sp+4h] [bp-4h]
  char v1[16]; // [sp+8h] [bp+0h] BYREF
  ...
  sprintf(
    v1,
    "Pattern %c %c %c %c ",
    (unsigned __int8)nonce_test_asic_result,
    (unsigned __int8)byte_47E55,
    (unsigned __int8)byte_47E56,
    v0);
  write_lcd_no_memset(1u, (unsigned __int8 *)v1, 0x10u);
...
// 2B0BE: variable 'v0' is possibly undefined
// 47E44: using guessed type int set_address_test_result;
// 47E48: using guessed type int read_temp_test_result;
// 47E4C: using guessed type int tempture_value_test_result;
// 47E54: using guessed type char nonce_test_asic_result;
// 47E55: using guessed type char byte_47E55;
// 47E56: using guessed type char byte_47E56;
...
int V9_show_status_func()
{
  ...
  while ( show_id_alive )
  {
    ...
    sprintf(s, "nonce=%d %d %d  ", one_work_nonce_each_asic, dword_478B0, dword_478B4);
    sprintf(
      byte_475EC,
      "%d-%d'C %d-%d'C",
      (unsigned __int8)byte_4843D,
      (unsigned __int8)sensor_info,
      (unsigned __int8)byte_48441,
      (unsigned __int8)byte_48440);
    ++v1;
    write(dword_F298C, lcd_output, 0x40u);
  }
  return 0;
...
// 478AC: using guessed type int one_work_nonce_each_asic;
// 478B0: using guessed type int dword_478B0;
// 478B4: using guessed type int dword_478B4;
// 47EA8: using guessed type int show_id_alive;
// 4843C: using guessed type char sensor_info;
// 4843D: using guessed type char byte_4843D;
// 48440: using guessed type char byte_48440;
// 48441: using guessed type char byte_48441;
// F298C: using guessed type int dword_F298C;
...
int singleBoardTest_V9_BM1744_manual()
{
  ...
  if ( use_syslog || opt_log_output || opt_log_level > 1 )
  {
    snprintf(v2, 0x400u, "%s[%d]\n", "singleBoardTest_V9_BM1744_manual", 329);
    applog(2, v2, 0);
  }
  get_app_config(&v3);
  ...
  else
  {
    ...
    if ( use_syslog || opt_log_output || opt_log_level > 1 )
    {
      snprintf(v2, 0x400u, "%s[%d]\n", "singleBoardTest_V9_BM1744_manual", 359);
      applog(2, v2, 0);
    }
...
int singleBoardTest_V9_BM1744()
{
  ...
  memset(one_work_invalid_nonce_each_asic_2, 0, sizeof(one_work_invalid_nonce_each_asic_2));
  show_id_alive = 1;
  pthread_create(&dword_F2970, 0, (void *(*)(void *))V9_show_status_func, 0);
  init_fpga();
  set_fpga_baud(0x1Au);
  check_chain();
  if ( (unsigned __int8)gChain == 255 )
  ...
  else
  {
    ...
    usleep((__useconds_t)&unk_493E0);
    write_axi_fpga(0xDu, 0);
    if ( isl_communication_check(dword_F2B68) <= 0 )
    {
      v3 = 1;
    }
    else
    {
      if ( dword_F2B6C == 1 )
        vol_init(dword_F2B68);
      usleep((__useconds_t)&unk_493E0);
      start_single_board_test();
      v3 = 0;
    }
    show_id_alive = 0;
    pthread_cancel(dword_F2970);
    pthread_join(dword_F2970, 0);
...
// 4843C: using guessed type char sensor_info;
// F29C4: using guessed type _BYTE chain_info[4];
// F2B68: using guessed type int dword_F2B68;
// F2B6C: using guessed type int dword_F2B6C;
...
// 11078: using guessed type int _isoc99_sscanf(_DWORD, const char *, ...);
// 47704: using guessed type int opt_log_level;
// 47EAC: using guessed type char use_syslog;
// 47EAF: using guessed type char opt_log_output;
// F29C8: using guessed type int app_conf;
...
// 36420: using guessed type _WORD crc_itu_t_table[256];
...
// 47828: using guessed type int _bss_start;
// 47EAD: using guessed type char opt_quiet;
// 47EB0: using guessed type pthread_mutex_t console_lock;
...
void __cdecl simplelog(int prio, const unsigned __int8 *str, bool force)
{
  ...
  my_log_curses(prio, byte_3665C, (const char *)str, force);
}
// 47828: using guessed type int _bss_start;
...
void *patten_info_init()
{
  ...
  memset(&g_patten, 0, 0x98u);
  g_patten = dword_F2B5C;
  dword_F2C38 = dword_F2B60;
  dword_F2C48 = dword_F2B48;
  strcpy((char *)&dword_F2C4C, "patten");
  strcpy(byte_F2C5C, "zec-z11");
  strcpy((char *)&dword_F2C6C, "asic");
  strcpy((char *)&dword_F2C7C, "core");
  dword_F2C3C = 140;
  dword_F2C40 = 4;
  dword_F2C44 = 1344;
  dword_F2C8C = (int)malloc(1488 * dword_F2B48 * dword_F2B60 * dword_F2B5C);
  if ( !dword_F2C8C )
  {
    printf("%s[%d] malloc failed\n", "patten_info_init", 28);
    exit(1);
  }
  result = malloc(dword_F2C48 * dword_F2C38 * g_patten);
  dword_F2CA0 = (int)result;
  if ( !result )
  {
    printf("%s[%d] malloc failed\n", "patten_info_init", 33);
    exit(1);
...
// F2B48: using guessed type int dword_F2B48;
// F2B5C: using guessed type int dword_F2B5C;
// F2B60: using guessed type int dword_F2B60;
// F2C34: using guessed type int g_patten;
// F2C38: using guessed type int dword_F2C38;
// F2C3C: using guessed type int dword_F2C3C;
// F2C40: using guessed type int dword_F2C40;
...
{
  if ( dword_F2C8C )
    free((void *)dword_F2C8C);
  if ( dword_F2CA0 )
    free((void *)dword_F2CA0);
}
// F2C8C: using guessed type int dword_F2C8C;
// F2CA0: using guessed type int dword_F2CA0;
...
void patten_load()
{
  char v0[64]; // [sp+14h] [bp+4h] BYREF
  char v1[4096]; // [sp+54h] [bp+44h] BYREF
  char *v2; // [sp+1054h] [bp+1044h]
  unsigned __int8 *v3; // [sp+1058h] [bp+1048h]
  FILE *v4; // [sp+105Ch] [bp+104Ch]
  int v5; // [sp+1060h] [bp+1050h]
  int k; // [sp+1064h] [bp+1054h]
  int j; // [sp+1068h] [bp+1058h]
  int i; // [sp+106Ch] [bp+105Ch]

  v5 = dword_F2C44 + dword_F2C3C + dword_F2C40;
  for ( i = 0; g_patten > i; ++i )
  {
    for ( j = 0; dword_F2C38 > j; ++j )
    {
      ...
      sprintf(
        v0,
        "%s/%s/%s-0x%02x/%s-0x%02x.txt",
        (const char *)&dword_F2C4C,
        byte_F2C5C,
        (const char *)&dword_F2C6C,
        i,
        (const char *)&dword_F2C7C,
        j);
      printf("fname %s\n", v0);
      v4 = fopen(v0, "r");
      for ( k = 0; dword_F2C48 > k; ++k )
      {
        v3 = (unsigned __int8 *)(v5 * j * dword_F2C48 + v5 * dword_F2C48 * i * dword_F2C38 + v5 * k + dword_F2C8C);
        memset(v1, 0, sizeof(v1));
        fgets(v1, 4096, v4);
        v2 = strtok(v1, "work");
        hex2bin(v3, (const unsigned __int8 *)v2 + 1, dword_F2C3C);
        v2 = strtok(v1, "nonce");
        hex2bin(&v3[dword_F2C3C], (const unsigned __int8 *)v2 + 1, dword_F2C40);
        v2 = strtok(v1, "sol");
        hex2bin(&v3[dword_F2C40 + dword_F2C3C], (const unsigned __int8 *)v2 + 1, dword_F2C44);
...
// 47728: using guessed type _DWORD sha256_k[64];
...
// 47708: using guessed type _DWORD sha256_h0[8];
...
// 2DCAE: masking with 0xF was optimized away because %var_C.4 <= 0xF
// 36710: using guessed type _DWORD K[64];
...
// 36810: using guessed type unsigned __int8 sha2_padding[64];
...
// 36C88: using guessed type _BYTE hex_6139[16];
...
// 36874: using guessed type _DWORD hex2bin_tbl[256];
...
int __fastcall divsi3_skip_div0_test(int result, unsigned int a2)
{
  ...
  else
  {
    ...
    {
      return ((int (__fastcall *)(_DWORD))((char *)&loc_32F00 + 16 * (31 - (__clz(a2) - __clz(v4)))))(0);
    }
    else
    {
...
// 32EC2: variable 'v2' is possibly undefined
...
// 46CA4: using guessed type void *_frame_dummy_init_array_entry;
