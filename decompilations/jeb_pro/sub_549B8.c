int sub_549B8(int param0, int param1, int param2, int param3, int param4, int param5, int param6, int param7) {
    int v0;
    int v1 = param5;
    ...
    if((int*)((int)(int*)((int)ptr0 >> (7 - v5)) & SOCK_STREAM) != 0) {
        ...
        if(gvar_58DE3C == 0) {
            sub_5DF98(&g2, "src/zlog.c", 795, "never call zlog_init() or dzlog_init() before");
            return pthread_rwlock_unlock(&g58DE1C);
        }
        else if(gvar_58DE10 == 0) {
            sub_5DF98(&g2, "src/zlog.c", 0x322, "zlog_default_category is null,dzlog_init() or dzlog_set_cateogry() is not called above");
            return pthread_rwlock_unlock(&g58DE1C);
        }
        ...
        if(ptr1 == 0) {
            ...
            if(__pointer == 0) {
                sub_5DF98(&g2, "src/zlog.c", 806, "zlog_thread_new fail");
                return pthread_rwlock_unlock(&g58DE1C);
            }
            ...
            if(v10 != 0) {
                ...
                v0 = v10;
                sub_5DF98(&g2, "src/zlog.c", 806, "pthread_setspecific fail, rd[%d]");
                return pthread_rwlock_unlock(&g58DE1C);
            }
            v8 = gvar_58DE18;
        }
        if(__pointer[0] != v8) {
            ...
            v0 = v12;
            sub_5DF98(&g2, "src/zlog.c", 806, "zlog_thread_resize_msg_buf fail, rd[%d]");
            return pthread_rwlock_unlock(&g58DE1C);
        }
    loc_54AB8:
        ...
        int v19 = v3;
        int v20 = param3;
        sub_5759C(ptr3, v13, v14, param0, param1, param2, param3, v3, v1, v6, v7);
        int v21 = sub_55C7C(gvar_58DE10, (int*)__pointer);
        if(v21 != 0) {
            v15 = v3;
            v0 = param0;
            sub_5DF98(&g2, "src/zlog.c", 814, "zlog_output fail, srcfile[%s], srcline[%ld]");
            return pthread_rwlock_unlock(&g58DE1C);
        }
        ...
        if(param0 != 0) {
            return sub_5DF98(&g2, "src/zlog.c", 0x33f, "reach reload-conf-period but zlog_reload fail, zlog-chk-conf [file] see detail");
        }
    }
    return param0;
}
