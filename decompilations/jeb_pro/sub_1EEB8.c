int sub_1EEB8(int param0, int param1, int param2, int param3, int param4, int param5) {
    char __s;
    int v0;
    char v1;
    char v2;
    ...
    do {
        ...
        do {
            ...
            ++ptr0;
            *ptr4 = ((uint32_t)*(char*)((char*)ptr0 + 18) * 0x100) | ((uint32_t)*(char*)(ptr0 + 4) * 0x1000000) | (v7 * &ELFHeader) | (uint32_t)*(char*)((char*)ptr0 + 19);
            ++ptr4;
        }
        while(ptr0 != ptr3);
        ptr2 += 8;
