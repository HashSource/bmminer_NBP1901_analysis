int sub_54140(int param0, int param1, int param2, int param3, int param4, int param5, int param6, int param7, int param8) {
    int v0;
    int v1 = param6;
    int v2 = param4;
    int v3 = v1 + 7;
    ...
    if((int*)((int)(int*)((int)ptr0 >> (7 - v4)) & SOCK_STREAM) != 0) {
        ...
        if(gvar_58DE3C == 0) {
            sub_5DF98(&g2, "src/zlog.c", 647, "never call zlog_init() or dzlog_init() before");
        ...
        if(ptr1 == 0) {
            ...
            if(__pointer == 0) {
                sub_5DF98(&g2, "src/zlog.c", 651, "zlog_thread_new fail");
                return pthread_rwlock_unlock(&g58DE1C);
            }
            ...
            if(v10 != 0) {
                ...
                v0 = v10;
                sub_5DF98(&g2, "src/zlog.c", 651, "pthread_setspecific fail, rd[%d]");
                return pthread_rwlock_unlock(&g58DE1C);
            }
            v8 = gvar_58DE18;
        }
        if(__pointer[0] != v8) {
            ...
            v0 = v12;
            sub_5DF98(&g2, "src/zlog.c", 651, "zlog_thread_resize_msg_buf fail, rd[%d]");
            return pthread_rwlock_unlock(&g58DE1C);
        }
    loc_54238:
        ...
        int v18 = v5;
        int v19 = v2;
        sub_57540(ptr3, param0, v13, param1, param2, param3, v2, v5, v1, v6, v7);
        int v20 = sub_55C7C((uint32_t*)param0, (int*)__pointer);
        if(v20 != 0) {
            v14 = v5;
            v0 = param1;
            sub_5DF98(&g2, "src/zlog.c", 659, "zlog_output fail, srcfile[%s], srcline[%ld]");
            return pthread_rwlock_unlock(&g58DE1C);
        }
        ...
        if(param0 != 0) {
            return sub_5DF98(&g2, "src/zlog.c", 676, "reach reload-conf-period but zlog_reload fail, zlog-chk-conf [file] see detail");
        }
    }
    return param0;
}
